 ...
 */
final class ItAutomationReviewTaskProvider implements HasModelClass, TaskProvider
{
    ...
    public function authorizedTasks(User $user, array $filters = []): array
    {
        ...
        return ItReplyTemplate::query()
            ...
            ->get()
            ->map(function (ItReplyTemplate $template) use ($timezone, $today): TaskItem {
