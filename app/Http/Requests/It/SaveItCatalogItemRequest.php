...
class SaveItCatalogItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'approver_user_id' => ['sometimes', 'nullable', 'integer', 'min:1', Rule::exists('users', 'id')],
            'cover_approver_user_id' => ['sometimes', 'nullable', 'integer', 'min:1', 'different:approver_user_id', Rule::exists('users', 'id')],
            'approval_window_days' => ['sometimes', 'nullable', 'integer', 'min:1', 'max:60'],
