...
class ClientMarController extends Controller
{
    ...
    {
        $user = $request->user();
        // If the user isn't allowed but can break-glass, send them to the emergency-access
        // request wizard (pre-opened for this client) rather than a hard 403 or a bare page.
