...
class Site extends Model
{
    ...
    protected $casts = [
        ...
        'offers_respite' => 'boolean',
        'respite_capacity' => 'integer',
    ...
    /** @deprecated Use DeviceRegistryService::forSite() instead. LocationHardware remains only as a compatibility shadow / historical bridge. */
