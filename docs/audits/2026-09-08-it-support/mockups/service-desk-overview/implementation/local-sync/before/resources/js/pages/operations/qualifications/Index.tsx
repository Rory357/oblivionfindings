        ...
        <AppLayout>
            ...
            <PageHero
                ...
                stats={[
                    ...
                    {
                        label: 'Met',
                        value: (requirements?.data ?? []).filter(
                            (r) => r.match_status === 'met',
                        ).length,
                    },
                    {
                        label: 'Unmet',
                        value: (requirements?.data ?? []).filter(
                            (r) => r.match_status === 'unmet',
                        ).length,
                    },
                ]}
            />
                        ...
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-16">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground/80">
                                    Qualification requirements will appear here
                                    once configured.
                                </p>
                            </CardContent>
                        </Card>
                                ...
                                <CardContent className="flex items-center gap-4 p-4">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            >
                                                <MatchIcon className="h-2.5 w-2.5" />{' '}
                                                {match.label}
                                            </Badge>
                                        </div>
