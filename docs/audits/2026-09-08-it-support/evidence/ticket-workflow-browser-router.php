...
require __DIR__.'/ticket-workflow-browser-runtime.php';
try {
    ...
    w06BrowserRequire($public !== false && ! is_file($public.'/hot')
        ...
        && hash_file('sha256', $public.'/ticket-workflow-review/manifest.json') === $context['asset_manifest_sha256'], 'Checkout assets or maintenance state changed; review before resuming.');
