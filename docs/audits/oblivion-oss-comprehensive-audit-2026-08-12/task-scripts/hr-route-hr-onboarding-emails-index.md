# HR-ROUTE-HR-ONBOARDING-EMAILS-INDEX: Hr Onboarding Emails Index

- Projection status: **Provisional route-derived capability; accepted denominator blocked**
- Actor/job owner: Actor satisfying exact route middleware `auth`, `permission:hr.onboarding.view`
- Owning module: Human resources
- Legacy family: `HR-ROUTE-HR-ONBOARDING-EMAILS-INDEX`
...
Start at `hr/onboarding/emails` (`hr.onboarding.emails.index`). Route existence is exact; visibility and access are unexecuted.
...
1. Enter through `GET|HEAD hr/onboarding/emails` (`hr.onboarding.emails.index`); the route is exact, but menu visibility and runtime access were not executed.

## Source-applicable states and transitions

- **information presented** is applicable only to `Closure` / `ROUTE-1566` at `routes/*.php closure`; it is not runtime-observed.
...
- `GET|HEAD hr/onboarding/emails` — `hr.onboarding.emails.index` — `Closure` — `routes/*.php closure:line unresolved` — middleware `web, auth, permission:hr.onboarding.view`
