# CAP-MED-PRESCRIPTION-COUNTERSIGN — Prescription Countersign

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-MED-PRESCRIPTION-COUNTERSIGN`
...
- Route evidence: `ROUTE-0399`
- Route names: `emar.prescriptions.countersign`
- Route paths: `emar/prescriptions/{order}/countersign`
...
- Target-supported route actions: `countersignPrescription`
...
Goal: Complete **Prescription Countersign** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
