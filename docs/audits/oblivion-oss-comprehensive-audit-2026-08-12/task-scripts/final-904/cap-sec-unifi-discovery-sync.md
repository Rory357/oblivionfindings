# CAP-SEC-UNIFI-DISCOVERY-SYNC — Unifi Discovery Sync

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-UNIFI-DISCOVERY-SYNC`
...
- Route evidence: `ROUTE-2600`, `ROUTE-2601`
- Route names: `security-devices.integrations.unifi.sync-devices`, `security-devices.integrations.unifi.sync-sites`
- Route paths: `security-devices/integrations/unifi/sync-devices`, `security-devices/integrations/unifi/sync-sites`
...
- Target-supported route actions: `syncDevices`, `syncSites`
...
Goal: Complete **Unifi Discovery Sync** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
