# CAP-SET-DATA-RETENTION-POLICY — Data Retention Policy

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SET-DATA-RETENTION-POLICY`
...
- Route evidence: `ROUTE-2649`
- Route names: `settings.data.retention.update`
- Route paths: `settings/data/retention`
...
- Target-supported route actions: `updateRetention`
...
Goal: Complete **Data Retention Policy** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
