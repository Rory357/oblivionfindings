...
- Capability: `CAP-GOV-RESOLUTION-FINALIZATION`
...
- Route evidence: `ROUTE-0997`
- Route names: `governance.resolutions.finalize`
- Route paths: `governance/resolutions/{resolution}/finalize`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0319`
- Target-supported route actions: `finalize`
...
Goal: Complete **Resolution Finalization** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
