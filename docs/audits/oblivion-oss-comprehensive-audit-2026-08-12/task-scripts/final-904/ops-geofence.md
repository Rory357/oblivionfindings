...
- Capability: `OPS-GEOFENCE`
- Canonical module: `OPERATIONS`
- ID provenance: `exact`
- Source families: `OPS-GEOFENCE`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-2082`, `ROUTE-2083`, `ROUTE-2084`, `ROUTE-2085`, `ROUTE-2086`
- Route names: `operations.geofences.create`, `operations.geofences.destroy`, `operations.geofences.index`, `operations.geofences.store`, `operations.geofences.update`
- Route paths: `operations/geofences`, `operations/geofences/{zone}`, `operations/geofences/create`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0634`, `PAGE-0635`
...
- Backend anchors: `app/Http/Controllers/Operations/GeofenceController.php`
...
- Target authorization evidence. Exact route permission atoms where enriched: `evv.viewAny`
