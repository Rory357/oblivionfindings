# CAP-FIN-PURCHASE-ORDER-BILL-CONVERSION — Purchase Order Bill Conversion

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-FIN-PURCHASE-ORDER-BILL-CONVERSION`
...
- Route evidence: `ROUTE-0658`
- Route names: `finance.purchase-orders.convert-to-bill`
- Route paths: `finance/purchase-orders/{purchaseOrder}/convert-to-bill`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0184`
- Target-supported route actions: `convertToBill`
...
Goal: Complete **Purchase Order Bill Conversion** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.

Prerequisites:

- A non-production representative account with the documented global/site/ownership scope.
- A resettable synthetic record in the correct prerequisite state.
- Target authorization evidence. Exact route permission atoms where enriched: `finance.ap.manage`
