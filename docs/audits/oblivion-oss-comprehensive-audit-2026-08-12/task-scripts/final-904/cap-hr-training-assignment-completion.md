...
- Target-supported route actions: `completeEnrollment`, `downloadCertificate`, `enroll`, `previewAssignments`, `recordCompletion`, `remindAssignment`, `storeAssignments`, `waiveAssignment`
