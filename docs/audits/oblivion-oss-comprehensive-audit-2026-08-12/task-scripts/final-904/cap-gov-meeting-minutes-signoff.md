# CAP-GOV-MEETING-MINUTES-SIGNOFF — Meeting Minutes Signoff

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-GOV-MEETING-MINUTES-SIGNOFF`
...
- Route evidence: `ROUTE-0944`, `ROUTE-0945`, `ROUTE-0946`, `ROUTE-0949`
- Route names: `governance.meetings.minutes.approve`, `governance.meetings.minutes.sign`, `governance.meetings.minutes.store`, `governance.meetings.minutes.update`
- Route paths: `governance/meetings/{meeting}/minutes`, `governance/meetings/{meeting}/minutes/approve`, `governance/meetings/{meeting}/sign-minutes`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0299`
- Target-supported route actions: `approveMinutes`, `signMinutes`, `storeMinutes`, `updateMinutes`
...
Goal: Complete **Meeting Minutes Signoff** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
