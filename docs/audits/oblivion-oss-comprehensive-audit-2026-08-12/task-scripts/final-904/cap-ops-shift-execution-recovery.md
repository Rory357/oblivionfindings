...
- Route evidence: `ROUTE-2198`, `ROUTE-2200`, `ROUTE-2207`, `ROUTE-2210`, `ROUTE-2714`, `ROUTE-2718`, `ROUTE-2720`, `ROUTE-2723`
- Route names: `operations.shifts.cancel`, `operations.shifts.complete`, `operations.shifts.reopen`, `operations.shifts.start`
- Route paths: `operations/shifts/{shift}/cancel`, `operations/shifts/{shift}/complete`, `operations/shifts/{shift}/reopen`, `operations/shifts/{shift}/start`, `shifts/{shift}/cancel`, `shifts/{shift}/complete`, `shifts/{shift}/reopen`, `shifts/{shift}/start`
...
- Target-supported route actions: `App\Http\Controllers\LegacyRouteRedirectController`, `cancelOccurrence`, `complete`, `reopenOccurrence`, `start`
