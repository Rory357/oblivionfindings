...
- Capability: `HR-INTERVIEW-KIT`
- Canonical module: `HR`
- ID provenance: `exact`
- Source families: `HR-INTERVIEW-KIT`, `HR-ROUTE-HR-KITS-INDEX`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-1702`, `ROUTE-1703`, `ROUTE-1704`, `ROUTE-1705`
- Route names: `hr.kits.index`, `hr.kits.store`, `hr.kits.toggleActive`, `hr.kits.update`
- Route paths: `hr/recruitment/kits`, `hr/recruitment/kits/{kit}`, `hr/recruitment/kits/{kit}/toggle-active`
- Page scope: no accepted-target page relation retained for this final target
- Page evidence: Not enriched.
- Target-supported route actions: `Closure`, `store`, `toggleActive`, `update`
- Other accepted IDs sharing retained routes: No other accepted working IDs share these retained route relations.
- Backend anchors: `app/Http/Controllers/Hr/InterviewKitController.php`
...
Goal: Complete **Interview Kit** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
