# CAP-SITE-MEAL-BUDGET-CONFIG — Meal Budget Config

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-MEAL-BUDGET-CONFIG`
...
- Route evidence: `ROUTE-2842`
- Route names: `sites.meals.settings`
- Route paths: `sites/{site}/meal-planner/settings`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0900`, `PAGE-0909`
- Target-supported route actions: `saveSettings`
...
Goal: Complete **Meal Budget Config** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
