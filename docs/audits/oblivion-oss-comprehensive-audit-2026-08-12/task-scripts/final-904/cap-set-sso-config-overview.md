...
- Backend anchors: `app/Http/Controllers/Settings/SsoConfigController.php`
...
Goal: Complete **SSO Config Overview** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
