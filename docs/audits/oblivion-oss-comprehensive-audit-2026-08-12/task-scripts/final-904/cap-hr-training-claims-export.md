# CAP-HR-TRAINING-CLAIMS-EXPORT — Training Claims Export

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-TRAINING-CLAIMS-EXPORT`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1792`, `ROUTE-1803`
- Route names: `hr.training.claims.store`, `hr.training.export`
- Route paths: `hr/training/claims`, `hr/training/export`
...
- Target-supported route actions: `claimFee`, `export`
...
Goal: Complete **Training Claims Export** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.

Prerequisites:

- A non-production representative account with the documented global/site/ownership scope.
- A resettable synthetic record in the correct prerequisite state.
- Target authorization evidence. Exact route permission atoms where enriched: `hr.training.view`, `training.viewAny`
