# CAP-HS-HAZARDOUS-SUBSTANCE-SDS — Hazardous Substance SDS

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HS-HAZARDOUS-SUBSTANCE-SDS`
...
- Route evidence: `ROUTE-1232`
- Route names: `health-safety.substances.sds.store`
- Route paths: `health-safety/substances/{substance}/sds`
...
- Target-supported route actions: `storeSds`
...
Goal: Complete **Hazardous Substance SDS** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
