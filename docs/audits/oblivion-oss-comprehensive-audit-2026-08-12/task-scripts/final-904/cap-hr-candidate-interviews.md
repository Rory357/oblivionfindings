# CAP-HR-CANDIDATE-INTERVIEWS — Candidate Interviews

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-CANDIDATE-INTERVIEWS`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1669`, `ROUTE-1689`, `ROUTE-1690`
- Route names: `hr.interviews.score`, `hr.interviews.store`, `hr.interviews.update`
- Route paths: `hr/recruitment/applications/{application}/interviews`, `hr/recruitment/interviews/{interview}`, `hr/recruitment/interviews/{interview}/score`
...
- Target-supported route actions: `scoreInterview`, `storeInterview`, `updateInterview`
...
Goal: Complete **Candidate Interviews** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
