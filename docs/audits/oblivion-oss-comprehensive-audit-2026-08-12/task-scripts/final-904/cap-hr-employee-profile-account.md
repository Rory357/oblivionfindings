# CAP-HR-EMPLOYEE-PROFILE-ACCOUNT — Employee Profile Account

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-EMPLOYEE-PROFILE-ACCOUNT`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1609`
- Route names: `hr.people.invite`
- Route paths: `hr/people/{profile}/invite`
- Page scope: source-family envelope only; no exclusive target page is claimed
- Page evidence: Not target-exclusive. Source-family envelope: `PAGE-0072`, `PAGE-0367`, `PAGE-0375`, `PAGE-0447`, `PAGE-0448`, `PAGE-0449`, `PAGE-0638`, `PAGE-0639`, `PAGE-0640`, `PAGE-0946`, `PAGE-0947`, `PAGE-0948`
- Target-supported route actions: `resendInvite`
...
Goal: Complete **Employee Profile Account** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
