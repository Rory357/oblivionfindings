# CAP-SEC-UNIFI-SITE-MAPPING — Unifi Site Mapping

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-UNIFI-SITE-MAPPING`
...
- Route evidence: `ROUTE-2597`, `ROUTE-2598`
- Route names: `security-devices.integrations.unifi.map-site`, `security-devices.integrations.unifi.remove-mapping`
- Route paths: `security-devices/integrations/unifi/map-site`, `security-devices/integrations/unifi/map-site/{siteConfig}`
...
- Target-supported route actions: `mapSite`, `removeSiteMapping`
...
Goal: Complete **Unifi Site Mapping** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
