# CAP-SITE-SITE-ROOM-ROOM-OCCUPANCY — Site Room Room Occupancy

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-SITE-ROOM-ROOM-OCCUPANCY`
...
- Route evidence: `ROUTE-2878`
- Route names: `sites.rooms.assign`
- Route paths: `sites/{site}/rooms/{room}/assign`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0932`, `PAGE-0933`
- Target-supported route actions: `assign`
...
Goal: Complete **Site Room Room Occupancy** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
