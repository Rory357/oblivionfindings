# CAP-SITE-SITE-ROOM-DOOR-CARD — Site Room Door Card

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-SITE-ROOM-DOOR-CARD`
...
- Route evidence: `ROUTE-2879`
- Route names: `sites.rooms.door-card`
- Route paths: `sites/{site}/rooms/{room}/door-card`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0933`
- Target-supported route actions: `doorCard`
...
Goal: Complete **Site Room Door Card** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
