# CAP-SITE-MEAL-WEEK-TEMPLATE-APPLY — Meal Week Template Apply

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-MEAL-WEEK-TEMPLATE-APPLY`
...
- Route evidence: `ROUTE-2855`
- Route names: `sites.meals.templates.apply`
- Route paths: `sites/{site}/meal-templates/{template}/apply`
...
- Target-supported route actions: `apply`
...
Goal: Complete **Meal Week Template Apply** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
