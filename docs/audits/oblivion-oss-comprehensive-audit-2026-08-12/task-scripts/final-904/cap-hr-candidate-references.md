# CAP-HR-CANDIDATE-REFERENCES — Candidate References

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-CANDIDATE-REFERENCES`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1671`, `ROUTE-1715`
- Route names: `hr.references.store`, `hr.references.update`
- Route paths: `hr/recruitment/applications/{application}/references`, `hr/recruitment/references/{reference}`
...
- Target-supported route actions: `storeReference`, `updateReference`
...
Goal: Complete **Candidate References** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
