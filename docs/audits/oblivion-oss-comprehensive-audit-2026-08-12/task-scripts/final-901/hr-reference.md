...
- Capability: `HR-REFERENCE`
- Canonical module: `HR`
- ID provenance: `source_stable_existing_feature_id`
- Source families: `HR-REFERENCE`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-0095`, `ROUTE-0096`
- Route names: `careers.reference.show`, `careers.reference.submit`
- Route paths: `careers/references/{token}`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0020`
- Target-supported route actions: `show`, `submit`
- Other accepted IDs sharing retained routes: No other accepted working IDs share these retained route relations.
- Backend anchors: `app/Domain/Hr/Models/HrReferenceCheck.php`, `app/Domain/Hr/Notifications/ReferenceRequestNotification.php`, `app/Http/Controllers/Careers/ReferenceController.php`, `app/Http/Controllers/Hr/CandidateController.php`
...
Goal: Complete **Reference** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
