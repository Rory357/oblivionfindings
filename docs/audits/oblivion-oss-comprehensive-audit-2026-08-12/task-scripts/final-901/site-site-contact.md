...
- Capability: `SITE-SITE-CONTACT`
- Canonical module: `SITES`
- ID provenance: `exact`
- Source families: `SITE-SITE-CONTACT`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-2757`, `ROUTE-2758`, `ROUTE-2759`
- Route names: `sites.contacts.destroy`, `sites.contacts.store`, `sites.contacts.update`
- Route paths: `sites/{site}/contacts`, `sites/{site}/contacts/{contact}`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0881`
...
- Backend anchors: `app/Http/Controllers/SiteContactController.php`
...
Goal: Complete **Site Contact** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
