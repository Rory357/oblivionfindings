# CAP-SEC-QUECLINK-HUB-FRAMES-DIAGNOSTICS — Queclink Hub Frames Diagnostics

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-QUECLINK-HUB-FRAMES-DIAGNOSTICS`
...
- Route evidence: `ROUTE-2583`, `ROUTE-2591`
- Route names: `security-devices.integrations.queclink.frames`, `security-devices.integrations.queclink.stream`
- Route paths: `security-devices/integrations/queclink/frames`, `security-devices/integrations/queclink/stream`
...
- Target-supported route actions: `frames`, `stream`
...
Goal: Complete **Queclink Hub Frames Diagnostics** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
