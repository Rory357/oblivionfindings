# CAP-MED-CD-LOSS-REPORTING — Cd Loss Reporting

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-MED-CD-LOSS-REPORTING`
...
- Route evidence: `ROUTE-0355`, `ROUTE-0356`
- Route names: `emar.cd_loss.index`, `emar.cd_loss.store`
- Route paths: `emar/controlled/loss-reports`
...
Goal: Complete **Cd Loss Reporting** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.

Prerequisites:

- A non-production representative account with the documented global/site/ownership scope.
- A resettable synthetic record in the correct prerequisite state.
- Target authorization evidence. Exact route permission atoms where enriched: `clients.update`, `medications.controlled.record`, `medications.controlled.view`
