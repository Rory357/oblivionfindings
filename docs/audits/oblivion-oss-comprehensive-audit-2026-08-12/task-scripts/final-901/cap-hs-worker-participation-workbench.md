# CAP-HS-WORKER-PARTICIPATION-WORKBENCH — Worker Participation Workbench

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HS-WORKER-PARTICIPATION-WORKBENCH`
...
- Route evidence: `ROUTE-1237`
- Route names: `health-safety.worker-participation.index`
- Route paths: `health-safety/worker-participation`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0364`, `PAGE-0365`, `PAGE-0373`, `PAGE-0399`
...
Goal: Complete **Worker Participation Workbench** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.

Prerequisites:

- A non-production representative account with the documented global/site/ownership scope.
- A resettable synthetic record in the correct prerequisite state.
- Target authorization evidence. Exact route permission atoms where enriched: `hazards.view`
