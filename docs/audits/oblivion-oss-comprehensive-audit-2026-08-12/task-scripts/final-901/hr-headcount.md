...
- Backend anchors: `app/Http/Controllers/Hr/HeadcountController.php`
...
Goal: Complete **Headcount** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
