...
- Capability: `CAP-HR-ONBOARDING-TEMPLATES`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1579`, `ROUTE-1580`, `ROUTE-1581`, `ROUTE-1582`
- Route names: `hr.onboarding.templates.active`, `hr.onboarding.templates.destroy`, `hr.onboarding.templates.duplicate`, `hr.onboarding.templates.update`
- Route paths: `hr/onboarding/templates`, `hr/onboarding/templates/{template}`, `hr/onboarding/templates/{template}/active`, `hr/onboarding/templates/{template}/duplicate`
...
- Target-supported route actions: `destroyTemplate`, `duplicateTemplate`, `setTemplateActive`, `updateTemplates`
...
Goal: Complete **Onboarding Templates** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
