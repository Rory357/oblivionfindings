# CAP-SITE-SITE-COMPLIANCE-STAFF-REQUIREMENTS — Site Compliance Staff Requirements

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-SITE-COMPLIANCE-STAFF-REQUIREMENTS`
...
- Route evidence: `ROUTE-2884`, `ROUTE-2885`, `ROUTE-2886`
- Route names: `sites.staff_requirements.destroy`, `sites.staff_requirements.store`, `sites.staff_requirements.update`
- Route paths: `sites/{site}/staff-requirements`, `sites/{site}/staff-requirements/{requirement}`
...
- Target-supported route actions: `destroyStaffRequirement`, `storeStaffRequirement`, `updateStaffRequirement`
...
Goal: Complete **Site Compliance Staff Requirements** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
