...
- Backend anchors: `app/Http/Controllers/Settings/SecurityPolicyController.php`
...
Goal: Complete **Security Policy** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
