# CAP-SET-API-CREDENTIAL-LIFECYCLE — API Credential Lifecycle

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SET-API-CREDENTIAL-LIFECYCLE`
...
- Route evidence: `ROUTE-2617`, `ROUTE-2618`, `ROUTE-2619`
- Route names: `settings.api`, `settings.api.keys.revoke`, `settings.api.keys.store`
- Route paths: `settings/api`, `settings/api/keys`, `settings/api/keys/{keyId}/revoke`
...
- Target-supported route actions: `index`, `revokeKey`, `storeKey`
- Other accepted IDs sharing retained routes: `CAP-SET-OUTBOUND-WEBHOOK-CONFIG`
...
Goal: Complete **API Credential Lifecycle** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
