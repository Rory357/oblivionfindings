# CAP-MED-WORKER-TODAY-WORKLIST — Worker Today Worklist

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-MED-WORKER-TODAY-WORKLIST`
...
- Route evidence: `ROUTE-1878`
- Route names: `meds.today`
- Route paths: `meds/today`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0538`, `PAGE-0539`, `PAGE-0546`
- Target-supported route actions: `today`
...
Goal: Complete **Worker Today Worklist** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
