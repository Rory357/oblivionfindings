# CAP-GOV-MEETING-STATUS-LOCK — Meeting Status Lock

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-GOV-MEETING-STATUS-LOCK`
...
- Route evidence: `ROUTE-0937`, `ROUTE-0943`
- Route names: `governance.meetings.advance-status`, `governance.meetings.lock`
- Route paths: `governance/meetings/{meeting}/advance-status`, `governance/meetings/{meeting}/lock`
...
- Target-supported route actions: `advanceStatus`, `lockMeeting`
...
Goal: Complete **Meeting Status Lock** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
