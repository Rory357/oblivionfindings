...
- Route evidence: `ROUTE-0772`, `ROUTE-0773`
- Route names: `fleet-assets.checklists.index`, `fleet-assets.checklists.store`
- Route paths: `fleet-assets/maintenance/checklists`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0231`
