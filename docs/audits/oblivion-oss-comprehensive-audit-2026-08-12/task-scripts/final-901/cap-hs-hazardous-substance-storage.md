# CAP-HS-HAZARDOUS-SUBSTANCE-STORAGE — Hazardous Substance Storage

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HS-HAZARDOUS-SUBSTANCE-STORAGE`
...
- Route evidence: `ROUTE-1235`
- Route names: `health-safety.substances.storage-locations.store`
- Route paths: `health-safety/substances/{substance}/storage-locations`
...
- Target-supported route actions: `storeStorageLocation`
...
Goal: Complete **Hazardous Substance Storage** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
