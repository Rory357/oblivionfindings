# CAP-MED-COVERT-AUTHORISATION — Covert Authorisation

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-MED-COVERT-AUTHORISATION`
...
- Route evidence: `ROUTE-0400`, `ROUTE-0401`
- Route names: `emar.covert.revoke`, `emar.covert.store`
- Route paths: `emar/prescriptions/covert`, `emar/prescriptions/covert/{authorisation}/revoke`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0075`
- Target-supported route actions: `revokeCovert`, `storeCovert`
...
Goal: Complete **Covert Authorisation** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
