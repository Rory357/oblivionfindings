# CAP-SEC-UNIFI-CREDENTIALS — Unifi Credentials

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-UNIFI-CREDENTIALS`
...
- Route evidence: `ROUTE-2596`, `ROUTE-2599`, `ROUTE-2602`
- Route names: `security-devices.integrations.unifi.key`, `security-devices.integrations.unifi.rotate`, `security-devices.integrations.unifi.test`
- Route paths: `security-devices/integrations/unifi/key`, `security-devices/integrations/unifi/rotate`, `security-devices/integrations/unifi/test`
- Page scope: source-family envelope only; no exclusive target page is claimed
- Page evidence: Not target-exclusive. Source-family envelope: `PAGE-0831`
- Target-supported route actions: `rotateKey`, `saveKey`, `testKey`
...
Goal: Complete **Unifi Credentials** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
