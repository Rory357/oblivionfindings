...
- Route evidence: `ROUTE-2836`, `ROUTE-2837`
- Route names: `sites.meals.plan.serve`, `sites.meals.plan.unserve`
- Route paths: `sites/{site}/meal-plan/{entry}/serve`, `sites/{site}/meal-plan/{entry}/unserve`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0899`, `PAGE-0900`, `PAGE-0902`, `PAGE-0909`
- Target-supported route actions: `markServed`, `unserve`
...
- Exact working-ID findings: `CATER-STOCK-002`
