...
- Capability: `CLI-CLIENT-SUPPORT-PLAN`
- Canonical module: `CLIENTS`
- ID provenance: `exact`
- Source families: `CLI-CLIENT-SUPPORT-PLAN`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-0194`, `ROUTE-2049`
- Route names: `clients.support_plan.update`, `operations.clients.support_plan.update`
- Route paths: `clients/{client}/support-plan`, `operations/clients/{client}/support-plan`
...
- Target-supported route actions: `update`
...
Goal: Complete **Client Support Plan** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
