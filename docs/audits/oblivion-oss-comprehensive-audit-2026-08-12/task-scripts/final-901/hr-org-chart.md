...
- Capability: `HR-ORG-CHART`
- Canonical module: `HR`
- ID provenance: `exact`
- Source families: `HR-ORG-CHART`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-1583`, `ROUTE-1584`
- Route names: `hr.orgchart.index`, `hr.orgchart.update`
- Route paths: `hr/orgchart`, `hr/orgchart/{profile}`
...
- Backend anchors: `app/Http/Controllers/Hr/OrgChartController.php`
...
Goal: Complete **Org Chart** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
