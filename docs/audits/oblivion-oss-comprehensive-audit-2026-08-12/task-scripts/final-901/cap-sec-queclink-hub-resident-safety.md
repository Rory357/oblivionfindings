# CAP-SEC-QUECLINK-HUB-RESIDENT-SAFETY — Queclink Hub Resident Safety

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-QUECLINK-HUB-RESIDENT-SAFETY`
...
- Route evidence: `ROUTE-2578`
- Route names: `security-devices.integrations.queclink.configuration.resident-safety-profile`
- Route paths: `security-devices/integrations/queclink/devices/{queclinkDevice}/configuration/resident-safety-profile`
...
- Target-supported route actions: `applyResidentSafetyProfile`
...
Goal: Complete **Queclink Hub Resident Safety** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
