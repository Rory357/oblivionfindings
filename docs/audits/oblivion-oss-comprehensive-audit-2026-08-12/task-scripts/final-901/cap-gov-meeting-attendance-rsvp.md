# CAP-GOV-MEETING-ATTENDANCE-RSVP — Meeting Attendance Rsvp

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-GOV-MEETING-ATTENDANCE-RSVP`
...
- Route evidence: `ROUTE-0941`, `ROUTE-0948`
- Route names: `governance.meetings.attendance.record`, `governance.meetings.rsvp`
- Route paths: `governance/meetings/{meeting}/attendance`, `governance/meetings/{meeting}/rsvp`
...
- Target-supported route actions: `recordAttendance`, `submitRsvp`
...
Goal: Complete **Meeting Attendance Rsvp** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
