# SITE-ROUTE-SITES-HOUSE-CHECKLISTS-INDEX: Sites House Checklists Index
...
- Legacy family: `SITE-ROUTE-SITES-HOUSE-CHECKLISTS-INDEX`
...
Start at `sites/{site}/house-checklists` (`sites.house-checklists.index`). Route existence is exact; visibility and access are unexecuted.
...
1. Enter through `GET|HEAD sites/{site}/house-checklists` (`sites.house-checklists.index`); the route is exact, but menu visibility and runtime access were not executed.

## Source-applicable states and transitions

- **information presented** is applicable only to `Closure` / `ROUTE-2803` at `routes/*.php closure`; it is not runtime-observed.
...
- `GET|HEAD sites/{site}/house-checklists` — `sites.house-checklists.index` — `Closure` — `routes/*.php closure:line unresolved` — middleware `web, auth, verified, permission:sites.viewAny`
