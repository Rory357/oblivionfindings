# CAP-SITE-SITE-ROOM-ASSET-LINKAGE — Site Room Asset Linkage

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-SITE-ROOM-ASSET-LINKAGE`
...
- Route evidence: `ROUTE-2876`, `ROUTE-2877`
- Route names: `sites.rooms.assets.attach`, `sites.rooms.assets.detach`
- Route paths: `sites/{site}/rooms/{room}/assets`, `sites/{site}/rooms/{room}/assets/{asset}`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0931`, `PAGE-0933`
- Target-supported route actions: `attachAsset`, `detachAsset`
...
Goal: Complete **Site Room Asset Linkage** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
