# CAP-HR-WELLBEING-EAP-REFERRALS — Wellbeing Eap Referrals

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-WELLBEING-EAP-REFERRALS`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1816`
- Route names: `hr.wellbeing.eap.store`
- Route paths: `hr/wellbeing/eap-referrals`
...
- Target-supported route actions: `storeEapReferral`
...
Goal: Complete **Wellbeing Eap Referrals** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
