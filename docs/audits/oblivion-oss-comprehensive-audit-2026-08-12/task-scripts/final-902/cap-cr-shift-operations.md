# CAP-CR-SHIFT-OPERATIONS — Shift Operations

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-CR-SHIFT-OPERATIONS`
- Canonical module: `CONTROL_ROOM`
- ID provenance: `exact`
- Source families: `CR-CONTROL-ROOM-SHIFT`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-0303`, `ROUTE-0304`, `ROUTE-0308`
- Route names: `control-room.shifts.index`, `control-room.shifts.note`, `control-room.shifts.store`
- Route paths: `control-room/shifts`, `control-room/shifts/{shift}/note`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0064`
- Target-supported route actions: `addNote`, `index`, `store`
- Other accepted IDs sharing retained routes: No other accepted working IDs share these retained route relations.
- Backend anchors: `app/Http/Controllers/ControlRoom/ControlRoomShiftController.php`
...
Goal: Complete **Shift Operations** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
