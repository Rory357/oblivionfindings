# CAP-HR-GOAL-CYCLE-CLOSE-ROLLOVER — Goal Cycle Close Rollover

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-GOAL-CYCLE-CLOSE-ROLLOVER`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1470`, `ROUTE-1471`
- Route names: `hr.goals.cycles.close`, `hr.goals.cycles.rollover`
- Route paths: `hr/goals/cycles/{cycle}/close`, `hr/goals/cycles/{cycle}/rollover`
- Page scope: no accepted-target page relation retained for this final target
- Page evidence: Not enriched.
- Target-supported route actions: `close`, `rollover`
...
Goal: Complete **Goal Cycle Close Rollover** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
