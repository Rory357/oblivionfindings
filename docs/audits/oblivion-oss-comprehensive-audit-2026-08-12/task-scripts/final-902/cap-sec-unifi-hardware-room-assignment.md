# CAP-SEC-UNIFI-HARDWARE-ROOM-ASSIGNMENT — Unifi Hardware Room Assignment

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-UNIFI-HARDWARE-ROOM-ASSIGNMENT`
...
- Route evidence: `ROUTE-2595`
- Route names: `security-devices.integrations.unifi.assign-room`
- Route paths: `security-devices/integrations/unifi/hardware/{hardware}/room`
...
- Target-supported route actions: `assignHardwareRoom`
...
Goal: Complete **Unifi Hardware Room Assignment** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
