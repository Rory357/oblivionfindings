# CAP-HS-COMMAND-CENTRE — Command Centre

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HS-COMMAND-CENTRE`
...
- Route evidence: `ROUTE-1078`
- Route names: `health-safety.dashboard`
- Route paths: `health-safety`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0364`, `PAGE-0366`, `PAGE-0368`, `PAGE-0369`, `PAGE-0372`, `PAGE-0374`, `PAGE-0377`
...
Goal: Complete **Command Centre** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
