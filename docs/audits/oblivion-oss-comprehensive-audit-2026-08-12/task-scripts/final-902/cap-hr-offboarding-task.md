# CAP-HR-OFFBOARDING-TASK — Offboarding Task

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-OFFBOARDING-TASK`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1553`
- Route names: `hr.offboarding.tasks.complete`
- Route paths: `hr/offboarding/tasks/{task}/complete`
- Page scope: source-family envelope only; no exclusive target page is claimed
- Page evidence: Not target-exclusive. Source-family envelope: `PAGE-0483`, `PAGE-0484`
- Target-supported route actions: `completeTask`
...
Goal: Complete **Offboarding Task** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
