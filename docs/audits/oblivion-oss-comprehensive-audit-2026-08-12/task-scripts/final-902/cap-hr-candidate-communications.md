# CAP-HR-CANDIDATE-COMMUNICATIONS — Candidate Communications

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-CANDIDATE-COMMUNICATIONS`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1682`, `ROUTE-1686`, `ROUTE-1687`
- Route names: `hr.candidates.bulk-email`, `hr.email-templates.destroy`, `hr.email-templates.store`
- Route paths: `hr/recruitment/candidates/bulk-email`, `hr/recruitment/email-templates`, `hr/recruitment/email-templates/{template}`
...
- Target-supported route actions: `bulkEmail`, `destroyEmailTemplate`, `storeEmailTemplate`
...
Goal: Complete **Candidate Communications** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
