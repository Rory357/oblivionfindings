...
- Route evidence: `ROUTE-1296`, `ROUTE-1303`
- Route names: `hr.calendar.events.rsvp`, `hr.calendar.index`
- Route paths: `hr/calendar`, `hr/calendar/events/{event}/rsvp`
...
- Target-supported route actions: `index`, `rsvp`
- Other accepted IDs sharing retained routes: `CAP-HR-CALENDAR-EVENT-MANAGEMENT`
