# CAP-HR-COMPLIANCE-MATRIX-ASSIGNMENT — Compliance Matrix Assignment

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-COMPLIANCE-MATRIX-ASSIGNMENT`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1365`, `ROUTE-1366`
- Route names: `hr.compliance.matrix`, `hr.compliance.matrix.update`
- Route paths: `hr/compliance/matrix`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0433`
- Target-supported route actions: `index`, `updateMatrix`
...
Goal: Complete **Compliance Matrix Assignment** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
