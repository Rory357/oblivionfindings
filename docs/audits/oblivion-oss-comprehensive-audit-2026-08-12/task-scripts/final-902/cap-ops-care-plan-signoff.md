# CAP-OPS-CARE-PLAN-SIGNOFF — Care Plan Signoff

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-OPS-CARE-PLAN-SIGNOFF`
...
- Route evidence: `ROUTE-1923`, `ROUTE-1924`
- Route names: `operations.care_plans.sign_offs.destroy`, `operations.care_plans.sign_offs.store`
- Route paths: `operations/care-plans/{carePlan}/sign-offs`, `operations/care-plans/{carePlan}/sign-offs/{signOff}`
...
- Target-supported route actions: `destroySignOff`, `storeSignOff`
...
Goal: Complete **Care Plan Signoff** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
