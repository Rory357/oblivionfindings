# CAP-SEC-QUECLINK-HUB-DEVICE-CUSTODY — Queclink Hub Device Custody

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-QUECLINK-HUB-DEVICE-CUSTODY`
...
- Route evidence: `ROUTE-2568`, `ROUTE-2569`, `ROUTE-2572`, `ROUTE-2581`, `ROUTE-2582`
- Route names: `security-devices.integrations.queclink`, `security-devices.integrations.queclink.bulk`, `security-devices.integrations.queclink.claim`, `security-devices.integrations.queclink.reject`, `security-devices.integrations.queclink.release`
- Route paths: `security-devices/integrations/queclink`, `security-devices/integrations/queclink/bulk`, `security-devices/integrations/queclink/devices/{queclinkDevice}/claim`, `security-devices/integrations/queclink/devices/{queclinkDevice}/reject`, `security-devices/integrations/queclink/devices/{queclinkDevice}/release`
...
- Target-supported route actions: `bulkAction`, `claimDevice`, `index`, `rejectDevice`, `releaseDevice`
- Other accepted IDs sharing retained routes: `CAP-SEC-QUECLINK-HUB-PENDING-INTAKE`
...
Goal: Complete **Queclink Hub Device Custody** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
