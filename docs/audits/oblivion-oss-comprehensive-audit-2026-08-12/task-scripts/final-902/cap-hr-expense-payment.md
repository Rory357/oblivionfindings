# CAP-HR-EXPENSE-PAYMENT — Expense Payment

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-EXPENSE-PAYMENT`
- Canonical module: `HR`
- ID provenance: `exact`
...
- Route evidence: `ROUTE-1336`
- Route names: `hr.compensation.expenses.pay`
- Route paths: `hr/compensation/expenses/{expenseClaim}/pay`
- Page scope: source-family envelope only; no exclusive target page is claimed
- Page evidence: Not target-exclusive. Source-family envelope: `PAGE-0418`, `PAGE-0419`, `PAGE-0420`
- Target-supported route actions: `pay`
...
Goal: Complete **Expense Payment** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
