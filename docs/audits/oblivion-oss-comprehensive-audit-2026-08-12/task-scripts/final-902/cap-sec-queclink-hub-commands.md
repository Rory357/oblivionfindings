# CAP-SEC-QUECLINK-HUB-COMMANDS — Queclink Hub Commands

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SEC-QUECLINK-HUB-COMMANDS`
...
- Route evidence: `ROUTE-2570`, `ROUTE-2571`, `ROUTE-2573`
- Route names: `security-devices.integrations.queclink.command`, `security-devices.integrations.queclink.commands.cancel`, `security-devices.integrations.queclink.commands.retry`
- Route paths: `security-devices/integrations/queclink/commands/{command}/cancel`, `security-devices/integrations/queclink/commands/{command}/retry`, `security-devices/integrations/queclink/devices/{queclinkDevice}/command`
...
- Target-supported route actions: `cancelCommand`, `retryCommand`, `sendCommand`
...
Goal: Complete **Queclink Hub Commands** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
