# CAP-CR-BROADCAST-COMPOSE-SEND — Broadcast Compose Send

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-CR-BROADCAST-COMPOSE-SEND`
...
- Route evidence: `ROUTE-0249`
- Route names: `control-room.broadcast.store`
- Route paths: `control-room/broadcast`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0050`
...
Goal: Complete **Broadcast Compose Send** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
