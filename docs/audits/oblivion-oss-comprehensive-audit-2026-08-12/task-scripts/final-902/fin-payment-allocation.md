...
- Backend anchors: `app/Domain/Finance/Http/Controllers/PaymentAllocationController.php`
- Exact working-ID findings: `FIN-PAYMENT-ALLOCATION-01`
...
Goal: Complete **Payment Allocation** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
