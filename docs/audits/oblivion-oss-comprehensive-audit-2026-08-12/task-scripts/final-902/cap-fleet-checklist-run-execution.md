...
- Route evidence: `ROUTE-0774`, `ROUTE-0775`
- Route names: `fleet-assets.checklists.run`, `fleet-assets.checklists.run-page`
- Route paths: `fleet-assets/maintenance/checklists/{template}/run`, `fleet-assets/maintenance/checklists/run`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0231`, `PAGE-0232`
- Target-supported route actions: `run`, `runPage`
- Other accepted IDs sharing retained routes: No other accepted working IDs share these retained route relations.
- Backend anchors: `app/Http/Controllers/FleetAssets/ChecklistController.php`
