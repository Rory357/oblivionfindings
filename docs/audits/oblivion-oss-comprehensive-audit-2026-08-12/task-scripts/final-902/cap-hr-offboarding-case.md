# CAP-HR-OFFBOARDING-CASE — Offboarding Case

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-HR-OFFBOARDING-CASE`
- Canonical module: `HR`
- ID provenance: `exact`
- Source families: `HR-OFFBOARDING`
- Route scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Route evidence: `ROUTE-1549`, `ROUTE-1550`, `ROUTE-1551`, `ROUTE-1552`
- Route names: `hr.offboarding.create`, `hr.offboarding.index`, `hr.offboarding.show`, `hr.offboarding.store`
- Route paths: `hr/offboarding`, `hr/offboarding/{checklist}`, `hr/offboarding/create`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0483`, `PAGE-0484`
...
- Backend anchors: `app/Http/Controllers/Hr/OffboardingController.php`
...
Goal: Complete **Offboarding Case** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
