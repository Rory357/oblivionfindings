# CAP-SITE-SITE-VENDOR-GLOBAL-AUDIT — Site Vendor Global Audit

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-SITE-SITE-VENDOR-GLOBAL-AUDIT`
...
- Route evidence: `ROUTE-3022`
- Route names: `sites.vendors.audit`
- Route paths: `vendors/audit`
- Page scope: target-supported exact/shared relation retained in the working manifest; not necessarily exclusive ownership
- Page evidence: `PAGE-0865`, `PAGE-0936`, `PAGE-0939`, `PAGE-0940`
- Target-supported route actions: `globalAudit`
...
Goal: Complete **Site Vendor Global Audit** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.

Prerequisites:

- A non-production representative account with the documented global/site/ownership scope.
- A resettable synthetic record in the correct prerequisite state.
- Target authorization evidence. Exact route permission atoms where enriched: `credentials.view`
