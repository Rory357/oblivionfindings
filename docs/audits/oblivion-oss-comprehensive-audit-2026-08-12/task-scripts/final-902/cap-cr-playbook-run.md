# CAP-CR-PLAYBOOK-RUN — Playbook Run

Status: **Blocked — source-derived final-ID script; representative-role execution and independent task validation not performed.**

## Evidence boundary

- Capability: `CAP-CR-PLAYBOOK-RUN`
...
- Route evidence: `ROUTE-0230`, `ROUTE-0231`, `ROUTE-0232`
- Route names: `control-room.alerts.playbook.advance`, `control-room.alerts.playbook.skip`, `control-room.alerts.playbook.start`
- Route paths: `control-room/alerts/{alert}/playbook/advance`, `control-room/alerts/{alert}/playbook/skip`, `control-room/alerts/{alert}/playbook/start`
...
- Target-supported route actions: `advanceStep`, `skipStep`, `startRun`
...
Goal: Complete **Playbook Run** on the authoritative record, then verify an unambiguous persisted outcome, actor/time provenance, downstream effect and next accountable owner or terminal state.
