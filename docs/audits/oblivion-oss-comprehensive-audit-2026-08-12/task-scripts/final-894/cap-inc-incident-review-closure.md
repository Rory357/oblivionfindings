...
- Route evidence: `ROUTE-1846`, `ROUTE-1851`, `ROUTE-1852`, `ROUTE-1853`
- Route names: `incidents.close`, `incidents.reopen`, `incidents.review`, `incidents.submit`
- Route paths: `incidents/{incident}/close`, `incidents/{incident}/reopen`, `incidents/{incident}/review`, `incidents/{incident}/submit`
...
- Exact target actions: `close`, `reopen`, `review`, `submit`
...
- Target authorization evidence. Exact route permission atoms where enriched: `incidents.approve`, `incidents.reopen`, `incidents.submit`
