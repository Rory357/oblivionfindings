...
- Route evidence: `ROUTE-1297`, `ROUTE-1298`, `ROUTE-1299`, `ROUTE-1300`, `ROUTE-1301`, `ROUTE-1302`
- Route names: `hr.calendar.attachments.destroy`, `hr.calendar.attachments.download`, `hr.calendar.events.attachments.store`, `hr.calendar.events.destroy`, `hr.calendar.events.store`, `hr.calendar.events.update`
- Route paths: `hr/calendar/attachments/{attachment}`, `hr/calendar/attachments/{attachment}/download`, `hr/calendar/events`, `hr/calendar/events/{event}`, `hr/calendar/events/{event}/attachments`
- Page scope: source-family envelope only; no exclusive target page is claimed
- Page evidence: Not target-exclusive. Source-family envelope: `PAGE-0408`
- Exact target actions: `destroy`, `destroyAttachment`, `downloadAttachment`, `store`, `storeAttachment`, `update`
