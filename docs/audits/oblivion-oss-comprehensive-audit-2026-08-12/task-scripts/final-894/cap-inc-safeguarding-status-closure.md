...
- Route evidence: `ROUTE-2513`, `ROUTE-2521`
- Route names: `safeguarding.close`, `safeguarding.updateStatus`
- Route paths: `safeguarding/{concern}/close`, `safeguarding/{concern}/status`
- Page scope: exact/shared target support allocation retained in the working manifest
- Page evidence: `PAGE-0812`, `PAGE-0813`
- Exact target actions: `close`, `updateStatus`
