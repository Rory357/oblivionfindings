...
- Route evidence: `ROUTE-1598`, `ROUTE-1599`, `ROUTE-1602`, `ROUTE-1610`, `ROUTE-1611`
- Route names: `hr.people.active`, `hr.people.bulk`, `hr.people.index`, `hr.people.rehire`, `hr.people.store`
- Route paths: `hr/people`, `hr/people/{profile}/active`, `hr/people/{profile}/rehire`, `hr/people/bulk`
- Page scope: exact/shared target support allocation retained in the working manifest
- Page evidence: `PAGE-0448`
- Exact target actions: `bulkAction`, `index`, `rehire`, `setActive`, `store`
