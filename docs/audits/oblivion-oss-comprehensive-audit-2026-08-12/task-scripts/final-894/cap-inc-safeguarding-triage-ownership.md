...
- Route evidence: `ROUTE-2505`, `ROUTE-2509`, `ROUTE-2514`, `ROUTE-2520`, `ROUTE-2522`, `ROUTE-2523`
- Route names: `safeguarding.assign`, `safeguarding.edit`, `safeguarding.markSubjectInformed`, `safeguarding.setSensitivity`, `safeguarding.triage`, `safeguarding.update`
- Route paths: `safeguarding/{concern}`, `safeguarding/{concern}/assign`, `safeguarding/{concern}/edit`, `safeguarding/{concern}/sensitivity`, `safeguarding/{concern}/subject-informed`, `safeguarding/{concern}/triage`
- Page scope: exact/shared target support allocation retained in the working manifest
- Page evidence: `PAGE-0812`, `PAGE-0813`
- Exact target actions: `assign`, `edit`, `markSubjectInformed`, `setSensitivity`, `triage`, `update`
