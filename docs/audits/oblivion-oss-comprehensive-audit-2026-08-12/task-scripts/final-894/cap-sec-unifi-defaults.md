...
- Route evidence: `ROUTE-2593`, `ROUTE-2594`
- Route names: `security-devices.integrations.unifi`, `security-devices.integrations.unifi.defaults`
- Route paths: `security-devices/integrations/unifi`, `security-devices/integrations/unifi/defaults`
- Page scope: exact/shared target support allocation retained in the working manifest
- Page evidence: `PAGE-0831`
- Exact target actions: `index`, `updateDefaults`
