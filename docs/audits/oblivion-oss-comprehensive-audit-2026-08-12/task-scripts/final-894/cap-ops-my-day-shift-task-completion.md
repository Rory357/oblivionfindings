...
- Route evidence: `ROUTE-1893`, `ROUTE-2211`
- Route names: `my-day.shift-task.complete`, `operations.shifts.tasks.update`
- Route paths: `my-tasks/shift-task/{task}/complete`, `operations/shifts/{shift}/tasks/{task}`
...
- Exact target actions: `completeShiftTask`, `update`
