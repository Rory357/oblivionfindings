...
- Exact target actions: `destroyMedication`, `discontinueMedication`, `importMedications`, `medicationDetail`, `medications`, `storeMedication`, `updateMedication`
...
- Target authorization evidence. Exact route permission atoms where enriched: `clients.update`, `medications.orders.manage`, `medications.view`
