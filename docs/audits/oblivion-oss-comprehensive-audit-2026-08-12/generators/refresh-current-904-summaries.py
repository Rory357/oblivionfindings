...
EXPECTED = {
    ...
    SCORECARD: "60360acbc22337e456ea74e231c2b650d248792f4cce1611046e674e63c28553",
    VISUAL: "4082310f08608b7743316f4a79724c162edfa69881887989215f02876ee3c32e",
    VISUAL_SUMMARY: "287e5fcfc4765d2bc159e10ae55a5d0d94df512d79521cb918362da4145fa4c0",
}
...
report = {
    ...
    "outputs": {"completion_report": record(COMPLETION), "executive_summary": record(executive), "module_map": record(module_map), "module_findings": record(findings_doc), "visual_narrative": record(VISUAL_NARRATIVE), "architecture_narrative": record(ARCHITECTURE_NARRATIVE), "unresolved_questions": record(unresolved), "dashboard": record(DASHBOARD), "deployed_current_control_room_handover_500": record(DEPLOYED_HANDOVER_500), "deployed_current_read_only_visual_resample": record(DEPLOYED_VISUAL_RESAMPLE), "artifact_hygiene": record(ARTIFACT_HYGIENE)},
