...
4. Build on the completed 16/16 blocker review and effective 88 complete observer-only / seven retained-partial split. Preserve the seven residual blockers until new official evidence resolves them, then neutralize and compare only eligible bounded observations and perform target-specific adjudication. Complete one verified benchmark or documented `No credible match` for each of the 340 canonical targets; observer completion is not formal upstream full-triage, mapping, selection, or final-no-match credit.
