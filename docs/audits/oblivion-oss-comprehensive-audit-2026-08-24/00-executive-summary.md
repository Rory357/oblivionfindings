...
- `audit-dashboard.html`: progress dashboard generated only from current structured evidence and freshly verified at all four required viewport dimensions, with zero application-browser or downstream credit.
