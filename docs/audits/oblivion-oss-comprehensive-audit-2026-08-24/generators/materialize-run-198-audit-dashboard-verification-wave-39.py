#!/usr/bin/env python3
"""Seal bounded RUN198 verification for the exact RUN197 audit dashboard.

This producer validates exact committed RUN197 reporting inputs, the narrow
...
if not __debug__:
    raise RuntimeError("RUN198 materializer refuses optimized Python")
...
OUTPUT = "evidence/browser/current-audit-dashboard-verification-run-198-wave-39.json"
HTML = "audit-dashboard.html"
BUILDER = "generators/build-current-audit-dashboard.py"
FINDINGS = "findings.json"
RUN_197_MATERIALIZER = (
    "generators/materialize-run-197-summary-timeline-site-privacy-remediation-"
    "reporting-wave-39.py"
)
RUN_197_RECEIPT = (
    "evidence/source/current-run-197-summary-timeline-site-privacy-remediation-"
    "reporting-wave-39.json"
)
RUN_195_RECEIPT = (
    "evidence/browser/current-audit-dashboard-verification-run-195-wave-38.json"
)

RUN_ID = "RUN-198-AUDIT-DASHBOARD-VERIFICATION-WAVE-39"
RUN_197_COMMIT = "5d78179de792198dc03467a1e681445b6c085038"
RUN_197_TREE = "b08abba571d52e36c840c4367272becccac79762"
RUN_197_PARENT = "c797f6b64314c9f507e10844f7dd61a85faace47"
ORIGIN_MAIN = "c39b076547056b1e158c604957a04bd8b75b0f29"
LOCAL_MAIN_BEHIND = 0
LOCAL_MAIN_AHEAD = 85
SHIFT_TASK_BASELINE = "47a6d231c52a78c9f0f606e41d4492d754771027"

RUN_197_MATERIALIZER_RECORD = {
    "path": RUN_197_MATERIALIZER,
    "sha256": "0dbccb27f2ee7d3c008861c760eb396bd7cde04eb22b58d552dc7b5abdfe2662",
    "git_blob_id": "54abeb0bca445dc5bb1d32cc22b19c66537dda0e",
    "bytes": 22291,
    "lines": 548,
}
RUN_197_RECEIPT_RECORD = {
    "path": RUN_197_RECEIPT,
    "sha256": "fb1615a6fe1fc87a002b4cdc683fc57e9d2867ec52decb56c1015ba5f14f1346",
    "git_blob_id": "2f71f92d55edf4cfb6cfc867da4110acf72c4e3e",
    "bytes": 14331,
    "lines": 395,
}
RUN_197_RECEIPT_SELF_SEAL = (
    "60040d25569007339bfebb0a718c9548110a23e595ae2d794659ec0909fdc0b8"
)
RUN_195_RECEIPT_RECORD = {
    "path": RUN_195_RECEIPT,
    "sha256": "455ee26c87ec6f07eca687eb1e40d2049c01513002732d08f74696b3dd617456",
    "git_blob_id": "fef96864488c54857c6df3165d25eaa80ab811b1",
    "bytes": 28880,
    "lines": 767,
}
RUN_195_RECEIPT_SELF_SEAL = (
    "a3dc0871156ba4c6376a92a4cacab8b8697fa0efcd49dea42d212533aff6b284"
)
COMMITTED_FINDINGS = {
    "path": FINDINGS,
    "sha256": "2ef3e5a31844b09006d2727cc2bd8709b69679c96ad5a1d1cc3284ade7109065",
    "git_blob_id": "b0ab8ffadf6b153834e45781d1673a95492f7ce4",
    "bytes": 682499,
    "lines": 11894,
}
COMMITTED_RUN_197_BUILDER = {
    "path": BUILDER,
    "sha256": "f048bbd215375f0f049729796b0c0dbf6ad2f6b1935536488c7b3ac24f53d4c1",
    "git_blob_id": "a2361bf3300e92983009b9d59ccc16155921bf31",
    "bytes": 824761,
    "lines": 7271,
}
COMMITTED_RUN_195_DASHBOARD = {
    "path": HTML,
...
FINAL_RUN_198_BUILDER = {
    "path": BUILDER,
    "sha256": "c20cb8502118fce16f64cf6ea37ebbb397b5bf155a4477d79dc43e1b955780ec",
    "git_blob_id": "ee3d2923e6b24b5e23a7ebb1e6d50bbda964e399",
    "bytes": 827041,
    "lines": 7291,
}
FINAL_RUN_198_BUILDER_DIFF = {
    "path": BUILDER,
    "binary_diff_sha256": (
        "8f9a1ccbfb813a524686dfcbcab1172ea0355d9e9443b20af156d995c778d99d"
    ),
    "numstat": {"added": 24, "deleted": 4},
}
FINAL_RUN_198_DASHBOARD = {
    "path": HTML,
...
FINAL_RUN_198_DASHBOARD_DIFF = {
    "path": HTML,
    "binary_diff_sha256": (
        "a1d861eed0ab7717ee6b43e9574acee249fea2764e7a79cdc2ca409b92bb7c9b"
    ),
...
SHIFT_TASK_RESERVED_PATHS = [
    "app/Jobs/ShiftTaskDueJob.php",
...
BROWSER_VISIBLE_TEXT_BOUNDARIES = [
    ...
    (
        "RUN-196: Summary/timeline Site-privacy defect reproduced and remediated "
        "in exactly four transferred paths"
    ),
    (
        "RUN-196R: exact remediation artifacts independently reviewed GO by "
        "three read-only reviewers"
    ),
    "RUN-197: Summary/timeline historical-remediated record added",
    (
        "17 retained claim identities split into 8 current provisional P1, 2 "
        "historical already-fixed, and 7 historical remediated"
    ),
    ...
    (
        "Before remediation, an actor with action permission but no current "
        "shared-Site access could read another staff member's protected summary "
        "or timeline, and a queued request could continue after authorization changed."
    ),
    (
        "historical issue · remediated on local main · not published to origin/main · "
        "shared-Site staff Summary/timeline authorization and queued requester "
        "revalidation only · feature unassigned · zero static ownership, "
        "adjacent-surface, My Day, browser, benchmark, publication, or completion "
        "inheritance · not a final finding"
    ),
    "baseline 1 failed + 5 passed / 9 assertions",
    "15 focused tests / 32 assertions counted once",
    "zero-assertion vendor-junction attempt",
    "eMAR 2/238 support",
    "shared post-merge 40/438",
    (
        "baseline 39a5d97d7d0f · fix 31a9edfbab32 · local merge 5c8a1357f830 · "
        "current main 44ab5e270aec · origin/main c39b07654705 unchanged"
    ),
    "feature unassigned",
    "other-staff reads require active shared-Site scope unless hr.employees.viewAllSites",
    "queued requester revalidated before protected reads/writes",
    "2/340 mappings",
    ...
    "RUN-195 responsive audit-dashboard verification receipt",
    ...
    "RUN-198 responsive audit-dashboard verification receipt",
...
EXPECTED_SOURCE_LITERAL_BOUNDARIES = 210
EXPECTED_UNIQUE_LOCAL_RESOURCES = 499
EXPECTED_HASHED_LINK_PAIRS = 821
EXPECTED_HASHED_FILE_OCCURRENCES = 819
EXPECTED_UNIQUE_HASHED_FILES = 425
...
SUMMARY_FINDING = "SUMMARY-TIMELINE-SITE-PRIVACY-01"
...
def validate_repository_state() -> None:
    assert git("rev-parse", "HEAD") == RUN_197_COMMIT
    assert git("rev-parse", "main") == RUN_197_COMMIT
    assert git("show", "-s", "--format=%T", "HEAD") == RUN_197_TREE
    assert git("show", "-s", "--format=%P", "HEAD") == RUN_197_PARENT
    assert git("show", "-s", "--format=%s", "HEAD") == (
        "audit: report RUN197 summary remediation"
    )
    ...
    assert committed_record(RUN_197_COMMIT, BUILDER) == COMMITTED_RUN_197_BUILDER
    assert committed_record(RUN_197_COMMIT, HTML) == COMMITTED_RUN_195_DASHBOARD
    assert file_record(BUILDER) == FINAL_RUN_198_BUILDER
    assert file_record(HTML) == FINAL_RUN_198_DASHBOARD
    assert diff_record(BUILDER) == FINAL_RUN_198_BUILDER_DIFF
    assert diff_record(HTML) == FINAL_RUN_198_DASHBOARD_DIFF
    assert (
        git(
            "diff",
            "--name-only",
...
def validate_run_197() -> tuple[dict[str, Any], dict[str, Any]]:
    assert file_record(RUN_197_MATERIALIZER) == RUN_197_MATERIALIZER_RECORD
    assert file_record(RUN_197_RECEIPT) == RUN_197_RECEIPT_RECORD
    assert committed_record(RUN_197_COMMIT, RUN_197_MATERIALIZER) == (
        RUN_197_MATERIALIZER_RECORD
    )
    assert committed_record(RUN_197_COMMIT, RUN_197_RECEIPT) == (
        RUN_197_RECEIPT_RECORD
    )
    assert file_record(FINDINGS) == COMMITTED_FINDINGS
    assert file_record(RUN_195_RECEIPT) == RUN_195_RECEIPT_RECORD

    run_197 = strict_json(RUN_197_RECEIPT)
    verify_self_seal(run_197, RUN_197_RECEIPT_SELF_SEAL)
    assert run_197["run_id"] == (
        "RUN-197-SUMMARY-TIMELINE-SITE-PRIVACY-01-"
        "REMEDIATION-REPORTING-WAVE-39"
    )
    assert run_197["scope"] == {
        "finding_id": SUMMARY_FINDING,
    ...
    transition = run_197["reporting_transition"]
    assert transition["finding_id"] == SUMMARY_FINDING
    ...
    assert run_197["bounded_execution_accounting"]["unique_total"] == {
        "tests": 176,
        "assertions": 2641,
    }
    assert run_197["dashboard_forward_gate"] == {
        "required_run": "RUN-198",
        "dashboard_html_changed_by_run_197": False,
        "preserved_run_195_dashboard_sha256": COMMITTED_RUN_195_DASHBOARD["sha256"],
    ...
    preservation = run_197["preservation_boundary"]
    ...
    assert len(run_197["completion_boundary"]) == 26
    assert all(value is False for value in run_197["completion_boundary"].values())
    assert run_197["credit_boundary"]["live_findings_register_and_reporting_status"]
    assert all(
        value is False
        for key, value in run_197["credit_boundary"].items()
        if key != "live_findings_register_and_reporting_status"
    )
    assert run_197["artifact_completion_test_met"] is True
    assert run_197["audit_completion_test_met"] is False

    run_195 = strict_json(RUN_195_RECEIPT)
    verify_self_seal(run_195, RUN_195_RECEIPT_SELF_SEAL)
    assert run_195["run_id"] == "RUN-195-AUDIT-DASHBOARD-VERIFICATION-WAVE-38"
    assert run_195["pins"]["final_run_195_dashboard"] == COMMITTED_RUN_195_DASHBOARD
    assert run_195["artifact_completion_test_met"] is True
    assert run_195["audit_completion_test_met"] is False

    findings = strict_json(FINDINGS)
    records = findings["records"]
    statuses = Counter(record["record_status"] for record in records)
    assert len(records) == len({record["id"] for record in records}) == 17
    assert statuses == {
        "PROVISIONAL_SOURCE_CLAIM_NOT_FINAL_FINDING": 8,
        "HISTORICAL_SOURCE_ISSUE_ALREADY_FIXED_CURRENT_MAIN_NOT_FINAL_FINDING": 2,
        "HISTORICAL_SOURCE_ISSUE_REMEDIATED_CURRENT_MAIN_NOT_FINAL_FINDING": 7,
    }
    summary = next(record for record in records if record["id"] == SUMMARY_FINDING)
    assert summary["feature_id"] is None
    assert summary["candidate_feature_id"] is None
    assert summary["completion_credit"] is False
    counts = findings["counts"]
    assert counts["retained_claim_records"] == 17
    assert counts["bounded_disposition_tests_passed"] == 176
    assert counts["bounded_disposition_assertions"] == 2641
    assert counts["benchmark_mapped"] == 2
    assert counts["final_no_match"] == 0
    assert counts["benchmark_unresolved"] == 338
    return run_197, run_195
...
def validate_builder_and_html() -> dict[str, Any]:
    ...
    assert '<a href="#checkpoint">RUN-197</a>' in html_text
    ...
    assert len(parser.hrefs) == 970
    assert len(parser.anchor_hrefs) == 969
...
def validate_browser_observation(
    ...
    assert_exact(
        artifact,
        {
            ...
            "http_status": 200,
            "response_content_length": FINAL_RUN_198_DASHBOARD["bytes"],
            "browser_fetched_sha256": FINAL_RUN_198_DASHBOARD["sha256"],
    ...
    for viewport in VIEWPORTS:
        assert_exact(
            viewports[viewport],
            {
                ...
                "tab_id": tab_id,
                "dashboard_sha256": FINAL_RUN_198_DASHBOARD["sha256"],
                "observed_at": observed_at,
                "visible_text_checks": [
...
def build_receipt(
    run_197: dict[str, Any],
    run_195: dict[str, Any],
    ...
    receipt: dict[str, Any] = {
        "schema_version": "run-198-audit-dashboard-verification-wave-39-v1",
        "run_id": RUN_ID,
        "generated_at": None,
        "pins": {
            "run_197_commit": RUN_197_COMMIT,
            "run_197_tree": RUN_197_TREE,
            "run_197_parent": RUN_197_PARENT,
            "origin_main": ORIGIN_MAIN,
            "local_main_ahead": LOCAL_MAIN_AHEAD,
            "local_main_behind": LOCAL_MAIN_BEHIND,
            "run_197_materializer": RUN_197_MATERIALIZER_RECORD,
            "run_197_receipt": RUN_197_RECEIPT_RECORD,
            "run_197_receipt_self_seal_sha256": RUN_197_RECEIPT_SELF_SEAL,
            "run_195_receipt": RUN_195_RECEIPT_RECORD,
            "run_195_receipt_self_seal_sha256": RUN_195_RECEIPT_SELF_SEAL,
            "committed_findings": COMMITTED_FINDINGS,
            "committed_run_197_builder": COMMITTED_RUN_197_BUILDER,
            "committed_run_195_dashboard": COMMITTED_RUN_195_DASHBOARD,
            "final_run_198_builder": FINAL_RUN_198_BUILDER,
            "final_run_198_builder_diff": FINAL_RUN_198_BUILDER_DIFF,
            "final_run_198_dashboard": FINAL_RUN_198_DASHBOARD,
            "final_run_198_dashboard_diff": FINAL_RUN_198_DASHBOARD_DIFF,
            "run_198_materializer": file_record(MATERIALIZER),
        },
        "reported_snapshot": {
            "static": {
        ...
        "reported_transition": {
            "from_dashboard_sha256": COMMITTED_RUN_195_DASHBOARD["sha256"],
            "to_dashboard_sha256": FINAL_RUN_198_DASHBOARD["sha256"],
            "reported_finding_id": SUMMARY_FINDING,
            "run_197_forward_gate_satisfied_by_this_artifact": artifact_complete,
            "static_ownership_or_queue_advance": False,
            "new_application_finding": False,
        },
        "generation": {
            "builder": FINAL_RUN_198_BUILDER,
            "dashboard": FINAL_RUN_198_DASHBOARD,
            "builder_diff": FINAL_RUN_198_BUILDER_DIFF,
            "dashboard_diff": FINAL_RUN_198_DASHBOARD_DIFF,
        ...
        "superseded_run_195_observation": {
            "dashboard": COMMITTED_RUN_195_DASHBOARD,
            "receipt": RUN_195_RECEIPT_RECORD,
            "receipt_artifact_completion_test_met": run_195[
                "artifact_completion_test_met"
            ],
            "superseded_by_dashboard_sha256": FINAL_RUN_198_DASHBOARD["sha256"],
        ...
        "finding_boundary": {
            ...
            "shared_site_staff_summary_timeline_and_queued_revalidation_only": True,
        ...
        "execution_boundary": {
            "bounded_unique_tests": 176,
            "bounded_unique_assertions": 2641,
            "run_198_application_runtime_or_tests_executed": False,
            "run_198_browser_scope": "static audit-dashboard HTML only",
        ...
        "benchmark_boundary": {
            ...
            "final_no_match_or_NCM": 0,
            "unresolved": 338,
            "run_198_benchmark_credit": False,
        },
        "noninheritance": {
        ...
        "worktree_attestation": {
            ...
            "shift_task_reserved_paths_unchanged": True,
        },
        ...
        "credit_boundary": {
            "exact_run_198_dashboard_artifact_verification": artifact_complete,
        ...
        "completion_gates": [
            {
                "name": name,
                "complete": False,
                "reason": "RUN198 verifies one exact dashboard artifact only",
            }
...
def write_receipt(receipt: dict[str, Any]) -> None:
    ...
    output = AUDIT / OUTPUT
    temporary = output.with_name(f".{output.name}.tmp-run198")
...
def main() -> None:
    ...
    run_197, run_195 = validate_run_197()
    html_graph = validate_builder_and_html()
    finalization = finalization_inputs(args, html_graph)
    receipt = build_receipt(run_197, run_195, html_graph, finalization)
