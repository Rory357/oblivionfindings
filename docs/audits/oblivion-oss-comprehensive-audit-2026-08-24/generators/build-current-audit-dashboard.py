...
<body>
  ...
  <main>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-138/R and reported in RUN-139. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
...
dashboard = TEMPLATE.substitute(
    ...
    static_owner_records=reviewed_finance_invoice_index_overlay["combined_counts"]["source_owner_records"],
    static_owner_routes=reviewed_finance_invoice_index_overlay["combined_counts"]["route_owner_records"],
    static_owner_pages=reviewed_finance_invoice_index_overlay["combined_counts"]["page_owner_records"],
    static_owner_features=reviewed_finance_invoice_index_overlay["combined_counts"]["distinct_feature_ids"],
    static_owner_h_features=reviewed_finance_invoice_index_overlay["combined_counts"]["distinct_H_feature_ids"],
    static_owner_d_features=reviewed_finance_invoice_index_overlay["combined_counts"]["distinct_D_feature_ids"],
    route_feature_ids=reviewed_finance_invoice_index_overlay["combined_counts"]["route_distinct_feature_ids"],
    page_feature_ids=reviewed_finance_invoice_index_overlay["combined_counts"]["page_distinct_feature_ids"],
    route_page_overlap=reviewed_finance_invoice_index_overlay["combined_counts"]["route_page_feature_overlap"],
    static_action_bridges=reviewed_finance_invoice_index_overlay["combined_counts"]["static_controller_action_bridges"],
    static_residual=f"{reviewed_finance_invoice_index_overlay['combined_counts']['bounded_static_source_residual_records']:,}",
    ownership_percent=reviewed_finance_invoice_index_overlay["combined_counts"]["bounded_static_source_ownership_percent"],
    route_residual=f"{reviewed_finance_invoice_index_overlay['combined_counts']['residual_explicit_unmapped_routes']:,}",
    route_shared_current=reviewed_finance_invoice_index_overlay["combined_counts"]["semantic_shared_routes"],
    route_alias_current=reviewed_finance_invoice_index_overlay["combined_counts"]["reviewed_alias_routes"],
    page_shared=reviewed_finance_invoice_index_overlay["combined_counts"]["semantic_shared_page_roots"],
    page_residual=reviewed_finance_invoice_index_overlay["combined_counts"]["residual_unadjudicated_page_roots"],
    page_gap=reviewed_finance_invoice_index_overlay["combined_counts"]["evidence_gap_page_roots_tagged_within_residual"],
    ...
    finance_fx_route_gap=reviewed_finance_invoice_index_overlay["combined_counts"]["evidence_gap_routes_tagged_within_residual"],
    ...
    queue_gap=reviewed_finance_invoice_index_overlay["queue_accounting"]["evidence_gap_queue_surface_rows"],
    queue_records=reviewed_finance_invoice_index_overlay["queue_accounting"]["direct_exact_queue_records"],
    queue_reviewed=reviewed_finance_invoice_index_overlay["queue_accounting"]["reviewed_queue_surface_rows"],
    queue_pending=reviewed_finance_invoice_index_overlay["queue_accounting"]["pending_unreviewed_queue_surface_rows"],
    queue_without_owner=reviewed_finance_invoice_index_overlay["queue_accounting"]["queue_surfaces_without_ownership"],
    queue_owner=reviewed_finance_invoice_index_overlay["queue_accounting"]["owner_queue_surface_rows"],
    queue_shared=reviewed_finance_invoice_index_overlay["queue_accounting"]["shared_queue_surface_rows"],
    queue_alias=reviewed_finance_invoice_index_overlay["queue_accounting"]["alias_queue_surface_rows"],
...
temporary_path = output_path.with_name(f".{output_path.name}.tmp-run139-dashboard")
