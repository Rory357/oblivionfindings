...
<body>
  ...
  <main>
    ...
    <section class="panel"><h2>Prior audit-dashboard verification</h2><p>RUN-070, RUN-072, RUN-073, RUN-076, RUN-081, RUN-083, RUN-085, RUN-088, RUN-094, RUN-100, RUN-104, RUN-108, RUN-112, RUN-116, RUN-120, RUN-124, RUN-128, and RUN-132 responsive verification are immutable history for their exact superseded HTML; no prior viewport, overflow, navigation, table, link, anchor, or console proof transfers to RUN-135.</p><ul class="list"><li><a href="evidence/browser/current-audit-dashboard-verification-formal-upstream-wave-03.json">Superseded RUN-070 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-072-wave-04.json">Superseded RUN-072 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-073-wave-05.json">Superseded RUN-073 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-076-wave-06.json">Superseded RUN-076 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-081-wave-07.json">Superseded RUN-081 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-083-wave-08.json">Superseded RUN-083 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-085-wave-09.json">Superseded RUN-085 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-088-wave-10.json">Superseded RUN-088 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-094-wave-11.json">Superseded RUN-094 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-100-wave-12.json">Superseded RUN-100 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-104-wave-13.json">Superseded RUN-104 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-108-wave-14.json">Superseded RUN-108 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-112-wave-15.json">Superseded RUN-112 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-116-wave-16.json">Superseded RUN-116 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-120-wave-17.json">Superseded RUN-120 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-124-wave-18.json">Superseded RUN-124 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-128-wave-19.json">Superseded RUN-128 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-132-wave-20.json">Superseded RUN-132 verification GO</a></li></ul></section>
    <section class="panel"><h2>Fresh RUN-136 audit-dashboard verification</h2><p>The exact regenerated RUN-135 dashboard must be checked at 1440×900, 1280×800, 1024×768, and 390×844. The linked RUN-136 receipt must record page overflow, bounded mobile table scrolling, navigation, local links, anchors, duplicate authored IDs, console output, visible 660/303/357 ownership, six accounting-integration route/action owners and six bridges, 62/242/48 route/page/overlap feature sets, 91 cumulative bridges, route 3,218=303+12+5+2,898 with seven tagged gaps, page 711=357+9+345 with one tagged gap, queue 507=114+393 with 114=92+10+5+7 and 415 without ownership, 3,269 residual records, six packet expansions (two existing plus four new), 22 assurance findings (15 plus seven) with zero final-finding credit, one operating organisation across multiple Sites, provider tenant_id as external-provider context, Gate 4 open, mapping 0/340, and all zero-credit boundaries. It verifies the audit artifact only and grants no application-browser, responsive-application, visual, workflow, finding, runtime, test, release, Pass, completion, or audit-complete credit.</p><ul class="list"><li><a href="evidence/browser/current-audit-dashboard-verification-run-136-wave-21.json">RUN-136 responsive audit-dashboard verification receipt</a></li></ul></section>
    <section class="panel"><h2>RUN-071–135 evidence lineage</h2><p>Every current raw, generated, reviewed, and integrated RUN-077–135 source/reporting artifact is linked with its exact SHA-256. Earlier receipts remain immutable history; the task-script directory link carries the historical RUN-072 300-file bundle hash.</p><ul class="list">$checkpoint_evidence_links</ul></section>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-134/R and reported in RUN-135. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
...
dashboard = TEMPLATE.substitute(
    ...
    static_owner_records=reviewed_finance_accounting_integration_overlay["combined_counts"]["source_owner_records"],
    static_owner_routes=reviewed_finance_accounting_integration_overlay["combined_counts"]["route_owner_records"],
    static_owner_pages=reviewed_finance_accounting_integration_overlay["combined_counts"]["page_owner_records"],
    static_owner_features=reviewed_finance_accounting_integration_overlay["combined_counts"]["distinct_feature_ids"],
    static_owner_h_features=reviewed_finance_accounting_integration_overlay["combined_counts"]["distinct_H_feature_ids"],
    static_owner_d_features=reviewed_finance_accounting_integration_overlay["combined_counts"]["distinct_D_feature_ids"],
    route_feature_ids=reviewed_finance_accounting_integration_overlay["combined_counts"]["route_distinct_feature_ids"],
    page_feature_ids=reviewed_finance_accounting_integration_overlay["combined_counts"]["page_distinct_feature_ids"],
    route_page_overlap=reviewed_finance_accounting_integration_overlay["combined_counts"]["route_page_feature_overlap"],
    static_action_bridges=reviewed_finance_accounting_integration_overlay["combined_counts"]["static_controller_action_bridges"],
    static_residual=f"{reviewed_finance_accounting_integration_overlay['combined_counts']['bounded_static_source_residual_records']:,}",
    ownership_percent=reviewed_finance_accounting_integration_overlay["combined_counts"]["bounded_static_source_ownership_percent"],
    route_residual=f"{reviewed_finance_accounting_integration_overlay['combined_counts']['residual_explicit_unmapped_routes']:,}",
    route_shared_current=reviewed_finance_accounting_integration_overlay["combined_counts"]["semantic_shared_routes"],
    route_alias_current=reviewed_finance_accounting_integration_overlay["combined_counts"]["reviewed_alias_routes"],
    page_shared=reviewed_finance_accounting_integration_overlay["combined_counts"]["semantic_shared_page_roots"],
    page_residual=reviewed_finance_accounting_integration_overlay["combined_counts"]["residual_unadjudicated_page_roots"],
    page_gap=reviewed_finance_accounting_integration_overlay["combined_counts"]["evidence_gap_page_roots_tagged_within_residual"],
    ...
    queue_gap=reviewed_finance_accounting_integration_overlay["queue_accounting"]["evidence_gap_queue_surface_rows"],
    queue_records=reviewed_finance_accounting_integration_overlay["queue_accounting"]["direct_exact_queue_records"],
    queue_reviewed=reviewed_finance_accounting_integration_overlay["queue_accounting"]["reviewed_queue_surface_rows"],
    queue_pending=reviewed_finance_accounting_integration_overlay["queue_accounting"]["pending_unreviewed_queue_surface_rows"],
    queue_without_owner=reviewed_finance_accounting_integration_overlay["queue_accounting"]["queue_surfaces_without_ownership"],
    queue_owner=reviewed_finance_accounting_integration_overlay["queue_accounting"]["owner_queue_surface_rows"],
    queue_shared=reviewed_finance_accounting_integration_overlay["queue_accounting"]["shared_queue_surface_rows"],
    queue_alias=reviewed_finance_accounting_integration_overlay["queue_accounting"]["alias_queue_surface_rows"],
...
temporary_path = output_path.with_name(f".{output_path.name}.tmp-run135-dashboard")
