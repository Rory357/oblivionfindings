...
<body>
  ...
  <main>
    <div class="notice" role="status"><strong>No completion claim:</strong> 186 grouped rows are a provisional discovery floor, not a frozen feature denominator. The 711-page committed-source denominator and static route, visual, backend, migration-history, and test locators do not establish runtime routes, final mapping, rendered browser coverage, executed tests, benchmark credit, task/ease scores, journeys, or all-pass modules.</div>
    ...
    <div class="split"><section class="panel"><h2>Formal waves</h2><p>RUN-001 through RUN-014 returned and reported no file writes.</p><ul class="list"><li>RUN-001: initial semantic route/page/backend/data/test census</li><li>RUN-002–006: first 172 grouped source candidates</li><li>RUN-007–009: observer, neutralizer, and eight native comparison packets</li><li>RUN-010–011: page/support adjudication and independent reconciliation</li><li>RUN-012: 38-route-file and 162-navigation-file reconciliation plus 14 provisional additions</li><li>RUN-013: full production JS/TS hero, overlay, state, and trigger census</li><li>RUN-014: backend, data-history, async, policy, and static test census</li></ul></section><section class="panel"><h2>Execution credit</h2><p>Static evidence is not runtime evidence.</p><ul class="list"><li><span class="zero">0</span> framework route executions</li><li><span class="zero">0</span> current application tests</li><li><span class="zero">0</span> rendered current-build visual instances</li><li><span class="zero">0</span> current-build application browser routes</li><li><span class="zero">0</span> benchmark mappings promoted</li><li><span class="zero">0</span> completed Pass 1–8 modules</li></ul></section></div>
    <section id="static-census" class="panel"><h2>Expanded static coverage wave</h2><p>RUN-012 through RUN-014 establish source denominators and gaps only. The required row-level visual materialization, canonical feature map, schema truth, and execution gates remain open.</p><div class="table-wrap"><table><thead><tr><th>Static universe</th><th>Denominator</th><th>Current boundary</th></tr></thead><tbody><tr><td>Route source files / callsites</td><td>$route_file_count / $route_calls</td><td class="partial">all files classified; no framework expansion</td></tr><tr><td>Named navigation/tab source files</td><td>$nav_file_count</td><td class="partial">definitions, not runtime-visible links</td></tr><tr><td>Hero definitions / instances</td><td>$hero_definitions / $hero_instances</td><td class="partial">static AST; 0 rendered</td></tr><tr><td>Overlay definitions / instances</td><td>$overlay_definitions / $overlay_instances</td><td class="partial">static AST; row materialization pending</td></tr><tr><td>Declarative overlay triggers</td><td>$declarative_triggers</td><td class="partial">separate handler/state ledgers retained</td></tr><tr><td>Models / policies / service entries</td><td>$models / $policies / $services</td><td class="partial">directory/declaration census, not ownership completion</td></tr><tr><td>Jobs / events / listeners</td><td>$jobs / $events / $listeners</td><td class="partial">static owners, no queue execution</td></tr><tr><td>Migrations / lexical PHP test cases</td><td>$migrations / $php_test_cases</td><td class="partial">history and locators; 0 database/test execution</td></tr></tbody></table></div></section>
