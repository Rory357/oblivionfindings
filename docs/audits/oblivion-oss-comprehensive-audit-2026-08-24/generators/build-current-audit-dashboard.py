...
assert page_render_owner_cohort["counts"]["selected_page_candidates"] == 24
assert page_render_owner_cohort["counts"]["page_ownership_credit_awarded"] == 0
assert page_render_owner_review["decision"]["verdict"] == "GO_20_EXPLICIT_OWNER_PAGE_3_SHARED_RELATION_1_EVIDENCE_GAP"
assert page_render_owner_review["decision"]["owner_pages"] == 20
assert page_render_owner_review["decision"]["shared_relations"] == 3
assert page_render_owner_review["decision"]["evidence_gaps"] == 1
...
assert reviewed_page_owner_overlay["combined_counts"]["source_owner_records"] == 612
assert reviewed_page_owner_overlay["combined_counts"]["route_owner_records"] == 265
assert reviewed_page_owner_overlay["combined_counts"]["page_owner_records"] == 347
...
assert reviewed_page_owner_overlay["combined_counts"]["bounded_static_source_residual_records"] == 3317
assert reviewed_page_owner_overlay["combined_counts"]["residual_unadjudicated_page_roots"] == 359
assert reviewed_page_owner_overlay["combined_counts"]["semantic_shared_page_roots"] == 5
assert reviewed_page_owner_overlay["combined_counts"]["evidence_gap_page_roots_tagged_within_residual"] == 1
assert reviewed_page_owner_overlay["queue_accounting"]["reviewed_queue_surface_rows"] == 59
assert reviewed_page_owner_overlay["queue_accounting"]["owner_queue_surface_rows"] == 54
assert reviewed_page_owner_overlay["queue_accounting"]["shared_queue_surface_rows"] == 2
assert reviewed_page_owner_overlay["queue_accounting"]["alias_queue_surface_rows"] == 3
assert reviewed_page_owner_overlay["queue_accounting"]["pending_unreviewed_queue_surface_rows"] == 448
...
assert 507 == 59 + 448
assert 59 == 54 + 2 + 3
assert reviewed_page_owner_overlay["credit_boundary"]["STATIC_PAGE_FEATURE_OWNERSHIP_FOR_20_RECORDS"] is True
assert all(
...
<body>
  ...
  <main>
    ...
    <section class="panel"><h2>Prior audit-dashboard verification</h2><p>RUN-070, RUN-072, RUN-073, RUN-076, RUN-081, RUN-083, RUN-085, RUN-088, RUN-094, RUN-100, and RUN-104 responsive verification are immutable history for their exact superseded HTML; no prior viewport, overflow, navigation, table, link, anchor, or console proof transfers to RUN-107.</p><ul class="list"><li><a href="evidence/browser/current-audit-dashboard-verification-formal-upstream-wave-03.json">Superseded RUN-070 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-072-wave-04.json">Superseded RUN-072 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-073-wave-05.json">Superseded RUN-073 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-076-wave-06.json">Superseded RUN-076 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-081-wave-07.json">Superseded RUN-081 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-083-wave-08.json">Superseded RUN-083 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-085-wave-09.json">Superseded RUN-085 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-088-wave-10.json">Superseded RUN-088 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-094-wave-11.json">Superseded RUN-094 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-100-wave-12.json">Superseded RUN-100 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-104-wave-13.json">Superseded RUN-104 verification GO</a></li></ul></section>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-106/R and reported in RUN-107. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
