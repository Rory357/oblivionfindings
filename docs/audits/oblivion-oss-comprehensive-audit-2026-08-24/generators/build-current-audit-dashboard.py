...
agents = read_json("evidence/benchmark/current-benchmark-agent-register.json")
...
<body>
  ...
  <main>
    ...
    <section id="progress" class="cards" aria-label="Current audit progress">
      ...
      <div class="card"><strong>$assignment_count / 11</strong><span>formal assignments / planned target</span><small>prompt minimum 8 met; finalization open</small></div><div class="card"><strong class="partial">$finding_count</strong><span>provisional P1 claims</span><small>none final</small></div><div class="card"><strong class="zero">0</strong><span>current runtime tests</span><small>not executed</small></div><div class="card"><strong class="zero">0</strong><span>all-pass modules</span><small>denominator still open</small></div>
    </section>
