...
<body>
  ...
  <main>
    ...
    <section class="panel"><h2>Prior audit-dashboard verification</h2><p>RUN-070, RUN-072, RUN-073, RUN-076, RUN-081, RUN-083, RUN-085, RUN-088, RUN-094, RUN-100, RUN-104, and RUN-108 responsive verification are immutable history for their exact superseded HTML; no prior viewport, overflow, navigation, table, link, anchor, or console proof transfers to RUN-111.</p><ul class="list"><li><a href="evidence/browser/current-audit-dashboard-verification-formal-upstream-wave-03.json">Superseded RUN-070 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-072-wave-04.json">Superseded RUN-072 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-073-wave-05.json">Superseded RUN-073 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-076-wave-06.json">Superseded RUN-076 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-081-wave-07.json">Superseded RUN-081 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-083-wave-08.json">Superseded RUN-083 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-085-wave-09.json">Superseded RUN-085 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-088-wave-10.json">Superseded RUN-088 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-094-wave-11.json">Superseded RUN-094 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-100-wave-12.json">Superseded RUN-100 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-104-wave-13.json">Superseded RUN-104 verification GO</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-108-wave-14.json">Superseded RUN-108 verification GO</a></li></ul></section>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-110/R and reported in RUN-111. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
...
dashboard = TEMPLATE.substitute(
    ...
    static_owner_routes=reviewed_page_owner_overlay["combined_counts"]["route_owner_records"],
    static_owner_pages=reviewed_page_owner_overlay["combined_counts"]["page_owner_records"],
    static_owner_features=reviewed_page_owner_overlay["combined_counts"]["distinct_feature_ids"],
    static_action_bridges=reviewed_page_owner_overlay["combined_counts"]["static_controller_action_bridges"],
    static_residual=f"{reviewed_page_owner_overlay['combined_counts']['bounded_static_source_residual_records']:,}",
    ownership_percent=reviewed_page_owner_overlay["combined_counts"]["bounded_static_source_ownership_percent"],
    page_shared=reviewed_page_owner_overlay["combined_counts"]["semantic_shared_page_roots"],
    page_residual=reviewed_page_owner_overlay["combined_counts"]["residual_unadjudicated_page_roots"],
    page_gap=reviewed_page_owner_overlay["combined_counts"]["evidence_gap_page_roots_tagged_within_residual"],
    ...
    queue_records=reviewed_page_owner_overlay["queue_accounting"]["direct_exact_queue_records"],
    queue_pending=reviewed_page_owner_overlay["queue_accounting"]["pending_unreviewed_queue_surface_rows"],
    queue_without_owner=reviewed_page_owner_overlay["queue_accounting"]["queue_surfaces_without_ownership"],
    queue_owner=reviewed_page_owner_overlay["queue_accounting"]["owner_queue_surface_rows"],
    queue_shared=reviewed_page_owner_overlay["queue_accounting"]["shared_queue_surface_rows"],
    queue_alias=reviewed_page_owner_overlay["queue_accounting"]["alias_queue_surface_rows"],
...
temporary_path = output_path.with_name(f".{output_path.name}.tmp-run107-dashboard")
