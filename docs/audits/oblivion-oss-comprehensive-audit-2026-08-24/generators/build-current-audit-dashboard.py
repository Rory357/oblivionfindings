...
<body>
  ...
  <main>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-102/R and reported in RUN-103. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
...
temporary_path = output_path.with_name(f".{output_path.name}.tmp-run103-dashboard")
