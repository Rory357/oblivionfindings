...
<body>
  ...
  <main>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-114/R and reported in RUN-115. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
...
dashboard = TEMPLATE.substitute(
    ...
    static_owner_records=reviewed_name_only_route_action_overlay["combined_counts"]["source_owner_records"],
...
temporary_path = output_path.with_name(f".{output_path.name}.tmp-run115-dashboard")
