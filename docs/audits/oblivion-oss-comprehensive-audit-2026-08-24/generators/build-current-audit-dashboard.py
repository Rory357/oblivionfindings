...
<body>
  ...
  <main>
    ...
    <p class="footer">Generated deterministically from independently reviewed static evidence through RUN-149 and reported in RUN-150. Exactly two matrix rows have static benchmark-mapping credit; all other application/runtime/browser/test/Pass/finding/completion boundaries remain unchanged. Audit artifacts only; no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
