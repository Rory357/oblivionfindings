...
<body>
  ...
  <main>
    ...
    <div class="split"><section class="panel"><h2>Evidence waves represented</h2><p>RUN-001 through RUN-038 are represented by audit artifacts; none grants application runtime, browser, executed-test, benchmark, or completion credit.</p><ul class="list"><li>RUN-001–016: census, discovery, page/static visual, and benchmark-metadata foundations</li><li>RUN-017–022: frontline/platform identity adjudication and blocked-owner reconciliation</li><li>RUN-023–025: cross-scope and remaining-owner arbitration</li><li>RUN-026: report-catalog identity adjudication</li><li>RUN-027: medical-profile owner tie-break</li><li>RUN-028–029: denominator integration and independent red team</li><li>RUN-030: deterministic materialization of 362 Layer-A edges and 340 canonical targets</li><li>RUN-031–033: disjoint upstream observer-triage partitions covering 95 repositories and 98 occurrence-weighted entries</li><li>RUN-034: normalized observer-only triage integration with 79 complete and 16 partial records</li><li>RUN-035–037: disjoint official-source reviews of every partial observer record</li><li>RUN-038: deterministic blocker-resolution integration with 9 resolved observer-only, 7 retained partial, and zero downstream credit</li></ul></section><section class="panel"><h2>Execution credit</h2><p>Static and observer evidence are not runtime evidence.</p><ul class="list"><li><span class="zero">0</span> framework route executions</li><li><span class="zero">0</span> current application tests</li><li><span class="zero">0</span> rendered current-build visual instances</li><li><span class="zero">0</span> current-build application browser routes</li><li><span class="zero">0</span> benchmark mappings promoted</li><li><span class="zero">0</span> completed Pass 1–8 modules</li></ul></section></div>
...
dashboard = TEMPLATE.substitute(
    ...
    generated_at=partial_resolution["generated_at"],
)
