...
assert all(sha256_file(path) == digest for path, digest in route_page_candidate_reporting["outputs"].items())
...
<body>
  ...
  <main>
    ...
    <section id="checkpoint" class="panel">
      <h2>RUN-071–083 completion-gate checkpoint</h2>
      <p>The 26 literal completion gates were reconciled before RUN-072 added source-bound usability and incident-chain evidence, RUN-073 materialized reporting paths and source synthesis, RUN-074–076 reconstructed bounded feature-side linkage, RUN-077–081 materialized, independently reviewed, integrated, and reported the exhaustive committed static route/name/page universe, and RUN-082–083 added a pending-review candidate census plus reporting. Static relation or registration artifacts are not measured task, framework reachability, runtime, browser, mapping, Pass, final-finding, or completion evidence.</p>
    ...
    <section class="panel"><h2>Prior audit-dashboard verification</h2><p>RUN-070, RUN-072, RUN-073, RUN-076, and RUN-081 responsive verification are immutable history for superseded HTML; no prior viewport, overflow, navigation, table, link, or console proof transfers to RUN-083.</p><ul class="list"><li><a href="evidence/browser/current-audit-dashboard-verification-formal-upstream-wave-03.json">Superseded RUN-070 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-072-wave-04.json">Superseded RUN-072 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-073-wave-05.json">Superseded RUN-073 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-076-wave-06.json">Superseded RUN-076 verification</a></li><li><a href="evidence/browser/current-audit-dashboard-verification-run-081-wave-07.json">Superseded RUN-081 verification</a></li></ul></section>
    ...
    <p class="footer">Generated deterministically from static candidate evidence through RUN-082 and reported in RUN-083. The matrix is unchanged; audit artifacts only and no application remediation is authorised.</p>
  </main>
</body>
</html>
""")
...
temporary_path = output_path.with_name(f".{output_path.name}.tmp-run083-dashboard")
