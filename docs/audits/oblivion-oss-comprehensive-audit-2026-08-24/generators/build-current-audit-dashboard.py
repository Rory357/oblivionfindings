...
agents = read_json("evidence/source/current-page-agent-register.json")
...
<body>
  ...
  <nav aria-label="Audit sections"><div><a href="#progress">Progress</a><a href="#pages">Pages</a><a href="#benchmarks">Benchmarks</a><a href="#modules">Modules</a><a href="#findings">Provisional findings</a><a href="#gaps">Gaps</a></div></nav>
  <main>
    <div class="notice" role="status"><strong>No completion claim:</strong> 172 grouped rows are discovery candidates, not a frozen feature denominator. The 711-page committed-source denominator does not establish final prompt page classification, runtime routes, feature mapping, browser coverage, tests, benchmark credit, task/ease scores, journeys, visual states, or all-pass modules.</div>
    <section id="progress" class="cards" aria-label="Current audit progress">
      ...
      <div class="card"><strong>$assignment_count / 11</strong><span>formal assignments / planned target</span><small>planned target met; finalization open</small></div><div class="card"><strong class="partial">$finding_count</strong><span>provisional P1 claims</span><small>none final</small></div><div class="card"><strong class="zero">0</strong><span>current runtime tests</span><small>not executed</small></div><div class="card"><strong class="zero">0</strong><span>all-pass modules</span><small>denominator still open</small></div>
    </section>
    ...
    <div class="split"><section class="panel"><h2>Formal waves</h2><p>RUN-001 through corrected RUN-011 returned and reported no file writes.</p><ul class="list"><li>RUN-001: semantic route/page/backend/data/test census</li><li>RUN-002–006: 172 grouped source candidates</li><li>RUN-007: 97-project local structural review plus provisional observations</li><li>RUN-008: neutralization and collision challenge</li><li>RUN-009: eight high-risk native comparison packets</li><li>RUN-010: 25 page/support and 11 missing-render adjudications</li><li>RUN-011: independent NO-GO, bounded corrections, then replacement GO</li></ul></section><section class="panel"><h2>Execution credit</h2><p>Static evidence is not runtime evidence.</p><ul class="list"><li><span class="zero">0</span> framework route executions</li><li><span class="zero">0</span> current application tests</li><li><span class="zero">0</span> current-build application browser routes</li><li><span class="zero">0</span> benchmark mappings promoted</li><li><span class="zero">0</span> completed Pass 1–8 modules</li></ul></section></div>
    <section id="benchmarks" class="panel"><h2>Current benchmark wave</h2><p>Historical rows were checked locally for structure; no project was refreshed upstream and no current candidate received mapping credit.</p><div class="table-wrap"><table><thead><tr><th>Evidence slice</th><th>Count</th><th>Current credit</th></tr></thead><tbody><tr><td>Historical physical register rows</td><td>$register_physical</td><td class="partial">97 prompt projects + 1 supplemental</td></tr><tr><td>Current upstream project refreshes</td><td>$upstream_refreshes / 97</td><td class="zero">none</td></tr><tr><td>Observer relations</td><td>$observer_records records / $observer_unique candidates</td><td class="partial">provisional only</td></tr><tr><td>Neutralizer adjudications</td><td>$neutralizer_count</td><td class="partial">challenge evidence only</td></tr><tr><td>Native comparator packets</td><td>$comparator_count</td><td class="partial">bounded static packets</td></tr><tr><td>Promoted feature mappings or final no-matches</td><td>$promoted_count</td><td class="zero">denominator not frozen</td></tr></tbody></table></div></section>
    ...
    <section id="gaps" class="panel"><h2>Literal completion gates still open</h2><div class="split"><ul class="list"><li>Framework route reachability and route/page-to-feature mapping</li><li>Final H/D/M identity and collision adjudication</li><li>Complete backend/data/test ownership</li><li>Current upstream project evidence and one final mapping or documented no-match per frozen feature</li><li>Task scripts and ten ease dimensions per H feature</li></ul><ul class="list"><li>Eight cross-module journeys at required viewports</li><li>Hero, overlay, trigger, and material-state universes</li><li>Safe current-build application browser/runtime lanes</li><li>Every module through Passes 1–8</li><li>Fresh Pass 8, freeze, reconciliation, and no-live-agent gate</li></ul></div></section>
    <section class="panel"><h2>Evidence files</h2><ul class="list"><li><a href="00-executive-summary.md">Executive summary</a></li><li><a href="01-repository-module-map.md">Current repository and page map</a></li><li><a href="02-repository-module-map-wave-02.md">Wave 02 module map</a></li><li><a href="03-feature-to-benchmark-matrix.csv">Interim feature-to-benchmark matrix</a></li><li><a href="06-open-source-benchmark-register.csv">Current carry-forward benchmark register</a></li><li><a href="evidence/source/current-static-semantic-census.json">Semantic census JSON</a></li><li><a href="evidence/source/current-page-adjudication-wave-01.json">Page adjudication evidence</a></li><li><a href="evidence/source/current-page-agent-register.json">Page agent register</a></li><li><a href="evidence/source/current-feature-discovery-wave-01.json">Feature wave 01 JSON</a></li><li><a href="evidence/source/current-feature-discovery-wave-02.json">Feature wave 02 JSON</a></li><li><a href="evidence/benchmark/current-benchmark-wave-01.json">Benchmark wave evidence</a></li><li><a href="evidence/benchmark/current-benchmark-agent-register.json">Benchmark agent register</a></li><li><a href="13-unresolved-questions-and-evidence-gaps.md">Unresolved evidence gaps</a></li></ul></section>
...
dashboard = TEMPLATE.substitute(
    ...
    register_physical=benchmark["project_register_current_audit"]["historical_rows_structurally_validated_local_only"] + benchmark["project_register_current_audit"]["supplemental_rows_structurally_validated_local_only"],
    upstream_refreshes=benchmark["project_register_current_audit"]["current_upstream_project_refreshes"],
