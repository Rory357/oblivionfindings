#!/usr/bin/env python3
"""Materialize the remaining source-bound reporting artifacts without awarding audit credit.
...
AUDIT_CHECKPOINT = "0d9a6c4c44c236e1c0695f25191bc962b73efe4e"
...
def write_text(relative: str, text: str) -> None:
    (AUDIT_DIR / relative).write_text(text.rstrip() + "\n", encoding="utf-8", newline="\n")
...
evidence = {
    "schema_version": 1,
    "run_id": "RUN-073-REPORTING-MATERIALIZATION",
    ...
    "outputs": {relative: sha256(relative) for relative in outputs},
    "credit_boundary": {
...
write_json("evidence/source/current-required-reporting-materialization-wave-05.json", evidence)
