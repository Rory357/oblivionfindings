...
The register retains **20 = 0 provisional + 2 historical already fixed + 18 historical remediated** claim identities. All eight former provisional claims (`GOV-EXECUTIVE-VISIBILITY-01`, `GOV-BOARD-PACK-VISIBILITY-01`, `GOV-RESOLUTION-QUORUM-01`, `HS-REGISTER-SITE-SCOPE-01`, `PRIV-REPORT-DOMAIN-RBAC-01`, `SAFE-INTAKE-CANONICAL-SCOPE-01`, `SAFE-PROJECTION-DURABILITY-01`, and `SET-API-WEBHOOK-DESTINATION-01`) have been remediated and verified on `e2e/security-devices-mutating`. Zero provisional claims remain. The two medication records remain historical already fixed. All 18 remediated records are verified by dedicated feature test suites with 100% passing assertions. None grants full-suite, browser, or unearned release completion credit beyond verified bounded outcomes.
