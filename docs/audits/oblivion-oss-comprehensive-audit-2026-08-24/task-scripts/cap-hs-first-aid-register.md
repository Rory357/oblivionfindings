# CAP-HS-FIRST-AID-REGISTER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Record first aid, follow-up, evidence, and linked incidents
- Matrix source owner, not assumed human actor: `FirstAidController`
...
- Backend: `app/Http/Controllers/HealthSafety/FirstAidController.php:55-115`
- Tests: `tests/Feature/HealthSafety/FirstAidControllerTest.php:84-148`
...
3. Attempt only the matrix-defined user job: Record first aid, follow-up, evidence, and linked incidents.
