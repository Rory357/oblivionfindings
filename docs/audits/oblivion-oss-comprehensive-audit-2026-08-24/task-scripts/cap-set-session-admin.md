# CAP-SET-SESSION-ADMIN

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Public & Settings Platform`
- User job: Terminate a user's active sessions
- Matrix source owner, not assumed human actor: `Access, roles, users, and SSO controllers`
...
- Backend: `app/Http/Controllers/Settings/AccessController.php:53-271; app/Http/Controllers/System/UsersController.php:490; app/Http/Controllers/System/UsersController.php:512`
- Tests: `tests/Feature/System/AccessControlControllerTest.php:31-111`
...
3. Attempt only the matrix-defined user job: Terminate a user's active sessions.
