...
- Module: `Governance`
- User job: Draft, approve, publish, and version governance policies
- Matrix source owner, not assumed human actor: `GovernancePolicyController and policy`
...
- Backend: `app/Domain/Governance/Http/Controllers/GovernancePolicyController.php:13; app/Domain/Governance/Http/Controllers/GovernancePolicyController.php:15-258; app/Domain/Governance/Http/Controllers/GovernancePolicyController.php:156`
- Tests: `tests/Browser/Governance/GovernancePoliciesTest.php:6`
...
3. Attempt only the matrix-defined user job: Draft, approve, publish, and version governance policies.
