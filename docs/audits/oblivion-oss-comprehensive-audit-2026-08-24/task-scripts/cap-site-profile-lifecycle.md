# CAP-SITE-PROFILE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Sites & Locations`
- User job: Create, edit, archive, and restore an operational Site
- Matrix source owner, not assumed human actor: `SiteController, SiteProfileData, and UserSiteAccessService`
...
- Backend: `app/Services/Sites/SiteProfileData.php:30-102`
- Tests: `tests/Feature/Sites/SiteProfileAuthorizationTest.php:72-145`
...
3. Attempt only the matrix-defined user job: Create, edit, archive, and restore an operational Site.
