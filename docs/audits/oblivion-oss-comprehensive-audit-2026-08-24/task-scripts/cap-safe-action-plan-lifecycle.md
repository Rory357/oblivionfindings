# CAP-SAFE-ACTION-PLAN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Safeguarding`
- User job: Create, update, progress, and complete a safeguarding action plan
- Matrix source owner, not assumed human actor: `SafeguardingActionPlanController`
...
- Route paths: `routes/safeguarding.php:98-106`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/SafeguardingActionPlanController.php; app/Http/Controllers/SafeguardingActionPlanController.php:10-88`
...
3. Attempt only the matrix-defined user job: Create, update, progress, and complete a safeguarding action plan.
