...
- Module: `IT & Support`
- User job: Create, update, and transition major IT incidents
- Matrix source owner, not assumed human actor: `IT service, change, problem, and major-incident services`
...
- Backend: `app/Domain/It/Services/ItMajorIncidentService.php:24; app/Domain/It/Services/ItMajorIncidentService.php:33-397`
- Tests: `tests/Feature/It/ItWorkAccessControllerTest.php:441-477`
...
3. Attempt only the matrix-defined user job: Create, update, and transition major IT incidents.
