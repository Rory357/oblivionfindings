...
- Module: `Fleet & Assets`
- User job: View consented, authorised resident transport tracking
- Matrix source owner, not assumed human actor: `ResidentTrackingController`
...
- Route paths: `routes/fleet-assets.php:207-224; routes/fleet-assets.php:212-223`
- Pages: `resources/js/pages/fleet-assets/resident-tracking/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/ResidentTrackingController.php:34-754`
...
3. Attempt only the matrix-defined user job: View consented, authorised resident transport tracking.
