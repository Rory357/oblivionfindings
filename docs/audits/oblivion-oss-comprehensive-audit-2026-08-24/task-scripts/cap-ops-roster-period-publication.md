# CAP-OPS-ROSTER-PERIOD-PUBLICATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Review, validate, publish, compare, republish, and unpublish a Site roster period.
- Matrix source owner, not assumed human actor: `RosteringController and RosterPublishingService`
...
- Route paths: `routes/operations.php:968-981`
- Pages: `resources/js/pages/operations/rostering/publish/Review.tsx:1-485`
- Backend: `app/Domain/Rostering/RosterPublishingService.php:12-354; app/Models/RosterPeriod.php:1`
- Tests: `tests/Feature/Rostering/RosterPublishingTest.php:11-133`
...
3. Attempt only the matrix-defined user job: Review, validate, publish, compare, republish, and unpublish a Site roster period..
