# CAP-CR-LIVE-DEVICE-MAP

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: View the authorised live device map and its device projection
- Matrix source owner, not assumed human actor: `Device visibility, playbook, and settings owners`
...
- Route paths: `routes/control-room.php:214; routes/control-room.php:379-386`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomDeviceController.php:16-288; app/Http/Controllers/ControlRoom/ControlRoomMapController.php:21-111`
...
3. Attempt only the matrix-defined user job: View the authorised live device map and its device projection.
