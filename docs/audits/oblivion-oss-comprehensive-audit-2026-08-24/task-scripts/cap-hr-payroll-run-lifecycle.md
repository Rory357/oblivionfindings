# CAP-HR-PAYROLL-RUN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Prepare and govern payroll runs
...
- Backend: `app/Domain/Hr/Models/HrPayrollRun.php:18; app/Http/Controllers/Hr/PayrollExportController.php:239; app/Http/Controllers/Hr/PayrollExportController.php:25`
...
3. Attempt only the matrix-defined user job: Prepare and govern payroll runs.
