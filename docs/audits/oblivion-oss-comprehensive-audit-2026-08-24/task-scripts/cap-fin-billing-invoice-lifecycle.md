...
- Module: `Finance`
- User job: Create, send, pay, and cancel invoices
...
- Route paths: `routes/finance.php:347-415; routes/finance.php:675`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/InvoiceController.php:33`
- Tests: `tests/Feature/Finance/QuoteConversionIntegrityTest.php:92`
...
3. Attempt only the matrix-defined user job: Create, send, pay, and cancel invoices.
