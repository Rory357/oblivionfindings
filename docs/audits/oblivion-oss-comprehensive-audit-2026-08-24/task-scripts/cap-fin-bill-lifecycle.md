# CAP-FIN-BILL-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Capture, approve, and settle supplier bills
...
- Backend: `app/Domain/Finance/Http/Controllers/BillController.php:19; app/Domain/Finance/Services/AccountsPayableService.php:116`
...
3. Attempt only the matrix-defined user job: Capture, approve, and settle supplier bills.
