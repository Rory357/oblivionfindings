# CAP-MED-STAFF-COMPETENCY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Assess and maintain staff medication competency
- Matrix source owner, not assumed human actor: `Medication competency owner`
...
- Route paths: `routes/emar.php:104-106; routes/emar.php:186-188`
- Pages: `resources/js/pages/emar/Competency.tsx`
...
3. Attempt only the matrix-defined user job: Assess and maintain staff medication competency.
