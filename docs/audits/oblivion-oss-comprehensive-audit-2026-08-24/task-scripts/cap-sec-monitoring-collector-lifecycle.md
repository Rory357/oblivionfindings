# CAP-SEC-MONITORING-COLLECTOR-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Issue, re-enrol, and revoke Site-scoped monitoring collectors
...
- Backend: `app/Domain/SecurityDevices/Http/Controllers/MonitoringCollectorLifecycleController.php:15`
...
3. Attempt only the matrix-defined user job: Issue, re-enrol, and revoke Site-scoped monitoring collectors.
