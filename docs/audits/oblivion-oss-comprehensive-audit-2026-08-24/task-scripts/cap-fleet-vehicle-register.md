...
- Module: `Fleet & Assets`
- User job: Maintain vehicles and vehicle-specific state
- Matrix source owner, not assumed human actor: `VehicleController`
...
- Route paths: `routes/fleet-assets.php:51-66`
- Pages: `resources/js/pages/fleet-assets/vehicles/index.tsx`
...
3. Attempt only the matrix-defined user job: Maintain vehicles and vehicle-specific state.
