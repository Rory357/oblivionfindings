# CAP-CR-TIME-RECORDING

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Record time against an authorised Control Room alert
- Matrix source owner, not assumed human actor: `Control Room time-recording owner`
...
- Route paths: `routes/control-room.php; routes/control-room.php:289-300`
- Pages: `resources/js/pages/control-room/show.tsx`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomTimeEntryController.php:17`
...
3. Attempt only the matrix-defined user job: Record time against an authorised Control Room alert.
