# CAP-GOV-PERFORMANCE-REVIEW

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Run board and CEO performance reviews and approvals
- Matrix source owner, not assumed human actor: `PerformanceReviewService and controller`
...
- Backend: `app/Domain/Governance/Services/PerformanceReviewService.php:22-373`
- Tests: `tests/Feature/Governance/GovernancePerformanceReviewTest.php:21`
...
3. Attempt only the matrix-defined user job: Run board and CEO performance reviews and approvals.
