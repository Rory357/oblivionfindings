...
- Module: `HR`
- User job: Acknowledge and evidence HR policy attestations
...
- Backend: `app/Domain/Hr/Models/HrPolicyAttestation.php:12; app/Http/Controllers/Hr/PolicyAttestationController.php:12`
...
3. Attempt only the matrix-defined user job: Acknowledge and evidence HR policy attestations.
