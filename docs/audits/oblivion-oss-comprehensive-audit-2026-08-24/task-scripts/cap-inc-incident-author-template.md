# CAP-INC-INCIDENT-AUTHOR-TEMPLATE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Incidents`
- User job: Author an incident from an authorised incident template
- Matrix source owner, not assumed human actor: `IncidentController and the incident-template owner`
...
- Route paths: `routes/incidents.php:16-139; routes/incidents.php:18-48`
- Pages: `resources/js/pages/incidents/index.tsx; resources/js/pages/incidents/templates/index.tsx`
- Backend: `app/Http/Controllers/IncidentController.php:1475-1790; app/Http/Controllers/IncidentController.php:36; app/Http/Controllers/IncidentTemplateController.php:8`
- Tests: `tests/Feature/IncidentControllerTest.php`
...
3. Attempt only the matrix-defined user job: Author an incident from an authorised incident template.
