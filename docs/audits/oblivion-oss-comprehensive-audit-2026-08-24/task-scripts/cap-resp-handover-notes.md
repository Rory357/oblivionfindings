# CAP-RESP-HANDOVER-NOTES

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Create, update, and acknowledge respite handover notes
- Matrix source owner, not assumed human actor: `RespiteHandoverNoteController`
...
- Route paths: `routes/respite.php:152-162`
- Pages: `resources/js/pages/respite/handover-notes/index.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteHandoverNoteController.php:15`
...
3. Attempt only the matrix-defined user job: Create, update, and acknowledge respite handover notes.
