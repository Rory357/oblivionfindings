...
- Module: `Governance`
- User job: Create, progress, block, complete, and escalate governance actions
- Matrix source owner, not assumed human actor: `ActionItemController and GovernanceWorkflowService`
...
- Backend: `app/Domain/Governance/Http/Controllers/ActionItemController.php:13-122`
- Tests: `tests/Feature/Governance/GovernanceActionItemsTest.php:20`
...
3. Attempt only the matrix-defined user job: Create, progress, block, complete, and escalate governance actions.
