# CAP-SEC-MONITORING-RETENTION-POLICY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Author monitoring retention policies
- Matrix source owner, not assumed human actor: `NativeMonitoringDefinitionService and monitoring policy owners`
...
- Backend: `app/Domain/Monitoring/Services/NativeMonitoringDefinitionService.php:86-282; app/Domain/SecurityDevices/Http/Controllers/MonitoringRetentionSettingsController.php:11`
- Tests: `tests/Feature/Monitoring/MonitoringPolicyAuthoringServiceTest.php:27-312`
...
3. Attempt only the matrix-defined user job: Author monitoring retention policies.
