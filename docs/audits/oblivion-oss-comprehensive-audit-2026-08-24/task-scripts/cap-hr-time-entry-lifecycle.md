# CAP-HR-TIME-ENTRY-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Administer HR time entries and amendments
...
- Backend: `app/Domain/Hr/Services/TimeTrackingService.php:17; app/Http/Controllers/Hr/TimeTrackingController.php:21`
...
3. Attempt only the matrix-defined user job: Administer HR time entries and amendments.
