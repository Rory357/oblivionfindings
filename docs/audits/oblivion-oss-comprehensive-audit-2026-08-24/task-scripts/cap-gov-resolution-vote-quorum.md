# CAP-GOV-RESOLUTION-VOTE-QUORUM

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Draft resolutions, declare conflicts, vote, enforce quorum, and close outcomes
- Matrix source owner, not assumed human actor: `VotingService and ResolutionController`
...
- Backend: `app/Domain/Governance/Services/VotingService.php:29-187`
- Tests: `tests/Feature/Governance/GovernanceResolutionsTest.php:39`
...
3. Attempt only the matrix-defined user job: Draft resolutions, declare conflicts, vote, enforce quorum, and close outcomes.
