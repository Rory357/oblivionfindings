# CAP-HS-EVENT-REGISTER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Find and review safety events
- Matrix source owner, not assumed human actor: `HsEventController`
...
- Route paths: `routes/health-safety.php:44-48`
- Pages: `resources/js/pages/health-safety/events/index.tsx`
...
3. Attempt only the matrix-defined user job: Find and review safety events.
