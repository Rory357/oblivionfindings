# CAP-OPS-CLIENT-ONBOARDING

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Operations`
- User job: Run governed client onboarding
- Matrix source owner, not assumed human actor: `Client onboarding owner`
...
3. Attempt only the matrix-defined user job: Run governed client onboarding.
