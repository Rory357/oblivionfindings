# CAP-FIN-CREDIT-NOTE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Create and approve supplier credit notes
- Matrix source owner, not assumed human actor: `AccountsPayableService and AP controllers`
...
- Backend: `app/Domain/Finance/Http/Controllers/CreditNoteController.php:17; app/Domain/Finance/Services/AccountsPayableService.php:731`
...
3. Attempt only the matrix-defined user job: Create and approve supplier credit notes.
