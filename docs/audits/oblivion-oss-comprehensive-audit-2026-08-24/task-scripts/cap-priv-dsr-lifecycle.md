...
- Module: `Privacy`
- User job: Intake, verify, assign, extend, complete, or refuse a DSR
- Matrix source owner, not assumed human actor: `DataSubjectRequestLifecycleService`
...
- Route paths: `routes/settings.php:234-236`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Privacy/Services/DataSubjectRequestLifecycleService.php:74-284`
- Tests: `tests/Feature/Privacy/DataSubjectRequestLifecycleTest.php:59-103`
...
3. Attempt only the matrix-defined user job: Intake, verify, assign, extend, complete, or refuse a DSR.
