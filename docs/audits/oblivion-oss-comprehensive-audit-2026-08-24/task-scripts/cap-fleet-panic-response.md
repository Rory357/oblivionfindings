# CAP-FLEET-PANIC-RESPONSE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Raise and respond to a transport panic event
...
- Route paths: `routes/fleet-assets.php:224`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/FleetAssets/ResidentTrackingController.php:775-829`
...
3. Attempt only the matrix-defined user job: Raise and respond to a transport panic event.
