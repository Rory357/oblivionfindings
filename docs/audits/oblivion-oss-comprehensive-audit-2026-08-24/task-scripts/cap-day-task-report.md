...
- User job: Report task status without leaking linked records
- Matrix source owner, not assumed human actor: `Task reporting owner`
...
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomTaskController.php:1; app/Http/Controllers/MyDayActionsController.php:1; app/Http/Controllers/MyDayMedicationsController.php:1`
...
3. Attempt only the matrix-defined user job: Report task status without leaking linked records.
