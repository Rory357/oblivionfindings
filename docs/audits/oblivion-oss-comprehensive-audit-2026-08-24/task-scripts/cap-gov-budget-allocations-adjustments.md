# CAP-GOV-BUDGET-ALLOCATIONS-ADJUSTMENTS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Manage governance budgets, allocations, actuals, and approvals
- Matrix source owner, not assumed human actor: `BudgetController and GovernanceNestedMutationService`
...
- Backend: `app/Domain/Governance/Services/GovernanceNestedMutationService.php:143-406`
- Tests: `tests/Feature/Governance/GovernanceNestedBindingIntegrityTest.php:81`
...
3. Attempt only the matrix-defined user job: Manage governance budgets, allocations, actuals, and approvals.
