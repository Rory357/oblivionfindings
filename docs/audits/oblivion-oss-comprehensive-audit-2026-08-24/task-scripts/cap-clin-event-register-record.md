...
- User job: Record a clinical event
- Matrix source owner, not assumed human actor: `ClinicalEventService`
...
- Route paths: `routes/health-clinical.php:23-114; routes/health-clinical.php:36-41`
- Pages: `resources/js/pages/health-clinical/components/record-event-dialog.tsx:27-248`
...
3. Attempt only the matrix-defined user job: Record a clinical event.
