# CAP-FIN-DONOR-FUND-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Maintain restricted donor funds and transactions
- Matrix source owner, not assumed human actor: `ClientFundTransactionService, PettyCashService, and DonorFundService`
...
- Backend: `app/Domain/Finance/Http/Controllers/DonorFundController.php:24; app/Domain/Finance/Services/ClientFundTransactionService.php:144-304; app/Domain/Finance/Services/DonorFundService.php:23`
- Tests: `tests/Feature/Finance/ClientFundGovernanceTest.php:100`
...
3. Attempt only the matrix-defined user job: Maintain restricted donor funds and transactions.
