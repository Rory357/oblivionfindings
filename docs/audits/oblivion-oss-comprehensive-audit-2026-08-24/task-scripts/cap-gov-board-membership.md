...
- Backend: `app/Domain/Governance/Http/Controllers/BoardMemberAdminController.php:12`
...
3. Attempt only the matrix-defined user job: Administer board membership.
