# CAP-CLI-CLIENT-CONSENT-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Clients`
- User job: Request, decide, validate, withdraw, and evidence client consent
- Matrix source owner, not assumed human actor: `ConsentRequestService and ConsentDecisionEvidenceService`
...
- Route paths: `routes/operations.php:180-208; routes/operations.php:355-364`
- Pages: `resources/js/pages/operations/clients/consent-requests/Show.tsx; resources/js/pages/operations/clients/consents/Index.tsx; resources/js/pages/operations/clients/tabs/_groups.ts`
- Backend: `app/Services/ConsentDecisionEvidenceService.php; app/Services/ConsentDecisionEvidenceService.php:18-220; app/Services/ConsentRequestService.php; app/Services/ConsentRequestService.php:30-1158`
- Tests: `tests/Feature/Consents/ConsentRequestIntegrityTest.php`
...
3. Attempt only the matrix-defined user job: Request, decide, validate, withdraw, and evidence client consent.
