# CAP-COMPLAINT-RESPITE-STAY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Record a respite-stay complaint and HDC escalation state
- Matrix source owner, not assumed human actor: `RespiteStayController and evidence-pack owner`
...
- Route paths: `routes/respite.php:80-93; routes/respite.php:89`
- Pages: `resources/js/pages/respite/stays/show.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteStayController.php:544-574`
- Tests: `tests/Feature/Respite/RespiteNzWorkflowCompletionTest.php:319-370`
...
3. Attempt only the matrix-defined user job: Record a respite-stay complaint and HDC escalation state.
