# CAP-SEC-MONITORING-MAINTENANCE-POLICY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Author and cancel monitoring maintenance windows
...
- Backend: `app/Domain/SecurityDevices/Http/Controllers/MonitoringMaintenanceSettingsController.php:11`
...
3. Attempt only the matrix-defined user job: Author and cancel monitoring maintenance windows.
