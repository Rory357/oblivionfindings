...
- Module: `Catering`
- User job: Maintain dietary and allergen tags
- Matrix source owner, not assumed human actor: `DietaryTagController`
...
- Route paths: `routes/catering.php:62-72; routes/catering.php:62-73`
- Pages: `resources/js/pages/catering/tags/index.tsx`
- Backend: `app/Http/Controllers/Catering/DietaryTagController.php:10-80`
...
3. Attempt only the matrix-defined user job: Maintain dietary and allergen tags.
