# CAP-GOV-SPEND-APPROVAL

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Request, decide, and evidence board or committee spend approval
- Matrix source owner, not assumed human actor: `SpendApprovalCommandService`
...
- Backend: `app/Domain/Governance/Services/SpendApprovalCommandService.php:109-345`
- Tests: `tests/Feature/Governance/SpendApprovalAuthorityTest.php:53`
...
3. Attempt only the matrix-defined user job: Request, decide, and evidence board or committee spend approval.
