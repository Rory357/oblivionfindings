# CAP-OPS-SHIFT-HANDOVER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Operations`
- User job: Prepare and accept shift handover
- Matrix source owner, not assumed human actor: `ShiftHandoverService`
...
- Route paths: `routes/shifts.php:121-126`
- Pages: `resources/js/pages/operations/handovers/Index.tsx`
- Backend: `app/Http/Controllers/AttendanceController.php:509-637; app/Services/ShiftHandoverService.php; app/Services/ShiftHandoverService.php:1`
...
3. Attempt only the matrix-defined user job: Prepare and accept shift handover.
