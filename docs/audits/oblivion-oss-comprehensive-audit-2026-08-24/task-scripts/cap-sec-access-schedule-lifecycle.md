# CAP-SEC-ACCESS-SCHEDULE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Create, version, and deactivate access schedules
...
- Backend: `app/Domain/SecurityDevices/AccessControl/Services/AccessControlLifecycleService.php:26; app/Domain/SecurityDevices/AccessControl/Services/AccessControlLifecycleService.php:26-378; app/Domain/SecurityDevices/AccessControl/Services/AccessControlLifecycleService.php:77`
...
3. Attempt only the matrix-defined user job: Create, version, and deactivate access schedules.
