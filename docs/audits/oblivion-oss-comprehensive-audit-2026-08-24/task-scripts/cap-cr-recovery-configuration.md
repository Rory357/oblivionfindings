# CAP-CR-RECOVERY-CONFIGURATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Configure maintenance, outbox recovery, and Control Room options
...
- Route paths: `routes/control-room.php:344-360`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomSettingsController.php:20`
...
3. Attempt only the matrix-defined user job: Configure maintenance, outbox recovery, and Control Room options.
