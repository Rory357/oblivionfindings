# CAP-PLAT-ADMIN-DASHBOARD

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Platform Dashboards`
- User job: Review the authorised organisation and Site operational overview
- Matrix source owner, not assumed human actor: `DashboardController`
...
- Route paths: `routes/web.php:128`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/DashboardController.php:24-480`
...
3. Attempt only the matrix-defined user job: Review the authorised organisation and Site operational overview.
