...
- Route paths: `routes/web.php:68-124; routes/web.php:74; routes/web.php:82; routes/web.php:96`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Tests: `tests/Feature/Hr/CareersPortalTest.php:15-143`
...
3. Attempt only the matrix-defined user job: Read public product and policy pages.
