# CAP-SET-DATA-GOVERNANCE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Public & Settings Platform`
- User job: Configure application privacy and compliance settings and maintain the processor register.
- Matrix source owner, not assumed human actor: `record: AppSetting; controller: DataSettingsController; policy: settings.access.manage`
...
- Route paths: `routes/settings.php:222-233; routes/settings.php:222-248; routes/settings.php:240-248`
- Pages: `resources/js/pages/settings/data.tsx:1006-1061; resources/js/pages/settings/data.tsx:1169-1216; resources/js/pages/settings/data.tsx:1450-1453; resources/js/pages/settings/data.tsx:701-785`
- Backend: `app/Http/Controllers/Settings/AuditLogSettingsController.php:14-118; app/Http/Controllers/Settings/DataSettingsController.php:168-213; app/Http/Controllers/Settings/DataSettingsController.php:315-373; app/Http/Controllers/Settings/DataSettingsController.php:366-373; app/Http/Controllers/Settings/DataSettingsController.php:97-132; app/Models/AppSetting.php:7-13`
- Tests: `tests/Browser/Settings/AuditLogsInteractionTest.php:42-94; tests/Browser/Settings/DataSettingsInteractionTest.php:177-239; tests/Browser/Settings/DataSettingsInteractionTest.php:61-118; tests/Feature/Privacy/DataSubjectRequestLifecycleTest.php:566-799`
...
3. Attempt only the matrix-defined user job: Configure application privacy and compliance settings and maintain the processor register..
