# CAP-MED-MEDICATION-ERROR-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Record, investigate, review, and close a medication error
- Matrix source owner, not assumed human actor: `Medication error lifecycle owner`
...
- Route paths: `routes/emar.php:365-386`
- Pages: `resources/js/pages/emar/MedicationErrors.tsx; resources/js/pages/emar/_error-dialogs.tsx`
- Backend: `app/Http/Controllers/Emar/MedicationErrorController.php:26`
...
3. Attempt only the matrix-defined user job: Record, investigate, review, and close a medication error.
