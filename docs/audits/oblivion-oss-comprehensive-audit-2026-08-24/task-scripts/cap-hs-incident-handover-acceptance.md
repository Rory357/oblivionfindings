# CAP-HS-INCIDENT-HANDOVER-ACCEPTANCE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Accept an incident into canonical H&S ownership
- Matrix source owner, not assumed human actor: `HsEventController and HsEventService`
...
- Route paths: `routes/health-safety.php:66`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/HealthSafety/HsEventController.php:408-443; app/Services/HealthSafety/HsEventService.php:269-322`
...
3. Attempt only the matrix-defined user job: Accept an incident into canonical H&S ownership.
