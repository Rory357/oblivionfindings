# CAP-FIN-PETTY-CASH-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Maintain petty-cash funds and transactions
...
- Backend: `app/Domain/Finance/Http/Controllers/PettyCashController.php:14; app/Domain/Finance/Services/ClientFundTransactionService.php:144-304`
...
3. Attempt only the matrix-defined user job: Maintain petty-cash funds and transactions.
