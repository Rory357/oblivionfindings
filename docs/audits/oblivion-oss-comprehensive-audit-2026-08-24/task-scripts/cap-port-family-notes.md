# CAP-PORT-FAMILY-NOTES

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Record and review authorised family notes
- Matrix source owner, not assumed human actor: `PortalFamilyNoteController`
...
- Pages: `resources/js/pages/portal/family-notes.tsx`
- Backend: `app/Http/Controllers/Portal/PortalFamilyNoteController.php`
...
3. Attempt only the matrix-defined user job: Record and review authorised family notes.
