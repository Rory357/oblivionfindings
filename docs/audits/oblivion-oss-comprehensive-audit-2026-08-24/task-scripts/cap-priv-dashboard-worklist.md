...
- Module: `Privacy`
- User job: Review privacy requests, breaches, holds, retention, and deadlines
- Matrix source owner, not assumed human actor: `PrivacyDashboardController`
...
- Backend: `app/Http/Controllers/PrivacyDashboardController.php:35-67`
- Tests: `tests/Feature/PrivacyControllerTest.php:1754-1769`
...
3. Attempt only the matrix-defined user job: Review privacy requests, breaches, holds, retention, and deadlines.
