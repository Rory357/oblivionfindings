# CAP-PORT-FAMILY-PHOTOS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review and upload authorised family-shared photos
...
- Route paths: `routes/portal.php:134-142`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalPhotoController.php:16-115`
...
3. Attempt only the matrix-defined user job: Review and upload authorised family-shared photos.
