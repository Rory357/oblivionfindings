...
- Module: `Finance`
- User job: Open, maintain, and close fiscal periods
...
- Route paths: `routes/finance.php:181`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/FiscalPeriodController.php:11`
...
3. Attempt only the matrix-defined user job: Open, maintain, and close fiscal periods.
