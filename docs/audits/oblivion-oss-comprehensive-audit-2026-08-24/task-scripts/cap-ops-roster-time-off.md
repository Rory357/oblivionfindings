# CAP-OPS-ROSTER-TIME-OFF

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Maintain non-leave roster unavailability and training blocks
...
- Backend: `app/Http/Controllers/StaffTimeOffController.php:10; app/Models/StaffTimeOff.php:11`
...
3. Attempt only the matrix-defined user job: Maintain non-leave roster unavailability and training blocks.
