# CAP-OPS-TIMESHEET-MANAGER-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Approve, reject, return, and amend timesheets
- Matrix source owner, not assumed human actor: `TimesheetApprovalService and operations reconciliation`
...
- Backend: `app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:118; app/Http/Controllers/TimesheetController.php:1237`
...
3. Attempt only the matrix-defined user job: Approve, reject, return, and amend timesheets.
