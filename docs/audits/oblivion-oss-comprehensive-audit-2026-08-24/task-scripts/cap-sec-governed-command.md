...
- User job: Request, approve, dispatch, and reconcile device commands
- Matrix source owner, not assumed human actor: `DeviceManagementAuthorizationService and GovernedCommandDispatchService`
...
- Backend: `app/Domain/SecurityDevices/Management/Services/GovernedCommandDispatchService.php:48-508`
- Tests: `tests/Feature/SecurityDevices/DeviceManagementAuthorizationTest.php:65-266`
...
3. Attempt only the matrix-defined user job: Request, approve, dispatch, and reconcile device commands.
