...
- Backend: `app/Domain/Finance/Http/Controllers/VendorController.php:14`
...
3. Attempt only the matrix-defined user job: Maintain vendor master records.
