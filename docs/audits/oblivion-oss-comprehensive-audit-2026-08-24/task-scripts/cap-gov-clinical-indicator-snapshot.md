# CAP-GOV-CLINICAL-INDICATOR-SNAPSHOT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Review clinical governance indicators and record snapshots
- Matrix source owner, not assumed human actor: `ClinicalGovernanceController and automation service`
...
- Backend: `app/Domain/Governance/Http/Controllers/ClinicalGovernanceController.php:20-88`
- Tests: `tests/Feature/Governance/ClinicalGovernanceAutomationTest.php:37`
...
3. Attempt only the matrix-defined user job: Review clinical governance indicators and record snapshots.
