# CAP-HR-SAVED-REPORT-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Define, preview, save, run, and remove a creator-owned custom HR report.
- Matrix source owner, not assumed human actor: `ReportBuilderController and ReportBuilderService`
...
- Route paths: `routes/hr.php:1365-1375`
- Pages: `resources/js/pages/hr/reports/builder.tsx:1-601`
- Backend: `app/Domain/Hr/Models/HrSavedReport.php:1; app/Http/Controllers/Hr/ReportBuilderController.php:14-155`
- Tests: `tests/Feature/Hr/ReportBuilderCanonicalAccessTest.php:93-215`
...
3. Attempt only the matrix-defined user job: Define, preview, save, run, and remove a creator-owned custom HR report..
