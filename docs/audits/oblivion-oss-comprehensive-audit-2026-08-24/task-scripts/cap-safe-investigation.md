# CAP-SAFE-INVESTIGATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Safeguarding`
- User job: Open and maintain a sensitivity-scoped safeguarding investigation
- Matrix source owner, not assumed human actor: `SafeguardingInvestigationController`
...
- Route paths: `routes/safeguarding.php:66-73`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/SafeguardingInvestigationController.php; app/Http/Controllers/SafeguardingInvestigationController.php:10-105`
...
3. Attempt only the matrix-defined user job: Open and maintain a sensitivity-scoped safeguarding investigation.
