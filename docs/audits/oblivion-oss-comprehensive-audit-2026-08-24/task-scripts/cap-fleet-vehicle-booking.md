# CAP-FLEET-VEHICLE-BOOKING

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Book, approve, check out, return, reject, or cancel a vehicle
- Matrix source owner, not assumed human actor: `VehicleBookingController and VehicleBookingAccessService`
...
- Backend: `app/Services/Fleet/VehicleBookingAccessService.php:30-127`
- Tests: `tests/Feature/FleetAssets/VehicleBookingSitePrivacyTest.php:139-353`
...
3. Attempt only the matrix-defined user job: Book, approve, check out, return, reject, or cancel a vehicle.
