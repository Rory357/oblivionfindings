# CAP-SAFE-RISK-ASSESSMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Safeguarding`
- User job: Record and update the concern's safeguarding risk assessment
- Matrix source owner, not assumed human actor: `SafeguardingRiskAssessmentController`
...
- Route paths: `routes/safeguarding.php:84-86`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/SafeguardingRiskAssessmentController.php; app/Http/Controllers/SafeguardingRiskAssessmentController.php:11-58`
...
3. Attempt only the matrix-defined user job: Record and update the concern's safeguarding risk assessment.
