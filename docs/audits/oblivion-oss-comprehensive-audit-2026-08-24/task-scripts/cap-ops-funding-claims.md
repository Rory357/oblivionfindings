# CAP-OPS-FUNDING-CLAIMS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Operations`
- User job: Prepare and manage governed funding claims
- Matrix source owner, not assumed human actor: `Operations funding owner`
...
- Route paths: `routes/operations.php:1-1336`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Services/Operations/CarePlanService.php:1; app/Services/Operations/TimesheetReconciliationService.php:1; app/Services/ShiftHandoverService.php:1`
- Tests: `tests/Unit/Operations/ClientSafetyPayloadTest.php:1; tests/Unit/Operations/TimesheetReconciliationServiceTest.php:1; tests/Unit/Services/ShiftHandoverServiceTest.php:1`
...
3. Attempt only the matrix-defined user job: Prepare and manage governed funding claims.
