# CAP-CR-ALERT-TASK-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Create, assign, progress, and complete an alert follow-up task
...
- Route paths: `routes/control-room.php:143-163`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomTaskController.php:18-418`
...
3. Attempt only the matrix-defined user job: Create, assign, progress, and complete an alert follow-up task.
