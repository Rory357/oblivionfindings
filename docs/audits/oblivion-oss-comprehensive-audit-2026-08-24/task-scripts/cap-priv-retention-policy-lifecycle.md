...
- Module: `Privacy`
- User job: Define, preview, approve, and revise retention policies
- Matrix source owner, not assumed human actor: `RetentionExecutionService and RetentionOwnerRegistry`
...
- Route paths: `routes/settings.php:225-227`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/DataRetentionPolicyController.php:16; app/Http/Controllers/DataRetentionPolicyController.php:66`
...
3. Attempt only the matrix-defined user job: Define, preview, approve, and revise retention policies.
