# CAP-MED-DESTRUCTION-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Record and, under authority, void a medication destruction
- Matrix source owner, not assumed human actor: `Medication destruction owner`
...
- Route paths: `routes/emar.php:139-141; routes/emar.php:217-218`
- Pages: `resources/js/pages/emar/Destructions.tsx`
- Backend: `app/Http/Controllers/Emar/EmarController.php:4023`
...
3. Attempt only the matrix-defined user job: Record and, under authority, void a medication destruction.
