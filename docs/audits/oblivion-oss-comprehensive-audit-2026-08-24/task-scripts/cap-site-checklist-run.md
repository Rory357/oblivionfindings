# CAP-SITE-CHECKLIST-RUN

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Sites & Locations`
- User job: Execute and complete Site checklist runs
- Matrix source owner, not assumed human actor: `SiteChecklistRunExecutionService and compliance owners`
...
- Backend: `app/Services/Sites/SiteChecklistRunExecutionService.php:20; app/Services/Sites/SiteChecklistRunExecutionService.php:37-200`
- Tests: `tests/Feature/Checklists/ChecklistRunOwnershipTest.php:231-448`
...
3. Attempt only the matrix-defined user job: Execute and complete Site checklist runs.
