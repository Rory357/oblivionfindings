...
- Route paths: `routes/finance.php:205`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/CurrencyController.php:10`
...
3. Attempt only the matrix-defined user job: Maintain supported currencies.
