...
- User job: Record and review a clinical observation
- Matrix source owner, not assumed human actor: `ClinicalObservationService`
...
- Route paths: `routes/health-clinical.php:23-114; routes/health-clinical.php:30-35`
- Pages: `resources/js/pages/health-clinical/components/record-observation-dialog.tsx:27-336`
...
3. Attempt only the matrix-defined user job: Record and review a clinical observation.
