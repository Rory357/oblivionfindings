# CAP-QUAL-INTERNAL-QUALITY-CHECKLIST

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Quality/Internal`
- User job: Review the authenticated internal quality checklist
- Matrix source owner, not assumed human actor: `QualityChecklistController`
...
- Route paths: `routes/web.php:126-130; routes/web.php:130`
- Pages: `resources/js/pages/quality/checklist.tsx:6-153`
- Backend: `app/Http/Controllers/QualityChecklistController.php:11-12; app/Http/Controllers/QualityChecklistController.php:7-15`
- Tests: `tests/Browser/Misc/MiscPagesTest.php:76-80; tests/Browser/Misc/MiscPagesTest.php:76-83`
...
3. Attempt only the matrix-defined user job: Review the authenticated internal quality checklist.
