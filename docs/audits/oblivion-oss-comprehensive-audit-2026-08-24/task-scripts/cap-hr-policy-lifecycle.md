...
- Module: `HR`
- User job: Draft, version, publish, and retire HR policies
- Matrix source owner, not assumed human actor: `HR document, policy, and signature owners`
...
- Backend: `app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Http/Controllers/Hr/EmployeeProfileController.php:1; app/Http/Controllers/Hr/PolicyController.php:21`
...
3. Attempt only the matrix-defined user job: Draft, version, publish, and retire HR policies.
