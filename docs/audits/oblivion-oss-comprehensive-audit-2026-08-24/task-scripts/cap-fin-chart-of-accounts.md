# CAP-FIN-CHART-OF-ACCOUNTS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Maintain ledger accounts
- Matrix source owner, not assumed human actor: `ChartOfAccountsService and ledger administration controllers`
...
- Route paths: `routes/finance.php:134-205`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Services/ChartOfAccountsService.php:9`
- Tests: `tests/Feature/Finance/FinanceChartVerificationTest.php:1`
...
3. Attempt only the matrix-defined user job: Maintain ledger accounts.
