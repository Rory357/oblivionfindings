# CAP-IT-PROBLEM-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `IT & Support`
- User job: Create and transition IT problems
...
- Backend: `app/Domain/It/Services/ItMajorIncidentService.php:33-397; app/Domain/It/Services/ItProblemService.php:16`
...
3. Attempt only the matrix-defined user job: Create and transition IT problems.
