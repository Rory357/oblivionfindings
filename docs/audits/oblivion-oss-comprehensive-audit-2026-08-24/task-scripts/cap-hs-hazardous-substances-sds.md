# CAP-HS-HAZARDOUS-SUBSTANCES-SDS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Maintain substances, SDS history, storage, exposure, and escalation
- Matrix source owner, not assumed human actor: `HazardousSubstanceController`
...
- Backend: `app/Http/Controllers/HealthSafety/HazardousSubstanceController.php:211-435`
- Tests: `tests/Feature/HealthSafety/HazardousSubstanceControllerTest.php:138-220`
...
3. Attempt only the matrix-defined user job: Maintain substances, SDS history, storage, exposure, and escalation.
