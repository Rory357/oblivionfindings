# CAP-IT-PROVISIONING-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `IT & Support`
- User job: Create, approve, fulfil, fail, or cancel provisioning requests
- Matrix source owner, not assumed human actor: `ItProvisioningRequestLifecycleService`
...
- Backend: `app/Domain/It/Services/ItProvisioningRequestLifecycleService.php:32-392`
- Tests: `tests/Feature/It/ItProvisioningTest.php:150-248`
...
3. Attempt only the matrix-defined user job: Create, approve, fulfil, fail, or cancel provisioning requests.
