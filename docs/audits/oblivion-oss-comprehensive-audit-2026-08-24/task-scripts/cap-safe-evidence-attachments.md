# CAP-SAFE-EVIDENCE-ATTACHMENTS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Safeguarding`
- User job: Upload and manage need-to-know safeguarding evidence attachments
- Matrix source owner, not assumed human actor: `SafeguardingAttachmentController`
...
- Route paths: `routes/safeguarding.php:88-96`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/SafeguardingAttachmentController.php; app/Http/Controllers/SafeguardingAttachmentController.php:17-85`
...
3. Attempt only the matrix-defined user job: Upload and manage need-to-know safeguarding evidence attachments.
