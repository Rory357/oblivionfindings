# CAP-FIN-CLIENT-FUND-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Govern Client-fund transactions and approvals
...
- Backend: `app/Domain/Finance/Services/ClientFundTransactionService.php:144-304; app/Domain/Finance/Services/ClientFundTransactionService.php:16`
...
3. Attempt only the matrix-defined user job: Govern Client-fund transactions and approvals.
