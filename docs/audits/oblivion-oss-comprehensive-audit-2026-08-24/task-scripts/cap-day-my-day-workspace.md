...
- User job: Work a personal Site-scoped day view of shifts, tasks, medication, and due actions
- Matrix source owner, not assumed human actor: `My Day presenters with canonical action owners`
...
- Navigation: `tests/Feature/Tasks/TaskNavigationFailureIsolationTest.php:1`
- Route names: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Route paths: `routes/web.php:151`
- Pages: `resources/js/pages/my-day/index.tsx:1`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomTaskController.php:1; app/Http/Controllers/MyDayActionsController.php:1; app/Http/Controllers/MyDayMedicationsController.php:1; app/Http/Controllers/MyTasksController.php:45-145`
- Tests: `tests/Feature/MyDayActiveSiteTest.php:1; tests/Feature/Tasks/AllTasksPermissionRecoveryTest.php:1; tests/Feature/Tasks/TaskNavigationFailureIsolationTest.php:1`
...
3. Attempt only the matrix-defined user job: Work a personal Site-scoped day view of shifts, tasks, medication, and due actions.
