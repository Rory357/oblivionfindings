...
- User job: Review, escalate, and close a clinical event
- Matrix source owner, not assumed human actor: `Clinical event lifecycle owner`
...
3. Attempt only the matrix-defined user job: Review, escalate, and close a clinical event.
