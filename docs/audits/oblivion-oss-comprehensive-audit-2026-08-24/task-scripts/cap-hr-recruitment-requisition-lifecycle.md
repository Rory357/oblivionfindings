...
- Module: `HR`
- User job: Create, approve, publish, synchronise, close, and unpublish a recruitment requisition.
- Matrix source owner, not assumed human actor: `RecruitmentJobController and HrRecruitmentAccessService`
...
- Route paths: `routes/hr.php:230-248`
- Pages: `resources/js/pages/hr/recruitment/index.tsx:1-2824`
- Backend: `app/Domain/Hr/Models/HrJobRequisition.php:1; app/Http/Controllers/Hr/RecruitmentJobController.php:21-540`
...
3. Attempt only the matrix-defined user job: Create, approve, publish, synchronise, close, and unpublish a recruitment requisition..
