# CAP-GOV-CEO-BOARD-REPORT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Draft, submit, present, and evidence CEO board reports
- Matrix source owner, not assumed human actor: `CeoBoardReportController and policy`
...
- Backend: `app/Domain/Governance/Http/Controllers/CeoBoardReportController.php:18-206`
- Tests: `tests/Browser/Governance/GovernanceMiscTest.php:116`
...
3. Attempt only the matrix-defined user job: Draft, submit, present, and evidence CEO board reports.
