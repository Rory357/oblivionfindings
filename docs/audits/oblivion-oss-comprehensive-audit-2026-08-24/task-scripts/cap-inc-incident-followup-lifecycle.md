# CAP-INC-INCIDENT-FOLLOWUP-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Incidents`
- User job: Create, update, and complete incident follow-up actions
...
- Route paths: `routes/incidents.php:106-118`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/IncidentFollowupController.php:13`
...
3. Attempt only the matrix-defined user job: Create, update, and complete incident follow-up actions.
