# CAP-FLEET-VEHICLE-INSPECTION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Create and complete a governed vehicle inspection
- Matrix source owner, not assumed human actor: `WorkOrderController and fleet maintenance owners`
...
- Route paths: `routes/fleet-assets.php:172-175; routes/fleet-assets.php:192`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/FleetAssets/InspectionController.php:14-277`
...
3. Attempt only the matrix-defined user job: Create and complete a governed vehicle inspection.
