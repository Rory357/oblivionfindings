# CAP-FIN-IRD-FILING-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Create, validate, and submit IRD filings
- Matrix source owner, not assumed human actor: `GstReturnService, IrdFilingService, and NzComplianceService`
...
- Route paths: `routes/finance.php:530-547`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/IrdFilingController.php:15; app/Domain/Finance/Services/IrdFilingService.php:12`
- Tests: `tests/Feature/Finance/IrdFilingCanonicalAccessTest.php:72`
...
3. Attempt only the matrix-defined user job: Create, validate, and submit IRD filings.
