...
- Module: `Workforce`
- User job: Clock in, take breaks, clock out, and create or reconcile the worker's attendance-backed draft timesheet.
- Matrix source owner, not assumed human actor: `AttendanceController and AttendanceService`
...
- Route paths: `routes/operations.php:1-1336; routes/shifts.php:1-127; routes/shifts.php:96-104`
- Pages: `resources/js/pages/attendance/index.tsx:1-1601`
- Backend: `app/Domain/Hr/Models/HrAttendanceSession.php:1; app/Domain/Hr/Services/AttendanceService.php:30-273; app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1`
- Tests: `tests/Feature/Hr/AttendanceClockWorkflowTest.php:40-480; tests/Feature/ShiftLifecycleHardeningTest.php:1; tests/Feature/TimesheetSafetyGuardsTest.php:1; tests/Unit/Rostering/EligibilityScoringStrategyTest.php:1`
...
3. Attempt only the matrix-defined user job: Clock in, take breaks, clock out, and create or reconcile the worker's attendance-backed draft timesheet..
