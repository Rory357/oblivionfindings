# CAP-MED-ADMINISTRATION-CORRECTION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Request, approve, or reject a medication-administration correction
- Matrix source owner, not assumed human actor: `MedicationAdministrationCorrectionController`
...
- Route paths: `routes/api_medications.php:63-65; routes/clients.php:198-201; routes/clients.php:199-201; routes/emar.php:320-325`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Api/MedicationsApiController.php:913-1003; app/Http/Controllers/MedicationAdministrationCorrectionController.php; app/Http/Controllers/MedicationAdministrationCorrectionController.php:12`
- Tests: `NOT_ESTABLISHED_CURRENT_AUDIT`
...
3. Attempt only the matrix-defined user job: Request, approve, or reject a medication-administration correction.
