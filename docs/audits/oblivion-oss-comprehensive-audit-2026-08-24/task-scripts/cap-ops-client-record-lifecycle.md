...
- Module: `Clients`
- User job: Create, view, update, and archive an authorised client record
- Matrix source owner, not assumed human actor: `ClientController and client lifecycle services`
...
- Route paths: `routes/clients.php:30-259`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ClientController.php:1; app/Services/ConsentDecisionEvidenceService.php:1; app/Services/ConsentRequestService.php:1`
- Tests: `tests/Feature/ClientControllerTest.php:1; tests/Feature/Consents/ConsentRequestIntegrityTest.php:1`
...
3. Attempt only the matrix-defined user job: Create, view, update, and archive an authorised client record.
