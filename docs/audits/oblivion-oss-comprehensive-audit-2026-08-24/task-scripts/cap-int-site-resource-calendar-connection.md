...
- Module: `Integrations`
- User job: Configure application-level calendar provider connections, approved-Site resource mappings, cadence, and conflict policy.
- Matrix source owner, not assumed human actor: `CalendarSyncSettingsController and CalendarSyncOAuthController`
...
- Route paths: `routes/settings.php:312-331`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/CalendarSyncOAuthController.php:12-109; app/Http/Controllers/Settings/CalendarSyncSettingsController.php:22-260`
...
3. Attempt only the matrix-defined user job: Configure application-level calendar provider connections, approved-Site resource mappings, cadence, and conflict policy..
