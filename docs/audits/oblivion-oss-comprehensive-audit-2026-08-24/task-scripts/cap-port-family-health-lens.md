# CAP-PORT-FAMILY-HEALTH-LENS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review the consent and section-filtered family health lens
...
- Route paths: `routes/portal.php:116`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalHealthController.php:10-45`
...
3. Attempt only the matrix-defined user job: Review the consent and section-filtered family health lens.
