...
- Module: `Respite`
- User job: Assemble, update, add or remove items, and seal a respite evidence pack
- Matrix source owner, not assumed human actor: `RespiteEvidencePackController`
...
- Route paths: `routes/respite.php:179-193`
- Pages: `resources/js/pages/respite/evidence-packs/show.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteEvidencePackController.php:21`
...
3. Attempt only the matrix-defined user job: Assemble, update, add or remove items, and seal a respite evidence pack.
