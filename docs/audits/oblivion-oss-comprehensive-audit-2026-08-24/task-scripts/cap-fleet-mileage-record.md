# CAP-FLEET-MILEAGE-RECORD

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Record authorised vehicle mileage
- Matrix source owner, not assumed human actor: `MileageController`
...
- Route paths: `routes/fleet-assets.php:320-330`
- Pages: `resources/js/pages/fleet-assets/mileage/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/MileageController.php:14`
...
3. Attempt only the matrix-defined user job: Record authorised vehicle mileage.
