# CAP-SAFE-EXTERNAL-REPORT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Safeguarding`
- User job: Record reports to external safeguarding authorities
- Matrix source owner, not assumed human actor: `SafeguardingExternalReportController`
...
- Backend: `app/Http/Controllers/SafeguardingExternalReportController.php:16-62`
- Tests: `tests/Feature/Safeguarding/SafeguardingSubRecordTest.php:104-120`
...
3. Attempt only the matrix-defined user job: Record reports to external safeguarding authorities.
