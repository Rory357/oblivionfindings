...
- Module: `Fleet & Assets`
- User job: Create and maintain vehicle service schedules
- Matrix source owner, not assumed human actor: `Fleet maintenance schedule owner`
...
- Route paths: `routes/fleet-assets.php:170; routes/fleet-assets.php:188-190`
- Pages: `resources/js/pages/fleet-assets/maintenance/schedules/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/ServiceScheduleController.php:14-225`
...
3. Attempt only the matrix-defined user job: Create and maintain vehicle service schedules.
