# CAP-RESP-RISK-PLAN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Create, review, activate, suspend, acknowledge, and deactivate a respite risk plan
- Matrix source owner, not assumed human actor: `RespiteRiskPlanActivationController`
...
- Route paths: `routes/respite.php:211-226`
- Pages: `resources/js/pages/respite/risk-plan-activations/index.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteRiskPlanActivationController.php:16`
...
3. Attempt only the matrix-defined user job: Create, review, activate, suspend, acknowledge, and deactivate a respite risk plan.
