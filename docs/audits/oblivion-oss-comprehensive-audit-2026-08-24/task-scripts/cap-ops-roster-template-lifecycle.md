...
- Module: `Workforce`
- User job: Create, duplicate, update, apply, and remove a roster template.
- Matrix source owner, not assumed human actor: `RosterTemplateController`
...
- Route paths: `routes/operations.php:930-953`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Operations/RosterTemplateController.php:1-463; app/Models/RosterTemplate.php:1`
- Tests: `tests/Feature/Rostering/TemplateApplyTest.php:18-230`
...
3. Attempt only the matrix-defined user job: Create, duplicate, update, apply, and remove a roster template..
