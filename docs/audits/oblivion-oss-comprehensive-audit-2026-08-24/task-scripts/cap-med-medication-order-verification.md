...
- Module: `eMAR`
- User job: Verify a medication order before use
- Matrix source owner, not assumed human actor: `Medication order verification owner`
...
- Route paths: `routes/api_medications.php:134-141; routes/api_medications.php:23-33; routes/api_medications.php:67-70; routes/emar.php:30-395`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Emar/EmarController.php:4023-4121; app/Services/Eligibility/Rules/MedicationCompetencyRule.php:1; app/Services/Medication/MedicationScopeDecisionService.php:40-221`
...
3. Attempt only the matrix-defined user job: Verify a medication order before use.
