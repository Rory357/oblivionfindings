# CAP-CATER-SITE-SHOPPING-LIST

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Catering`
- User job: Generate, maintain, receive, and close approved-Site shopping lists
- Matrix source owner, not assumed human actor: `Site meal-planning owner`
...
- Route paths: `routes/sites.php:295-421; routes/sites.php:385-410`
- Pages: `resources/js/pages/sites/meal-planner/index.tsx`
- Backend: `app/Http/Controllers/Sites/SiteMealShoppingListController.php:19-262`
...
3. Attempt only the matrix-defined user job: Generate, maintain, receive, and close approved-Site shopping lists.
