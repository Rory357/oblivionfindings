# CAP-FIN-CLIENT-FINANCIAL-SUMMARY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Review the scoped costs, funding, invoices, and ledger summary for one Client.
- Matrix source owner, not assumed human actor: `ClientFinancialsController and ClientFinancialSummaryService`
...
- Route paths: `routes/finance.php:104-108`
- Pages: `resources/js/pages/clients/Financials.tsx:1-452`
- Backend: `app/Domain/Finance/Http/Controllers/ClientFinancialsController.php:14-45; app/Domain/Finance/Services/ClientFinancialSummaryService.php:15-211`
- Tests: `tests/Feature/Finance/FinancialInsightsObjectScopeTest.php:256-292`
...
3. Attempt only the matrix-defined user job: Review the scoped costs, funding, invoices, and ledger summary for one Client..
