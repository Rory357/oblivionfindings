...
- Module: `Finance`
- User job: Review scoped executive KPIs, insights, and Site summaries.
- Matrix source owner, not assumed human actor: `ExecutiveFinancialDashboardController and FinancialInsightsScopeResolver`
...
- Route paths: `routes/finance.php:74-77`
- Pages: `resources/js/pages/finance/executive-dashboard/Index.tsx:1-343`
- Backend: `app/Domain/Finance/Http/Controllers/ExecutiveFinancialDashboardController.php:14-44; app/Domain/Finance/Services/FinancialInsightsScopeResolver.php:25-128`
- Tests: `tests/Architecture/FinancialInsightsObjectScopeBoundaryTest.php:1-145`
...
3. Attempt only the matrix-defined user job: Review scoped executive KPIs, insights, and Site summaries..
