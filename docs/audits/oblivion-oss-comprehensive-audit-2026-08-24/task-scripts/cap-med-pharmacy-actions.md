...
- Module: `eMAR`
- User job: Create, update, and advance pharmacy orders
- Matrix source owner, not assumed human actor: `EmarController and pharmacy action services`
...
- Route paths: `routes/emar.php:221-223`
- Pages: `resources/js/pages/emar/Medications.tsx`
- Backend: `app/Http/Controllers/Emar/EmarController.php:1954-2279; app/Http/Controllers/Emar/EmarController.php:22`
...
3. Attempt only the matrix-defined user job: Create, update, and advance pharmacy orders.
