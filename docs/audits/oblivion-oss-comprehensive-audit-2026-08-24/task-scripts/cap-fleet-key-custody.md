# CAP-FLEET-KEY-CUSTODY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Issue, return, and reconcile vehicle-key custody
- Matrix source owner, not assumed human actor: `KeyController`
...
- Route paths: `routes/fleet-assets.php:195-205; routes/fleet-assets.php:197-204`
- Pages: `resources/js/pages/fleet-assets/keys/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/KeyController.php:18-586`
...
3. Attempt only the matrix-defined user job: Issue, return, and reconcile vehicle-key custody.
