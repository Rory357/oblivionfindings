...
- Module: `Control Room`
- User job: Configure signal rules and triage queues
- Matrix source owner, not assumed human actor: `Control Room settings owner`
...
- Route paths: `routes/control-room.php:329-343; routes/control-room.php:329-408`
- Pages: `resources/js/pages/control-room/settings.tsx`
...
3. Attempt only the matrix-defined user job: Configure signal rules and triage queues.
