# CAP-RESP-DAILY-CARE-NOTES

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Create and maintain authorised respite daily-care notes
- Matrix source owner, not assumed human actor: `RespiteDailyNoteController`
...
- Route paths: `routes/respite.php:197-207`
- Pages: `resources/js/pages/respite/daily-notes/index.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteDailyNoteController.php:19`
...
3. Attempt only the matrix-defined user job: Create and maintain authorised respite daily-care notes.
