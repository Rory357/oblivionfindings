...
- Module: `Workforce`
- User job: Maintain recurring staff availability
- Matrix source owner, not assumed human actor: `Availability and leave owners`
...
- Backend: `app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1; app/Http/Controllers/StaffAvailabilityController.php:9`
...
3. Attempt only the matrix-defined user job: Maintain recurring staff availability.
