...
- Module: `Governance`
- User job: Score risks, add treatments, accept, and close records
- Matrix source owner, not assumed human actor: `RiskRegisterController and RiskScoringService`
...
- Backend: `app/Domain/Governance/Http/Controllers/RiskRegisterController.php:31-277`
- Tests: `tests/Feature/Governance/GovernanceRiskRegisterTest.php:23`
...
3. Attempt only the matrix-defined user job: Score risks, add treatments, accept, and close records.
