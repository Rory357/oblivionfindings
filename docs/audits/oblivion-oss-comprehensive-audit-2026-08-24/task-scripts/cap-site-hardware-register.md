# CAP-SITE-HARDWARE-REGISTER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Sites & Locations`
- User job: Maintain Site hardware and physical placement
- Matrix source owner, not assumed human actor: `SiteTypePlanService and SitePhysicalRoomService`
...
- Backend: `app/Http/Controllers/Sites/SiteHardwareController.php:19; app/Services/Sites/SitePhysicalRoomService.php:28-448`
- Tests: `tests/Feature/Sites/SitePhysicalRoomBridgeTest.php:48-221`
...
3. Attempt only the matrix-defined user job: Maintain Site hardware and physical placement.
