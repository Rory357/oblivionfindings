# CAP-MED-SELF-ADMINISTRATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Assess and maintain client self-administration authority
- Matrix source owner, not assumed human actor: `Medication self-administration owner`
...
- Route paths: `routes/emar.php:134-136; routes/emar.php:200-202`
- Pages: `resources/js/pages/emar/SelfAdmin.tsx`
...
3. Attempt only the matrix-defined user job: Assess and maintain client self-administration authority.
