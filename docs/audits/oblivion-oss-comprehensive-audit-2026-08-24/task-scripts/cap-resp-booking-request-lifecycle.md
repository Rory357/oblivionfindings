# CAP-RESP-BOOKING-REQUEST-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Create, review, approve, and promote a respite booking request
- Matrix source owner, not assumed human actor: `RespiteBookingRequestController`
...
- Route paths: `routes/respite.php:47-63`
- Pages: `resources/js/pages/respite/requests/show.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteBookingRequestController.php:25`
...
3. Attempt only the matrix-defined user job: Create, review, approve, and promote a respite booking request.
