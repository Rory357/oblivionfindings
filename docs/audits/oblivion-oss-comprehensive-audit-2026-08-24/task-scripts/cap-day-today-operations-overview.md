...
- User job: Review today's authorised shifts, medication work, and attention items
- Matrix source owner, not assumed human actor: `TodayDashboardController`
...
- Route paths: `routes/web.php:129`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/TodayDashboardController.php:13-124`
- Tests: `tests/Browser/Pages/TodayTest.php`
...
3. Attempt only the matrix-defined user job: Review today's authorised shifts, medication work, and attention items.
