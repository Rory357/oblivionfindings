...
- Module: `Control Room`
- User job: Prepare, hand over, accept, and acknowledge complete shift state
- Matrix source owner, not assumed human actor: `ControlRoomHandoverScopeService and shift handover service`
...
- Backend: `app/Services/ControlRoom/ControlRoomHandoverScopeService.php:65-547`
- Tests: `tests/Feature/ControlRoom/ControlRoomShiftHandoverScopeTest.php:57-487`
...
3. Attempt only the matrix-defined user job: Prepare, hand over, accept, and acknowledge complete shift state.
