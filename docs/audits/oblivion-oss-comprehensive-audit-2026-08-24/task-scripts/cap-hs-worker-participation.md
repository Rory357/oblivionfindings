# CAP-HS-WORKER-PARTICIPATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Govern representatives, committees, meetings, consultation, and participation evidence
- Matrix source owner, not assumed human actor: `WorkerParticipationController`
...
- Route paths: `routes/health-safety.php:234-352`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/HealthSafety/WorkerParticipationController.php:43-749; app/Http/Controllers/HealthSafety/WorkerParticipationController.php:63-147`
- Tests: `tests/Feature/HealthSafety/WorkerParticipationTest.php:149-254`
...
3. Attempt only the matrix-defined user job: Govern representatives, committees, meetings, consultation, and participation evidence.
