...
- Module: `Fleet & Assets`
- User job: Record a daily vehicle check against its authorised template
...
- Route paths: `routes/fleet-assets.php:45-46`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/FleetAssets/DailyCheckController.php:15-189`
...
3. Attempt only the matrix-defined user job: Record a daily vehicle check against its authorised template.
