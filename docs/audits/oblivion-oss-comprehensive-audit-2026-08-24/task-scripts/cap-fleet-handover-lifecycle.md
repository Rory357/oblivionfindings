# CAP-FLEET-HANDOVER-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Create, accept, or dispute a fleet handover
- Matrix source owner, not assumed human actor: `HandoverController`
...
- Route paths: `routes/fleet-assets.php:254-270; routes/fleet-assets.php:254-272`
- Pages: `resources/js/pages/fleet-assets/handovers/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/HandoverController.php:19-536`
...
3. Attempt only the matrix-defined user job: Create, accept, or dispute a fleet handover.
