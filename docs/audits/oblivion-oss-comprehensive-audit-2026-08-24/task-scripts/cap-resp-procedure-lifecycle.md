# CAP-RESP-PROCEDURE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Maintain procedure templates and run, complete, fail, cancel, or escalate procedure runs
- Matrix source owner, not assumed human actor: `RespiteProcedureTemplateController and RespiteProcedureRunController`
...
- Route paths: `routes/respite.php:107-127`
- Pages: `resources/js/pages/respite/procedure-runs/index.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteProcedureRunController.php:18; app/Http/Controllers/Respite/RespiteProcedureTemplateController.php:13`
...
3. Attempt only the matrix-defined user job: Maintain procedure templates and run, complete, fail, cancel, or escalate procedure runs.
