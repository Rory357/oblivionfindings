...
- Route paths: `routes/settings.php:194`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/NotificationPreferencesController.php:15-238; app/Http/Controllers/Settings/SecurityPolicyController.php:13`
...
3. Attempt only the matrix-defined user job: Configure application security policy.
