# CAP-CLI-CLIENT-RISK-REGISTER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Clients`
- User job: View and maintain the client's risk register
- Matrix source owner, not assumed human actor: `ClientRiskController`
...
- Route paths: `routes/clients.php:242-259`
- Pages: `resources/js/pages/operations/clients/tabs/risk-management.tsx`
- Backend: `app/Http/Controllers/ClientRiskController.php:10`
...
3. Attempt only the matrix-defined user job: View and maintain the client's risk register.
