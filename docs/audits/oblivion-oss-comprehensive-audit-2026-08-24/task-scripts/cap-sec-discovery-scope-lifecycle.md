...
- User job: Create, validate, apply, and deactivate approved Site discovery scopes
- Matrix source owner, not assumed human actor: `Discovery services and MonitoringCollectorLifecycleController`
...
- Backend: `app/Domain/Monitoring/Services/NativeMonitoringDefinitionService.php:240; app/Domain/SecurityDevices/Http/Controllers/DiscoveryScopeLifecycleController.php:20`
...
3. Attempt only the matrix-defined user job: Create, validate, apply, and deactivate approved Site discovery scopes.
