# CAP-HR-COMPLIANCE-RECORDS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Manage staff compliance records
- Matrix source owner, not assumed human actor: `HR compliance and training owners`
...
- Backend: `app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Http/Controllers/Hr/ComplianceController.php:33; app/Http/Controllers/Hr/EmployeeProfileController.php:1`
...
3. Attempt only the matrix-defined user job: Manage staff compliance records.
