# CAP-SEC-MONITOR-DEFINITION-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Create and govern native monitor definitions
...
- Backend: `app/Domain/Monitoring/Services/NativeMonitoringDefinitionService.php:27`
...
3. Attempt only the matrix-defined user job: Create and govern native monitor definitions.
