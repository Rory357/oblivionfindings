...
- Module: `Finance`
- User job: Create and govern purchase orders
...
- Tests: `tests/Feature/Finance/BillSpendApprovalGateTest.php:156`
...
3. Attempt only the matrix-defined user job: Create and govern purchase orders.
