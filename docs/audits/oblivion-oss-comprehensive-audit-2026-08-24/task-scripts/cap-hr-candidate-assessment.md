...
- Module: `HR`
- User job: Define interview kits and conduct governed interviews, scorecards, and reference checks for an application.
- Matrix source owner, not assumed human actor: `CandidateController and InterviewKitController`
...
- Route paths: `routes/hr.php:167-179`
- Pages: `resources/js/pages/hr/candidates/show.tsx:1-2547`
- Backend: `app/Domain/Hr/Models/HrInterview.php:1; app/Http/Controllers/Hr/InterviewKitController.php:11-100`
- Tests: `tests/Feature/Hr/RecruitmentDeferredLifecycleTest.php:185-247`
...
3. Attempt only the matrix-defined user job: Define interview kits and conduct governed interviews, scorecards, and reference checks for an application..
