# CAP-PORT-FAMILY-TIMELINE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review and interact with the authorised family timeline
- Matrix source owner, not assumed human actor: `PortalClientController and FamilyDashboardController read projections`
...
- Route paths: `routes/portal.php:104-114`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalTimelineController.php:13-88; app/Http/Controllers/Portal/PortalTimelineInteractionController.php:16-140`
...
3. Attempt only the matrix-defined user job: Review and interact with the authorised family timeline.
