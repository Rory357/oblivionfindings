...
- Module: `Finance`
- User job: Review the finance module overview, selected period, cash, receivables, payables, funding, and attention items.
- Matrix source owner, not assumed human actor: `FinanceDashboardController and DashboardAggregatorService`
...
- Route paths: `routes/finance.php:64-72`
- Pages: `resources/js/pages/finance/Dashboard.tsx:1-1425`
- Backend: `app/Domain/Finance/Http/Controllers/FinanceDashboardController.php:19-76; app/Domain/Finance/Services/DashboardAggregatorService.php:19-517`
- Tests: `tests/Feature/Finance/OverviewHubTest.php:9-57`
...
3. Attempt only the matrix-defined user job: Review the finance module overview, selected period, cash, receivables, payables, funding, and attention items..
