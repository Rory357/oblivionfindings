# CAP-OPS-ROSTER-AUTO-SCHEDULE-SUGGESTIONS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Generate, review, accept, dismiss, and apply roster suggestions.
- Matrix source owner, not assumed human actor: `RosterSuggestionController and RosterSuggestionService`
...
- Route paths: `routes/operations.php:983-994`
- Pages: `resources/js/pages/operations/rostering/suggestions/Show.tsx:1-480`
- Backend: `app/Domain/Rostering/AutoSchedule/RosterSuggestionService.php:12-286; app/Models/RosterSuggestion.php:1`
- Tests: `tests/Feature/Rostering/SuggestionEndToEndTest.php:39-124`
...
3. Attempt only the matrix-defined user job: Generate, review, accept, dismiss, and apply roster suggestions..
