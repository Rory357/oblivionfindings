# CAP-HR-LEAVE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Request, approve, decline, and cancel leave
- Matrix source owner, not assumed human actor: `HR leave, time, and payroll owners`
...
- Entry status: `ROUTE_SOURCE_ANCHOR_ONLY_UNVALIDATED`

## Source anchors

- Navigation: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Route names: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Route paths: `routes/hr.php:1-1420; routes/operations.php:1-1336; routes/shifts.php:1-127`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Domain/Hr/Services/LeaveService.php:24; app/Domain/Hr/Services/WorkforceAvailabilityCoverageService.php:38; app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1; app/Http/Controllers/Hr/EmployeeProfileController.php:1; app/Http/Controllers/Hr/LeaveController.php:21; app/Http/Controllers/StaffTimeOffController.php:40`
- Tests: `tests/Architecture/HrComplianceExportPermissionBoundaryTest.php:1; tests/Architecture/HrStaffCreationWorkflowBoundaryTest.php:1; tests/Architecture/HrWebhookEgressBoundaryTest.php:1; tests/Feature/ShiftLifecycleHardeningTest.php:1; tests/Feature/TimesheetSafetyGuardsTest.php:1; tests/Unit/Rostering/EligibilityScoringStrategyTest.php:1`
...
3. Attempt only the matrix-defined user job: Request, approve, decline, and cancel leave.
