# CAP-HR-TRAINING-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Assign and complete staff training
...
- Backend: `app/Domain/Hr/Services/TrainingService.php:24; app/Http/Controllers/Hr/TrainingController.php:35`
...
3. Attempt only the matrix-defined user job: Assign and complete staff training.
