# CAP-FIN-RECEIPT-ALLOCATION-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Capture and allocate an idempotent receipt
- Matrix source owner, not assumed human actor: `QuoteLifecycleService and AccountsReceivableService`
...
- Backend: `app/Domain/Finance/Http/Controllers/AccountsReceivableController.php:127; app/Domain/Finance/Services/AccountsReceivableService.php:296`
...
3. Attempt only the matrix-defined user job: Capture and allocate an idempotent receipt.
