...
- Module: `Operations`
- User job: Record and review shift notes
- Matrix source owner, not assumed human actor: `Shift-note owner`
...
- Pages: `resources/js/pages/operations/shift-notes/Index.tsx`
...
3. Attempt only the matrix-defined user job: Record and review shift notes.
