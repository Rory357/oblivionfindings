# CAP-COMPLAINT-SITE-FEEDBACK

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Sites & Locations`
- User job: Record and respond to an approved-Site complaint or feedback record
- Matrix source owner, not assumed human actor: `SiteComplianceController`
...
- Route paths: `routes/sites.php`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Sites/SiteComplianceController.php:415-548`
- Tests: `tests/Feature/Sites/SiteComplianceWorkflowTest.php:287-359`
...
3. Attempt only the matrix-defined user job: Record and respond to an approved-Site complaint or feedback record.
