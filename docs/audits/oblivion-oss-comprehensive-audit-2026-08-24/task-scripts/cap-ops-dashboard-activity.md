# CAP-OPS-DASHBOARD-ACTIVITY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Operations`
- User job: Review operations dashboard activity
- Matrix source owner, not assumed human actor: `Operations dashboard presenters`
...
3. Attempt only the matrix-defined user job: Review operations dashboard activity.
