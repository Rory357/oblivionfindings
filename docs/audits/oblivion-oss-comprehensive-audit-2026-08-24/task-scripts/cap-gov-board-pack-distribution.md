# CAP-GOV-BOARD-PACK-DISTRIBUTION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Generate, distribute, read, and download board packs
- Matrix source owner, not assumed human actor: `BoardPackBuilderService and BoardPackController`
...
- Backend: `app/Domain/Governance/Http/Controllers/BoardPackController.php:23-90`
- Tests: `tests/Feature/Governance/GovernanceBoardPacksTest.php:24`
...
3. Attempt only the matrix-defined user job: Generate, distribute, read, and download board packs.
