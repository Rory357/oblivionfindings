# CAP-MED-STOCK-MOVEMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Receive, adjust, and inspect medication stock movements
- Matrix source owner, not assumed human actor: `Medication stock owner`
...
- Route paths: `routes/api_medications.php:121-132; routes/emar.php:224-226; routes/emar.php:94-96`
- Pages: `resources/js/pages/emar/StockManagement.tsx`
- Backend: `app/Http/Controllers/Api/MedicationsApiController.php:1315-1497`
...
3. Attempt only the matrix-defined user job: Receive, adjust, and inspect medication stock movements.
