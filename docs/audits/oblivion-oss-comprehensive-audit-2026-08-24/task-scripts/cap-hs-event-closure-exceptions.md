# CAP-HS-EVENT-CLOSURE-EXCEPTIONS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Close safety events or approve narrow independent exceptions
- Matrix source owner, not assumed human actor: `HsEventClosureService`
...
- Backend: `app/Services/HealthSafety/HsEventClosureService.php:251-590`
- Tests: `tests/Feature/HealthSafety/HsEventClosureTest.php:41-128`
...
3. Attempt only the matrix-defined user job: Close safety events or approve narrow independent exceptions.
