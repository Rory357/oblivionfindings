# CAP-HR-REPORT-SUBSCRIPTION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Configure, update, pause, and resume a governed scheduled-report subscription and its recipients.
- Matrix source owner, not assumed human actor: `HrReportController and HrReportingService`
...
- Route paths: `routes/hr.php:747-752`
- Pages: `resources/js/pages/hr/reports/index.tsx:1-583`
- Backend: `app/Domain/Hr/Models/HrReportSubscription.php:14-64; app/Http/Controllers/Hr/HrReportController.php:234-383`
- Tests: `tests/Feature/Hr/HrReportAutomationTest.php:45-74`
...
3. Attempt only the matrix-defined user job: Configure, update, pause, and resume a governed scheduled-report subscription and its recipients..
