...
- Module: `Finance`
- User job: Create, send, accept, and convert quotes
...
- Route paths: `routes/finance.php:347-415; routes/finance.php:389`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Services/QuoteLifecycleService.php:16`
...
3. Attempt only the matrix-defined user job: Create, send, accept, and convert quotes.
