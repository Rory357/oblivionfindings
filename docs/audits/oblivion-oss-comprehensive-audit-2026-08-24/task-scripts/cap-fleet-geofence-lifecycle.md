# CAP-FLEET-GEOFENCE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Create, update, and remove authorised fleet geofences
- Matrix source owner, not assumed human actor: `ResidentTrackingController and realtime authorization owners`
...
- Route paths: `routes/fleet-assets.php:145-157`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/FleetAssets/GeofenceController.php:18-212`
...
3. Attempt only the matrix-defined user job: Create, update, and remove authorised fleet geofences.
