# CAP-HR-CASEWORK-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Manage confidential HR casework
...
- Route paths: `routes/hr.php:539-567`
- Pages: `resources/js/pages/hr/cases/index.tsx:106-579`
- Backend: `app/Http/Controllers/Hr/HrCaseController.php:25; app/Http/Controllers/Hr/HrCaseController.php:25-584`
- Tests: `tests/Feature/Hr/HrCasesPageContractTest.php:66-202`
...
3. Attempt only the matrix-defined user job: Manage confidential HR casework.
