# CAP-ROAD-QUARTERLY-PLAN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Roadmap`
- User job: Generate, review, approve, publish, and revise quarterly plans
...
- Route paths: `routes/roadmap.php:52`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Roadmap/Http/Controllers/QuarterlyPlanController.php:15`
...
3. Attempt only the matrix-defined user job: Generate, review, approve, publish, and revise quarterly plans.
