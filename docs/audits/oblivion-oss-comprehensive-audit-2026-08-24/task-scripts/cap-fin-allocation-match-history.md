...
- Module: `Finance`
- User job: Review allocation history and confirm or reject payment matches
- Matrix source owner, not assumed human actor: `PaymentMatchingService and settlement owners`
...
- Backend: `app/Domain/Finance/Services/PaymentMatchingService.php:300-421`
- Tests: `tests/Feature/Finance/PaymentAllocationIntegrityTest.php:360`
...
3. Attempt only the matrix-defined user job: Review allocation history and confirm or reject payment matches.
