# CAP-FLEET-OUTING-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Create, progress, and record return for a fleet outing
- Matrix source owner, not assumed human actor: `OutingController`
...
- Route paths: `routes/fleet-assets.php:303-315`
- Pages: `resources/js/pages/fleet-assets/outings/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/OutingController.php:21`
...
3. Attempt only the matrix-defined user job: Create, progress, and record return for a fleet outing.
