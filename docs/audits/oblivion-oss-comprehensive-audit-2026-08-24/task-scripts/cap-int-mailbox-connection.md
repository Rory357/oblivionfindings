...
- Module: `Integrations`
- User job: Configure IT mailbox connections
...
- Route paths: `routes/settings.php:201-219`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/ItMailboxSettingsController.php:21`
...
3. Attempt only the matrix-defined user job: Configure IT mailbox connections.
