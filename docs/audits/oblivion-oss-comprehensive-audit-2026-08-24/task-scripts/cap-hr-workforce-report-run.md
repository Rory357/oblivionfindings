# CAP-HR-WORKFORCE-REPORT-RUN

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Select and run a governed standard workforce report.
...
- Route paths: `routes/hr.php:739-745`
- Pages: `resources/js/pages/hr/reports/index.tsx:1-583`
- Backend: `app/Domain/Hr/Models/HrEmployeeProfile.php:17-226; app/Http/Controllers/Hr/HrReportController.php:16-159`
- Tests: `tests/Feature/Hr/HrReportingExpandedTypesTest.php:123-155`
...
3. Attempt only the matrix-defined user job: Select and run a governed standard workforce report..
