# CAP-ROAD-INITIATIVE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Roadmap`
- User job: Create, score, update, and transition initiatives
- Matrix source owner, not assumed human actor: `Roadmap domain controllers and services`
...
- Route paths: `routes/roadmap.php:1-97; routes/roadmap.php:20`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Roadmap/Http/Controllers/InitiativeController.php:19; app/Domain/Roadmap/Http/Controllers/RoadmapDashboardController.php`
- Tests: `tests/Feature/Roadmap/RoadmapPermissionsTest.php; tests/Feature/Roadmap/RoadmapWorkflowTest.php`
...
3. Attempt only the matrix-defined user job: Create, score, update, and transition initiatives.
