...
- User job: Monitor lone-worker sessions, check-ins, location, and alerts
- Matrix source owner, not assumed human actor: `LoneWorkerController and LoneWorkerSignalService`
...
- Backend: `app/Http/Controllers/HealthSafety/LoneWorkerController.php:227-778`
- Tests: `tests/Feature/HealthSafety/LoneWorkerSiteAccessTest.php:30-158`
...
3. Attempt only the matrix-defined user job: Monitor lone-worker sessions, check-ins, location, and alerts.
