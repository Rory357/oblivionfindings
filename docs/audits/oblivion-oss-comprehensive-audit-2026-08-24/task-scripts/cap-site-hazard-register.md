...
- Backend: `app/Http/Controllers/Sites/SiteHazardController.php:30; app/Services/Sites/SiteChecklistRunExecutionService.php:37-200`
...
3. Attempt only the matrix-defined user job: Record and govern Site hazards.
