...
- Module: `Privacy`
- User job: Create, review, and release legal holds
- Matrix source owner, not assumed human actor: `LegalHoldController and retention enforcement`
...
- Backend: `app/Http/Controllers/LegalHoldController.php:17-152`
- Tests: `tests/Feature/PrivacyControllerTest.php:1142-1215`
...
3. Attempt only the matrix-defined user job: Create, review, and release legal holds.
