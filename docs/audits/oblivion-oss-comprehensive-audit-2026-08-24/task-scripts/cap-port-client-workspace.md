# CAP-PORT-CLIENT-WORKSPACE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Use the authorised portal client workspace and section-gated summary
- Matrix source owner, not assumed human actor: `PortalClientController`
...
- Route paths: `routes/portal.php:49-180; routes/portal.php:57-65`
- Pages: `resources/js/pages/portal/client.tsx`
- Backend: `app/Http/Controllers/PortalClientController.php:13-147; app/Services/Portal/PortalClientSectionAccess.php:15-180`
...
3. Attempt only the matrix-defined user job: Use the authorised portal client workspace and section-gated summary.
