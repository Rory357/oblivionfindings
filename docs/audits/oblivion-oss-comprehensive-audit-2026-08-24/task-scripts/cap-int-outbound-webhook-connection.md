# CAP-INT-OUTBOUND-WEBHOOK-CONNECTION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Integrations`
- User job: Configure and test outbound webhooks
- Matrix source owner, not assumed human actor: `ApiSettingsController and integration settings owners`
...
- Route paths: `routes/settings.php:201-219; routes/settings.php:211`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/ApiSettingsController.php:17`
- Tests: `tests/Browser/Settings/ApiSettingsInteractionTest.php:22-116`
...
3. Attempt only the matrix-defined user job: Configure and test outbound webhooks.
