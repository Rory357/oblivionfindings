# CAP-FIN-EFTPOS-BATCH-RECONCILIATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Import and reconcile EFTPOS batches
...
- Backend: `app/Domain/Finance/Http/Controllers/EftposController.php:15; app/Domain/Finance/Services/EftposReconciliationService.php:17`
...
3. Attempt only the matrix-defined user job: Import and reconcile EFTPOS batches.
