...
- Module: `Finance`
- User job: Review the financial position of one authorised Site.
- Matrix source owner, not assumed human actor: `SiteFinancialDashboardController and SiteFinancialDashboardService`
...
- Route paths: `routes/finance.php:98-102`
- Pages: `resources/js/pages/finance/site-dashboard/Show.tsx:1-524`
- Backend: `app/Domain/Finance/Http/Controllers/SiteFinancialDashboardController.php:15-52; app/Domain/Finance/Services/SiteFinancialDashboardService.php:14-144`
- Tests: `tests/Feature/Finance/FinancialInsightsObjectScopeTest.php:471-480`
...
3. Attempt only the matrix-defined user job: Review the financial position of one authorised Site..
