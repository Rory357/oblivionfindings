# CAP-CR-MESSAGING-DISCUSSION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Exchange authorised alert messages and discussion
- Matrix source owner, not assumed human actor: `ControlRoomMessagingController`
...
- Route paths: `routes/control-room.php:263-277`
- Pages: `resources/js/pages/control-room/messaging.tsx`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomMessagingController.php:17; app/Http/Controllers/ControlRoom/ControlRoomMessagingController.php:24-304`
...
3. Attempt only the matrix-defined user job: Exchange authorised alert messages and discussion.
