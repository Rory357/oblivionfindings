# CAP-HR-DOCUMENT-SIGNATURE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Request and record document signatures
...
- Backend: `app/Domain/Hr/Models/HrDocumentSignature.php:13; app/Http/Controllers/Hr/ESignatureController.php:17`
...
3. Attempt only the matrix-defined user job: Request and record document signatures.
