# CAP-PUB-CAREERS-APPLICATION-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Public & Settings Platform`
- User job: Apply for a role and use token-bound application, offer, and reference flows
- Matrix source owner, not assumed human actor: `Public routes, ContactController, and careers controllers`
...
- Route paths: `routes/web.php:114`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Careers/CareerPortalController.php:148; app/Http/Controllers/Careers/CareerPortalController.php:21`
...
3. Attempt only the matrix-defined user job: Apply for a role and use token-bound application, offer, and reference flows.
