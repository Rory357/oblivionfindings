...
- Module: `Finance`
- User job: Configure an accounting integration, test its connection, manage mappings, disconnect it, and manually request a sync.
- Matrix source owner, not assumed human actor: `AccountingIntegrationController`
...
- Route paths: `routes/finance.php:602-612`
- Pages: `resources/js/pages/finance/Integrations/Index.tsx:1-570`
- Backend: `app/Domain/Finance/Http/Controllers/AccountingIntegrationController.php:14-241; app/Domain/Finance/Models/FinAccountingIntegration.php:13-108`
- Tests: `tests/Browser/Finance/FinanceIntegrationMappingInteractionTest.php:8-72`
...
3. Attempt only the matrix-defined user job: Configure an accounting integration, test its connection, manage mappings, disconnect it, and manually request a sync..
