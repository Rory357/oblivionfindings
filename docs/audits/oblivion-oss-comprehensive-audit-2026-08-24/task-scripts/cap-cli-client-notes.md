...
- Module: `Clients`
- User job: Create and pin privacy-scoped client timeline notes
- Matrix source owner, not assumed human actor: `ClientNoteController`
...
- Route paths: `routes/clients.php:180-186; routes/clients.php:181-186`
- Pages: `resources/js/pages/operations/clients/tabs/communication-notes.tsx`
- Backend: `app/Http/Controllers/ClientNoteController.php:11`
...
3. Attempt only the matrix-defined user job: Create and pin privacy-scoped client timeline notes.
