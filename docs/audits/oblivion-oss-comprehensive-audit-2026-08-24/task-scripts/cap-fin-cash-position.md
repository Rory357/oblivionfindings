# CAP-FIN-CASH-POSITION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Review live bank balances and near-term financial obligations.
- Matrix source owner, not assumed human actor: `CashPositionController`
...
- Route paths: `routes/finance.php:79-82`
- Pages: `resources/js/pages/finance/cash-position/Index.tsx:1-330`
- Backend: `app/Domain/Finance/Http/Controllers/CashPositionController.php:18-79; app/Domain/Finance/Models/FinBankAccount.php:1`
- Tests: `tests/Feature/Finance/OverviewHubTest.php:40-57`
...
3. Attempt only the matrix-defined user job: Review live bank balances and near-term financial obligations..
