...
- Module: `Privacy`
- User job: Create, assess, review, and approve privacy impact assessments
- Matrix source owner, not assumed human actor: `DPIAController`
...
- Backend: `app/Http/Controllers/DPIAController.php:68-188`
- Tests: `tests/Feature/PrivacyControllerTest.php:1280-1372`
...
3. Attempt only the matrix-defined user job: Create, assess, review, and approve privacy impact assessments.
