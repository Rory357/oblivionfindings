# CAP-CR-EVIDENCE-PACK-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Assemble and govern a Control Room evidence pack
- Matrix source owner, not assumed human actor: `ControlRoomEvidenceController and ControlRoomReportService`
...
- Route paths: `routes/control-room.php:304-324`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomEvidenceController.php:16-381`
...
3. Attempt only the matrix-defined user job: Assemble and govern a Control Room evidence pack.
