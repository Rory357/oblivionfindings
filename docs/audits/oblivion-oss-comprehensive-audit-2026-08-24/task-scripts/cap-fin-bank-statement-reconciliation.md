# CAP-FIN-BANK-STATEMENT-RECONCILIATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Match, unmatch, complete, and amend bank reconciliations
- Matrix source owner, not assumed human actor: `BankReconciliationService, BankFeedService, and EftposReconciliationService`
...
- Route paths: `routes/finance.php:495`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/BankReconciliationController.php:14; app/Domain/Finance/Services/BankReconciliationService.php:34-629`
- Tests: `tests/Feature/Finance/BankReconciliationAggregateTest.php:117`
...
3. Attempt only the matrix-defined user job: Match, unmatch, complete, and amend bank reconciliations.
