# CAP-SET-NOTIFICATION-CONFIG

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Public & Settings Platform`
- User job: Configure personal and role notification preferences
- Matrix source owner, not assumed human actor: `Dedicated settings controllers`
...
- Route paths: `routes/settings.php:131`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/NotificationPreferencesController.php:13; app/Http/Controllers/Settings/NotificationPreferencesController.php:15-238`
- Tests: `tests/Feature/Settings/SecurityPolicyEnforcementTest.php:14-80`
...
3. Attempt only the matrix-defined user job: Configure personal and role notification preferences.
