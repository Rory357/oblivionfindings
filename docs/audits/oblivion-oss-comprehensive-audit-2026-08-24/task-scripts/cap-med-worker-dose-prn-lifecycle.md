# CAP-MED-WORKER-DOSE-PRN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Record scheduled and PRN dose outcomes
- Matrix source owner, not assumed human actor: `Medication administration lifecycle owner`
...
- Route paths: `routes/api_medications.php:18-37; routes/api_medications.php:67-74; routes/emar.php:30-395`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Api/MedicationsApiController.php:302-999; app/Http/Controllers/Emar/EmarController.php:4023-4121; app/Services/Eligibility/Rules/MedicationCompetencyRule.php:1; app/Services/Medication/MedicationScopeDecisionService.php:40-221`
...
3. Attempt only the matrix-defined user job: Record scheduled and PRN dose outcomes.
