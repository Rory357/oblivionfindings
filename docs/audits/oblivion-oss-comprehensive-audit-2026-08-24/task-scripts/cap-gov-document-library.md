# CAP-GOV-DOCUMENT-LIBRARY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Store, browse, download, and remove governance documents
- Matrix source owner, not assumed human actor: `GovernanceDocumentController and policy`
...
- Backend: `app/Domain/Governance/Http/Controllers/GovernanceDocumentController.php:12-112`
- Tests: `tests/Browser/Governance/GovernanceMiscTest.php:6`
...
3. Attempt only the matrix-defined user job: Store, browse, download, and remove governance documents.
