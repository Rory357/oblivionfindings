...
- Module: `HR`
- User job: Create, view, update, activate, deactivate, rehire, and invite an employee profile through the canonical identity seam.
- Matrix source owner, not assumed human actor: `EmployeeProfileController, EmployeeIntakeService, and HrLifecycleAccessService`
...
- Route paths: `routes/hr.php:1-1420; routes/hr.php:259-287`
- Pages: `resources/js/pages/hr/employees/show.tsx:1`
- Backend: `app/Domain/Hr/Policies/HrEmployeeProfilePolicy.php:8-36; app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Http/Controllers/Hr/EmployeeProfileController.php:1; app/Http/Controllers/Hr/EmployeeProfileController.php:61-442`
- Tests: `tests/Architecture/HrComplianceExportPermissionBoundaryTest.php:1; tests/Architecture/HrStaffCreationWorkflowBoundaryTest.php:1; tests/Architecture/HrWebhookEgressBoundaryTest.php:1; tests/Feature/Hr/EmployeeProfileSitePrivacyTest.php:133-251`
...
3. Attempt only the matrix-defined user job: Create, view, update, activate, deactivate, rehire, and invite an employee profile through the canonical identity seam..
