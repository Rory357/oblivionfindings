# CAP-FLEET-INCIDENT-RECORD

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Record and govern a fleet incident
- Matrix source owner, not assumed human actor: `Fleet incident controller`
...
- Route paths: `routes/fleet-assets.php:274-302`
- Pages: `resources/js/pages/fleet-assets/incidents/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/IncidentController.php:33`
...
3. Attempt only the matrix-defined user job: Record and govern a fleet incident.
