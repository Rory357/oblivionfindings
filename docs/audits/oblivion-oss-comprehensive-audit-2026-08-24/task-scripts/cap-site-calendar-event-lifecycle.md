# CAP-SITE-CALENDAR-EVENT-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Sites & Locations`
- User job: Create, approve, update, and cancel Site calendar events
- Matrix source owner, not assumed human actor: `SiteCalendarController and SiteCalendarService`
...
- Backend: `app/Http/Controllers/Sites/SiteCalendarController.php:101; app/Http/Controllers/Sites/SiteCalendarController.php:24`
...
3. Attempt only the matrix-defined user job: Create, approve, update, and cancel Site calendar events.
