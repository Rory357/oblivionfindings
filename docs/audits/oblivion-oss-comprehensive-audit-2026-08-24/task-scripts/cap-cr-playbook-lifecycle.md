# CAP-CR-PLAYBOOK-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Create, activate, start, advance, and skip alert playbooks
- Matrix source owner, not assumed human actor: `Control Room playbook owner`
...
- Route paths: `routes/control-room.php:329-408; routes/control-room.php:388-410`
- Pages: `resources/js/pages/control-room/playbooks/index.tsx`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomPlaybookController.php:18-552`
...
3. Attempt only the matrix-defined user job: Create, activate, start, advance, and skip alert playbooks.
