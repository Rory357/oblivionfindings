...
- Module: `Governance`
- User job: Acknowledge and evidence governance policy attestations
...
- Backend: `app/Domain/Governance/Http/Controllers/GovernancePolicyController.php:15-258; app/Domain/Governance/Http/Controllers/GovernancePolicyController.php:171; app/Domain/Governance/Models/PolicyAttestation.php:10`
...
3. Attempt only the matrix-defined user job: Acknowledge and evidence governance policy attestations.
