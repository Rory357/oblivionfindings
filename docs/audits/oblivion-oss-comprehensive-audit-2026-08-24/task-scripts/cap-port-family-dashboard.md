# CAP-PORT-FAMILY-DASHBOARD

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Use the family dashboard and create or cancel visit requests
...
- Route paths: `routes/portal.php:69-73`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/FamilyDashboardController.php:22-572`
...
3. Attempt only the matrix-defined user job: Use the family dashboard and create or cancel visit requests.
