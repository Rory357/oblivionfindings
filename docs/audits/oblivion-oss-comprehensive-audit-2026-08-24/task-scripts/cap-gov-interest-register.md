# CAP-GOV-INTEREST-REGISTER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Record and govern board-member interests
- Matrix source owner, not assumed human actor: `Board member, interest, and evaluation controllers`
...
- Backend: `app/Domain/Governance/Http/Controllers/BoardEvaluationController.php:14-173; app/Domain/Governance/Http/Controllers/BoardInterestController.php:11`
- Tests: `tests/Feature/Governance/GovernanceBoardMemberSelfServiceTest.php:22`
...
3. Attempt only the matrix-defined user job: Record and govern board-member interests.
