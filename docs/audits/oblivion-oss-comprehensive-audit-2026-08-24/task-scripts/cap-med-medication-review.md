# CAP-MED-MEDICATION-REVIEW

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Create, progress, complete, and remove medication reviews
- Matrix source owner, not assumed human actor: `Medication review owner`
...
- Route paths: `routes/emar.php:109-111; routes/emar.php:167-169; routes/emar.php:167-171`
- Pages: `resources/js/pages/emar/Reviews.tsx`
...
3. Attempt only the matrix-defined user job: Create, progress, complete, and remove medication reviews.
