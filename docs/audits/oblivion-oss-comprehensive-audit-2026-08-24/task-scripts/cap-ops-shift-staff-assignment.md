# CAP-OPS-SHIFT-STAFF-ASSIGNMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Assign eligible staff to shifts
- Matrix source owner, not assumed human actor: `Shift staffing and coverage services`
...
- Route paths: `routes/operations.php:1-1336; routes/operations.php:807-819; routes/shifts.php:1-127`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:456; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1; app/Models/Shift.php:1; app/Services/Eligibility/AssignmentEligibilityGateway.php:11-37; app/Services/ShiftStaffEligibilityService.php:21-449`
- Tests: `tests/Feature/ShiftLifecycleHardeningTest.php:1; tests/Feature/TimesheetSafetyGuardsTest.php:1; tests/Unit/Rostering/EligibilityScoringStrategyTest.php:1; tests/Unit/Services/AssignmentEligibilityGatewayTest.php:17-88`
...
3. Attempt only the matrix-defined user job: Assign eligible staff to shifts.
