# CAP-FIN-OBLIGATION-CALENDAR

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Review finance obligations over a selected calendar range.
- Matrix source owner, not assumed human actor: `FinanceCalendarController and FinanceCalendarAggregator`
...
- Route paths: `routes/finance.php:84-91`
- Pages: `resources/js/pages/finance/Calendar.tsx:1-393`
- Backend: `app/Domain/Finance/Http/Controllers/FinanceCalendarController.php:18-63; app/Domain/Finance/Services/Calendar/FinanceCalendarAggregator.php:26-113`
- Tests: `tests/Feature/Finance/FinanceCalendarTest.php:122-164`
...
3. Attempt only the matrix-defined user job: Review finance obligations over a selected calendar range..
