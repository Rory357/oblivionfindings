# CAP-SEC-ACCESS-CREDENTIAL-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Issue, reconcile, and revoke access credentials
- Matrix source owner, not assumed human actor: `AccessControlLifecycleService`
...
- Backend: `app/Domain/SecurityDevices/AccessControl/Services/AccessControlLifecycleService.php:181; app/Domain/SecurityDevices/AccessControl/Services/AccessControlLifecycleService.php:201; app/Domain/SecurityDevices/AccessControl/Services/AccessControlLifecycleService.php:26-378`
- Tests: `tests/Feature/SecurityDevices/AccessControlWorkflowTest.php:144-451`
...
3. Attempt only the matrix-defined user job: Issue, reconcile, and revoke access credentials.
