...
- Module: `HR`
- User job: Onboard staff through governed checklists and tasks
- Matrix source owner, not assumed human actor: `Onboarding and offboarding controllers`
...
- Route paths: `routes/hr.php:1-1420`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Domain/Hr/Services/OnboardingService.php:36; app/Http/Controllers/Hr/EmployeeProfileController.php:1; app/Http/Controllers/Hr/OnboardingController.php:41`
- Tests: `tests/Architecture/HrComplianceExportPermissionBoundaryTest.php:1; tests/Architecture/HrStaffCreationWorkflowBoundaryTest.php:1; tests/Architecture/HrWebhookEgressBoundaryTest.php:1`
...
3. Attempt only the matrix-defined user job: Onboard staff through governed checklists and tasks.
