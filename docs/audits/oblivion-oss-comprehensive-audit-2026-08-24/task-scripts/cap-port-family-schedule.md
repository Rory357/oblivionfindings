# CAP-PORT-FAMILY-SCHEDULE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review the authorised family shift and respite schedule
...
- Route paths: `routes/portal.php:118`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalScheduleController.php:13-103`
...
3. Attempt only the matrix-defined user job: Review the authorised family shift and respite schedule.
