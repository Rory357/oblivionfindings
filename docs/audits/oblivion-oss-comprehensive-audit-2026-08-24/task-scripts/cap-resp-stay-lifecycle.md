...
- Module: `Respite`
- User job: Check in, extend, govern, and discharge a respite stay
- Matrix source owner, not assumed human actor: `RespiteStayController`
...
- Route paths: `routes/respite.php:80-93`
- Pages: `resources/js/pages/respite/stays/show.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteStayController.php:32-574`
...
3. Attempt only the matrix-defined user job: Check in, extend, govern, and discharge a respite stay.
