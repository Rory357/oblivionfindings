...
- Module: `Safeguarding`
- User job: Restrict, preview, request, and decide governed declassification
- Matrix source owner, not assumed human actor: `SafeguardingSensitivityService`
...
- Route paths: `routes/safeguarding.php:55-64`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Services/Safeguarding/SafeguardingSensitivityService.php:35-287`
- Tests: `tests/Feature/Safeguarding/SafeguardingSensitivityGovernanceTest.php:113-235`
...
3. Attempt only the matrix-defined user job: Restrict, preview, request, and decide governed declassification.
