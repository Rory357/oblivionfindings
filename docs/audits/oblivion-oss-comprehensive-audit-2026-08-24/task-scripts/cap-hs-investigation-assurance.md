# CAP-HS-INVESTIGATION-ASSURANCE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Investigate, review, rework, and independently approve completion
- Matrix source owner, not assumed human actor: `HsInvestigationService`
...
- Backend: `app/Services/HealthSafety/HsInvestigationService.php:185-332`
- Tests: `tests/Feature/HealthSafety/HsInvestigationAssuranceTest.php:28-83`
...
3. Attempt only the matrix-defined user job: Investigate, review, rework, and independently approve completion.
