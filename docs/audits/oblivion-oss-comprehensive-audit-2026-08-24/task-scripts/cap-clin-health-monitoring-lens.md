# CAP-CLIN-HEALTH-MONITORING-LENS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Care & Clinical`
- User job: Review the authorised health-monitoring rollup
- Matrix source owner, not assumed human actor: `Clinical recording services`
...
- Route paths: `routes/health-clinical.php:57-59`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Clinical/Services/ClinicalDashboardService.php:584; app/Http/Controllers/Clinical/HealthClinicalDashboardController.php:246`
...
3. Attempt only the matrix-defined user job: Review the authorised health-monitoring rollup.
