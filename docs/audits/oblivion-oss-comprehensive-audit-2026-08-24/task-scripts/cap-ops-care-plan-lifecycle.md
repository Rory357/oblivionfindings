...
- Module: `Operations`
- User job: Create, review, attest, export, and close a care plan
- Matrix source owner, not assumed human actor: `CarePlanController, CarePlanService, and CarePlanAttestationService`
...
- Route paths: `routes/operations.php:638-686`
- Pages: `resources/js/pages/operations/care-plans/Index.tsx; resources/js/pages/operations/care-plans/Show.tsx`
- Backend: `app/Services/Operations/CarePlanAttestationService.php:19-392; app/Services/Operations/CarePlanService.php:9`
...
3. Attempt only the matrix-defined user job: Create, review, attest, export, and close a care plan.
