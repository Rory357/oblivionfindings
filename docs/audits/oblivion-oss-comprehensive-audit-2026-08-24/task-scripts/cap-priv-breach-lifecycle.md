...
- Module: `Privacy`
- User job: Report, investigate, notify, and resolve privacy breaches
- Matrix source owner, not assumed human actor: `DataBreachController`
...
- Route paths: `routes/settings.php:237-239`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/DataBreachController.php:76-238`
- Tests: `tests/Feature/PrivacyControllerTest.php:1014-1028`
...
3. Attempt only the matrix-defined user job: Report, investigate, notify, and resolve privacy breaches.
