# CAP-FIN-GST-RETURN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Prepare, file, and amend GST returns
...
- Backend: `app/Domain/Finance/Http/Controllers/GstReturnController.php:14; app/Domain/Finance/Services/GstReturnService.php:21`
...
3. Attempt only the matrix-defined user job: Prepare, file, and amend GST returns.
