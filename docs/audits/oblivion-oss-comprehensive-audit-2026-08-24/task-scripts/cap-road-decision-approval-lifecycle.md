# CAP-ROAD-DECISION-APPROVAL-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Roadmap`
- User job: Review and resolve roadmap decision requests
...
- Route paths: `routes/roadmap.php:84`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Roadmap/Http/Controllers/DecisionRequestController.php:15`
...
3. Attempt only the matrix-defined user job: Review and resolve roadmap decision requests.
