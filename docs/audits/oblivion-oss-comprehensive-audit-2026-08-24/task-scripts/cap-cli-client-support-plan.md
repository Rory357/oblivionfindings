...
- Module: `Clients`
- User job: Maintain the client's support plan
- Matrix source owner, not assumed human actor: `ClientSupportPlanController`
...
- Route paths: `routes/clients.php:156-157`
- Pages: `resources/js/pages/operations/clients/tabs/care-support-plan.tsx`
- Backend: `app/Http/Controllers/ClientSupportPlanController.php:10`
...
3. Attempt only the matrix-defined user job: Maintain the client's support plan.
