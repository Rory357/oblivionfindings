# CAP-GOV-COMPLIANCE-OBLIGATION-EVIDENCE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Manage compliance obligations, evidence, and notifiable records
- Matrix source owner, not assumed human actor: `ComplianceController and ComplianceEngineService`
...
- Backend: `app/Domain/Governance/Services/ComplianceEngineService.php:67-203`
- Tests: `tests/Feature/Governance/GovernanceComplianceTest.php:26`
...
3. Attempt only the matrix-defined user job: Manage compliance obligations, evidence, and notifiable records.
