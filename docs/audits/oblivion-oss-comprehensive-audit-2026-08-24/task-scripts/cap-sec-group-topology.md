# CAP-SEC-GROUP-TOPOLOGY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Build device groups, rules, links, and topology
- Matrix source owner, not assumed human actor: `DeviceGroupController and relationship services`
...
- Backend: `app/Domain/SecurityDevices/Services/DeviceGroupAutoRuleService.php:50-214`
- Tests: `tests/Feature/SecurityDevices/DeviceGroupControllerTest.php:110-160`
...
3. Attempt only the matrix-defined user job: Build device groups, rules, links, and topology.
