# CAP-CLIN-TRENDS-LENS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Care & Clinical`
- User job: Review permission-filtered client clinical trends
- Matrix source owner, not assumed human actor: `HealthClinicalClientTrendsController`
...
- Route paths: `routes/health-clinical.php:60-62; routes/health-clinical.php:92-94`
- Pages: `resources/js/pages/health-clinical/Trends.tsx`
- Backend: `app/Http/Controllers/Clinical/HealthClinicalClientTrendsController.php:12`
...
3. Attempt only the matrix-defined user job: Review permission-filtered client clinical trends.
