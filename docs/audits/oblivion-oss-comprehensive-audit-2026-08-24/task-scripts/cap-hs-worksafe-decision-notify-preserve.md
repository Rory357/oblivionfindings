# CAP-HS-WORKSAFE-DECISION-NOTIFY-PRESERVE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Record notifiable decisions, WorkSafe notice, and Site preservation
- Matrix source owner, not assumed human actor: `HsEventService and HsWorksafeDecisionController`
...
- Backend: `app/Services/HealthSafety/HsEventService.php:322-663`
- Tests: `tests/Feature/HealthSafety/HsEventWorksafeTest.php:197-256`
...
3. Attempt only the matrix-defined user job: Record notifiable decisions, WorkSafe notice, and Site preservation.
