# CAP-MED-ROUND-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Generate, assign, conduct, and complete a medication round
- Matrix source owner, not assumed human actor: `GuidedRoundController and medication-round owner`
...
- Route paths: `routes/emar.php:118-130; routes/emar.php:191-197`
- Pages: `resources/js/pages/emar/Rounds.tsx`
- Backend: `app/Http/Controllers/Emar/GuidedRoundController.php:22`
...
3. Attempt only the matrix-defined user job: Generate, assign, conduct, and complete a medication round.
