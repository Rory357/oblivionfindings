...
- Module: `Workforce`
- User job: Create or edit a shift/manual timesheet and submit or atomically resubmit it for approval.
- Matrix source owner, not assumed human actor: `TimesheetController and TimesheetApprovalService`
...
- Route paths: `routes/operations.php:1-1336; routes/operations.php:1032-1050; routes/shifts.php:1-127`
- Pages: `resources/js/pages/operations/timesheets/index.tsx:1-1325`
- Backend: `app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:18-116; app/Models/Timesheet.php:1`
- Tests: `tests/Feature/ShiftLifecycleHardeningTest.php:1; tests/Feature/TimesheetSafetyGuardsTest.php:1; tests/Feature/TimesheetSafetyGuardsTest.php:165-228; tests/Unit/Rostering/EligibilityScoringStrategyTest.php:1`
...
3. Attempt only the matrix-defined user job: Create or edit a shift/manual timesheet and submit or atomically resubmit it for approval..
