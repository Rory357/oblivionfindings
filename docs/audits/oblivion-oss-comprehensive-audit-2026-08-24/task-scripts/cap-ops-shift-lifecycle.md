# CAP-OPS-SHIFT-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Create, publish, start, and close a shift
- Matrix source owner, not assumed human actor: `ShiftLifecycleService`
...
- Backend: `app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1`
...
3. Attempt only the matrix-defined user job: Create, publish, start, and close a shift.
