# CAP-GOV-MEETING-AGENDA-MINUTES-ATTENDANCE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Schedule meetings and manage agendas, attendance, minutes, and status
- Matrix source owner, not assumed human actor: `GovernanceMeetingController and governance workflow services`
...
- Backend: `app/Domain/Governance/Http/Controllers/GovernanceMeetingController.php:41-152`
- Tests: `tests/Feature/Governance/GovernanceNestedBindingIntegrityTest.php:39`
...
3. Attempt only the matrix-defined user job: Schedule meetings and manage agendas, attendance, minutes, and status.
