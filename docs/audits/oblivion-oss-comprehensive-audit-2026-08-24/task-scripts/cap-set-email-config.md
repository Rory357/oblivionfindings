...
- Backend: `app/Http/Controllers/Settings/EmailSettingsController.php:13; app/Http/Controllers/Settings/NotificationPreferencesController.php:15-238`
...
3. Attempt only the matrix-defined user job: Configure application email delivery.
