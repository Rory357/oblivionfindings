# CAP-HS-DASHBOARD-ANALYTICS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Review Site-scoped safety KPIs, trends, and attention worklists
- Matrix source owner, not assumed human actor: `HealthSafetyDashboardController and analytics services`
...
- Backend: `app/Http/Controllers/HealthSafety/HealthSafetyDashboardController.php:52-67`
- Tests: `tests/Feature/HealthSafety/HealthSafetyDashboardControllerTest.php:43-84`
...
3. Attempt only the matrix-defined user job: Review Site-scoped safety KPIs, trends, and attention worklists.
