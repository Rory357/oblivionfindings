...
- Module: `HR`
- User job: Create and maintain a candidate, move or reject applications, manage the talent pool, communications, tags, and candidate documents.
- Matrix source owner, not assumed human actor: `CandidateController and HrRecruitmentAccessService`
...
- Route paths: `routes/hr.php:151-166`
- Pages: `resources/js/pages/hr/candidates/show.tsx:1-2547`
- Backend: `app/Domain/Hr/Models/HrApplication.php:1; app/Http/Controllers/Hr/CandidateController.php:44-916`
- Tests: `tests/Feature/Hr/RecruitmentCanonicalAccessTest.php:92-229`
...
3. Attempt only the matrix-defined user job: Create and maintain a candidate, move or reject applications, manage the talent pool, communications, tags, and candidate documents..
