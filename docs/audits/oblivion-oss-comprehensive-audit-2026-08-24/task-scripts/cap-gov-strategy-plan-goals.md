# CAP-GOV-STRATEGY-PLAN-GOALS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Create strategic plans, goals, versions, and approvals
- Matrix source owner, not assumed human actor: `StrategicPlanController and policy`
...
- Backend: `app/Domain/Governance/Http/Controllers/StrategicPlanController.php:19-167`
- Tests: `tests/Feature/Governance/GovernanceStrategyTest.php:20`
...
3. Attempt only the matrix-defined user job: Create strategic plans, goals, versions, and approvals.
