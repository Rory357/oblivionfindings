...
- Module: `Control Room`
- User job: Create and manage authorised Control Room broadcasts
...
- Route paths: `routes/control-room.php:279-286`
- Pages: `resources/js/pages/control-room/broadcast.tsx`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomBroadcastController.php:16; app/Http/Controllers/ControlRoom/ControlRoomMessagingController.php:24-304`
...
3. Attempt only the matrix-defined user job: Create and manage authorised Control Room broadcasts.
