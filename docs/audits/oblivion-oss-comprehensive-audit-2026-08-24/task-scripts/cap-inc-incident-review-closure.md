...
- Module: `Incidents`
- User job: Review and close an incident under incident journey rules
- Matrix source owner, not assumed human actor: `IncidentController and IncidentJourney`
...
- Route paths: `routes/incidents.php:16-139; routes/incidents.php:88-104`
- Pages: `resources/js/pages/incidents/show.tsx`
- Backend: `app/Http/Controllers/IncidentController.php:1475-1790; app/Services/Incidents/IncidentJourneyService.php:21`
- Tests: `tests/Architecture/IncidentAlertLifecycleOwnershipBoundaryTest.php`
...
3. Attempt only the matrix-defined user job: Review and close an incident under incident journey rules.
