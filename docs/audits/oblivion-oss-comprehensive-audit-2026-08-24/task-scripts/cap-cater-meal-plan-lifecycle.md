# CAP-CATER-MEAL-PLAN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Catering`
- User job: Plan, copy, serve, and govern meals for an approved Site
- Matrix source owner, not assumed human actor: `Site meal-plan owner`
...
- Route paths: `routes/catering.php:20-27; routes/sites.php:295-361; routes/sites.php:295-421`
- Pages: `resources/js/pages/catering/meal-planner.tsx`
- Backend: `app/Http/Controllers/Sites/SiteMealPlanController.php:27-703`
...
3. Attempt only the matrix-defined user job: Plan, copy, serve, and govern meals for an approved Site.
