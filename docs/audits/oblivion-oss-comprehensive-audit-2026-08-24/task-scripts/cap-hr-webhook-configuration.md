# CAP-HR-WEBHOOK-CONFIGURATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Configure governed HR webhook endpoints
- Matrix source owner, not assumed human actor: `HrWebhookService and delivery job`
...
- Backend: `app/Domain/Hr/Models/HrWebhookEndpoint.php:13; app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Domain/Hr/Services/HrWebhookService.php:190; app/Http/Controllers/Hr/EmployeeProfileController.php:1`
...
3. Attempt only the matrix-defined user job: Configure governed HR webhook endpoints.
