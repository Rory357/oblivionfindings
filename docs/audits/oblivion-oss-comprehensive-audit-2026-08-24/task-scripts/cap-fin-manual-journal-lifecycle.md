...
- Module: `Finance`
- User job: Draft, post, and reverse manual journals
- Matrix source owner, not assumed human actor: `JournalPostingService and RecurringJournalService`
...
- Route paths: `routes/finance.php:160`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Services/JournalPostingService.php:21; app/Domain/Finance/Services/JournalPostingService.php:21-272`
- Tests: `tests/Feature/Finance/JournalPostingReversalInvariantTest.php:81`
...
3. Attempt only the matrix-defined user job: Draft, post, and reverse manual journals.
