# CAP-MED-SHIFT-HANDOVER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Create, submit, acknowledge, lock, and govern a medication shift handover
- Matrix source owner, not assumed human actor: `Medication handover owner`
...
- Route paths: `routes/api_medications.php:102-105; routes/emar.php:144-150; routes/emar.php:249-270`
- Pages: `resources/js/pages/emar/Handovers.tsx`
- Backend: `app/Http/Controllers/Api/MedicationsApiController.php:1197-1217`
...
3. Attempt only the matrix-defined user job: Create, submit, acknowledge, lock, and govern a medication shift handover.
