...
- Route paths: `routes/health-clinical.php:63-68`
- Pages: `resources/js/pages/health-clinical/Assessments.tsx; resources/js/pages/health-clinical/components/record-assessment-dialog.tsx:40-398`
- Backend: `app/Http/Controllers/Clinical/HealthClinicalDashboardController.php:377-471`
...
3. Attempt only the matrix-defined user job: Record and review a client clinical assessment.
