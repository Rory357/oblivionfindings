# CAP-FIN-CASH-FLOW-FORECAST-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Create and review cash-flow forecasts
- Matrix source owner, not assumed human actor: `BudgetActualsService, BudgetVarianceService, and CashFlowForecastService`
...
- Backend: `app/Domain/Finance/Http/Controllers/CashFlowForecastController.php:11; app/Domain/Finance/Services/CashFlowForecastService.php:14`
...
3. Attempt only the matrix-defined user job: Create and review cash-flow forecasts.
