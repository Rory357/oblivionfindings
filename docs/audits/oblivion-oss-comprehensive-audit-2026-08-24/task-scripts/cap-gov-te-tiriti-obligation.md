# CAP-GOV-TE-TIRITI-OBLIGATION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Record and maintain Te Tiriti governance obligations
- Matrix source owner, not assumed human actor: `TeTiritiController`
...
- Backend: `app/Domain/Governance/Http/Controllers/TeTiritiController.php:12-73`
- Tests: `tests/Browser/Governance/GovernanceMiscTest.php:146`
...
3. Attempt only the matrix-defined user job: Record and maintain Te Tiriti governance obligations.
