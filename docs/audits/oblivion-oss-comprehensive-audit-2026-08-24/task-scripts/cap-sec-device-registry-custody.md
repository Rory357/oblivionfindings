# CAP-SEC-DEVICE-REGISTRY-CUSTODY

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Security Devices`
- User job: Register, assign, release, link, and decommission devices
- Matrix source owner, not assumed human actor: `DeviceRegistryService and SecurityDevicesAccessService`
...
- Backend: `app/Domain/SecurityDevices/Services/SecurityDevicesAccessService.php:35-1272`
- Tests: `tests/Feature/SecurityDevices/DeviceCustodyAuthorizationTest.php:33-137`
...
3. Attempt only the matrix-defined user job: Register, assign, release, link, and decommission devices.
