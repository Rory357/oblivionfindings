...
- Module: `Control Room`
- User job: Transfer an active Control Room task into a canonical Health & Safety corrective action.
- Matrix source owner, not assumed human actor: `ControlRoomTaskController::transferToHealthSafety and ControlRoomAlertLifecycleService::transferTaskToHealthSafety`
...
- Route paths: `routes/control-room.php:155-157`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomTaskController.php:261-285; app/Services/ControlRoom/ControlRoomAlertLifecycleService.php:936-1005`
...
3. Attempt only the matrix-defined user job: Transfer an active Control Room task into a canonical Health & Safety corrective action..
