# CAP-FIN-SITE-PORTFOLIO-OVERVIEW

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Compare financial summaries for every Site visible to the viewer.
- Matrix source owner, not assumed human actor: `SitesFinancialOverviewController and FinancialInsightsScopeResolver`
...
- Route paths: `routes/finance.php:93-96`
- Pages: `resources/js/pages/finance/sites-overview/Show.tsx:1-571`
- Backend: `app/Domain/Finance/Http/Controllers/SitesFinancialOverviewController.php:14-154; app/Domain/Finance/Services/FinancialInsightsScopeResolver.php:35-70`
- Tests: `tests/Feature/Finance/SitesFinancialOverviewTest.php:1`
...
3. Attempt only the matrix-defined user job: Compare financial summaries for every Site visible to the viewer..
