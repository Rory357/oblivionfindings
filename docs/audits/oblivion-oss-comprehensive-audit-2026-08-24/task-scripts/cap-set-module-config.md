...
- Backend: `app/Http/Controllers/Settings/ModuleSettingsController.php:9; app/Http/Controllers/Settings/NotificationPreferencesController.php:15-238`
...
3. Attempt only the matrix-defined user job: Configure enabled application modules.
