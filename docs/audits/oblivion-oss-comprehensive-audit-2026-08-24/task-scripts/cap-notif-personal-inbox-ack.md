# CAP-NOTIF-PERSONAL-INBOX-ACK

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Notifications`
- User job: Read, mark, and acknowledge owned notifications
- Matrix source owner, not assumed human actor: `NotificationInboxController and the canonical user notification relation`
...
- Route paths: `routes/portal.php:181-231`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/NotificationInboxController.php:9-45`
- Tests: `tests/Browser/Notifications/NotificationsTest.php`
...
3. Attempt only the matrix-defined user job: Read, mark, and acknowledge owned notifications.
