# CAP-CATER-SITE-INVENTORY-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Catering`
- User job: Maintain, adjust, and stocktake approved-Site meal inventory
- Matrix source owner, not assumed human actor: `Site meal-planning and Catering domain owners`
...
- Route paths: `routes/sites.php:363-383`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Sites/SiteMealInventoryController.php:13-168`
...
3. Attempt only the matrix-defined user job: Maintain, adjust, and stocktake approved-Site meal inventory.
