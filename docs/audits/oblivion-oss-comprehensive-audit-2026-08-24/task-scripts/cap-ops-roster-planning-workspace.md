...
- Module: `Workforce`
- User job: Review and plan a Site roster, calendar, conflicts, coverage, and open shifts.
- Matrix source owner, not assumed human actor: `RosteringController and RosterPeriodService`
...
- Route paths: `routes/operations.php:900-928`
- Pages: `resources/js/pages/operations/rostering/index.tsx:1-3233`
- Backend: `app/Http/Controllers/RosteringController.php:38-1063; app/Models/RosterPeriod.php:1`
- Tests: `tests/Feature/Rostering/RosterPeriodSiteAccessTest.php:10-35`
...
3. Attempt only the matrix-defined user job: Review and plan a Site roster, calendar, conflicts, coverage, and open shifts..
