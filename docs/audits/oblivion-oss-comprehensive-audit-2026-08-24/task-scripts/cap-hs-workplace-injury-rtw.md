# CAP-HS-WORKPLACE-INJURY-RTW

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Record a workplace injury and govern its return-to-work plan, capacity, duties, evidence, and completion
- Matrix source owner, not assumed human actor: `ReturnToWorkController and WorkplaceInjuryJourneyService`
...
- Route paths: `routes/health-safety.php:354-399`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/HealthSafety/ReturnToWorkController.php:37-893; app/Http/Controllers/HealthSafety/ReturnToWorkController.php:485-837`
- Tests: `tests/Feature/HealthSafety/InjuriesControllerTest.php:150-259`
...
3. Attempt only the matrix-defined user job: Record a workplace injury and govern its return-to-work plan, capacity, duties, evidence, and completion.
