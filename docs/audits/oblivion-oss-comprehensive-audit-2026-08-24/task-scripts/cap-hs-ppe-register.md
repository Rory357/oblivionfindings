...
- User job: Manage PPE inventory, allocations, inspection, and disposal evidence
- Matrix source owner, not assumed human actor: `PpeController`
...
- Backend: `app/Http/Controllers/HealthSafety/PpeController.php:37-112`
- Tests: `tests/Feature/HealthSafety/PpeRegisterTest.php:179-267`
...
3. Attempt only the matrix-defined user job: Manage PPE inventory, allocations, inspection, and disposal evidence.
