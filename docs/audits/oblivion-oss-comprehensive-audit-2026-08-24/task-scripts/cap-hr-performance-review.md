# CAP-HR-PERFORMANCE-REVIEW

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Manage staff performance reviews
- Matrix source owner, not assumed human actor: `HR performance and casework owners`
...
- Backend: `app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Http/Controllers/Hr/EmployeeProfileController.php:1; app/Http/Controllers/Hr/PerformanceReviewController.php:24`
...
3. Attempt only the matrix-defined user job: Manage staff performance reviews.
