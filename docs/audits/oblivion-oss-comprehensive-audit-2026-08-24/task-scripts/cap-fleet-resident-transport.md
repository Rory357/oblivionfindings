# CAP-FLEET-RESIDENT-TRANSPORT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Run resident transport and govern medication custody in transit
- Matrix source owner, not assumed human actor: `ResidentTransportJourneyService and scope`
...
- Backend: `app/Services/Fleet/ResidentTransportJourneyService.php:47-431`
- Tests: `tests/Feature/FleetAssets/ResidentTransportJourneySecurityTest.php:146-832`
...
3. Attempt only the matrix-defined user job: Run resident transport and govern medication custody in transit.
