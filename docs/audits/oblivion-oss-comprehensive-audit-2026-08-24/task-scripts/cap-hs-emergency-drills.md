...
- User job: Schedule, execute, evidence, and review emergency drills
- Matrix source owner, not assumed human actor: `EmergencyDrillController and DrillComplianceService`
...
- Backend: `app/Http/Controllers/HealthSafety/EmergencyDrillController.php:49-170`
- Tests: `tests/Feature/HealthSafety/EmergencyDrillTest.php:103-216`
...
3. Attempt only the matrix-defined user job: Schedule, execute, evidence, and review emergency drills.
