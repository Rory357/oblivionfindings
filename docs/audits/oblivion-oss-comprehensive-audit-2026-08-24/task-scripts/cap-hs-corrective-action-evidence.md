...
- User job: Create, complete, verify, close, and evidence corrective actions
- Matrix source owner, not assumed human actor: `HsCorrectiveActionService`
...
- Backend: `app/Services/HealthSafety/HsCorrectiveActionService.php:53-592`
- Tests: `tests/Feature/HealthSafety/HsCorrectiveActionEvidenceTest.php:31-99`
...
3. Attempt only the matrix-defined user job: Create, complete, verify, close, and evidence corrective actions.
