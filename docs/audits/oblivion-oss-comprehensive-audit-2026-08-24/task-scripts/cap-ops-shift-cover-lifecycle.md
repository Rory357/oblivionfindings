# CAP-OPS-SHIFT-COVER-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Request, claim, approve, and resolve shift cover
...
- Route paths: `routes/operations.php:1-1336; routes/shifts.php:1-127`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Shifts/Lifecycle/ShiftLifecycleService.php:1; app/Domain/Shifts/Timesheets/TimesheetApprovalService.php:1; app/Services/ShiftReplacementService.php:31`
- Tests: `tests/Feature/ShiftLifecycleHardeningTest.php:1; tests/Feature/TimesheetSafetyGuardsTest.php:1; tests/Unit/Rostering/EligibilityScoringStrategyTest.php:1`
...
3. Attempt only the matrix-defined user job: Request, claim, approve, and resolve shift cover.
