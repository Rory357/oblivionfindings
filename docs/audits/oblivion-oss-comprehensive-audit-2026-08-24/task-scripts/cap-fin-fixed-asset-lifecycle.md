...
- Module: `Finance`
- User job: Register, capitalise, depreciate, and dispose of fixed assets
- Matrix source owner, not assumed human actor: `FixedAssetService`
...
- Backend: `app/Domain/Finance/Services/FixedAssetService.php:26-362`
- Tests: `tests/Feature/Finance/FixedAssetDisposalIntegrityTest.php:60`
...
3. Attempt only the matrix-defined user job: Register, capitalise, depreciate, and dispose of fixed assets.
