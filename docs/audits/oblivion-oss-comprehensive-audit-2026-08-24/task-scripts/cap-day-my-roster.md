...
- User job: Review the worker's roster
- Matrix source owner, not assumed human actor: `Roster read lens`
...
3. Attempt only the matrix-defined user job: Review the worker's roster.
