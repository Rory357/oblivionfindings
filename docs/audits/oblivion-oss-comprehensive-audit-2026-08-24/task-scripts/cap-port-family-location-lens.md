# CAP-PORT-FAMILY-LOCATION-LENS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review consented location, history, and privacy status
...
- Route paths: `routes/portal.php:126-130`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalLocationController.php:13-163`
...
3. Attempt only the matrix-defined user job: Review consented location, history, and privacy status.
