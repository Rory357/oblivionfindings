# CAP-HS-RISK-ASSESSMENT-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Create, review, activate, supersede, and archive risk assessments
- Matrix source owner, not assumed human actor: `HsRiskAssessmentController and service`
...
- Backend: `app/Http/Controllers/HealthSafety/HsRiskAssessmentController.php:140-313`
- Tests: `tests/Feature/HealthSafety/HsRiskAssessmentSiteAccessTest.php:30-128`
...
3. Attempt only the matrix-defined user job: Create, review, activate, supersede, and archive risk assessments.
