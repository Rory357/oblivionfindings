# CAP-PORT-FAMILY-DOCUMENTS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review and upload authorised family-shared documents
...
- Route paths: `routes/portal.php:120-122`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalDocumentController.php:13-124`
...
3. Attempt only the matrix-defined user job: Review and upload authorised family-shared documents.
