...
- Module: `Catering`
- User job: Maintain the catering product catalog
...
- Route paths: `routes/catering.php:49-60`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Catering/ProductController.php:10-99`
...
3. Attempt only the matrix-defined user job: Maintain the catering product catalog.
