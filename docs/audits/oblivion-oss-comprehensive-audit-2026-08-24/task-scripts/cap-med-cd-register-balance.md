...
- Module: `eMAR`
- User job: Maintain the controlled-drug register and balance
- Matrix source owner, not assumed human actor: `Controlled-drug register owner`
...
3. Attempt only the matrix-defined user job: Maintain the controlled-drug register and balance.
