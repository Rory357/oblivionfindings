# CAP-RESP-REFERRAL-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Create, review, and update a respite referral
- Matrix source owner, not assumed human actor: `RespiteReferralController`
...
- Route paths: `routes/respite.php:35-44`
- Pages: `resources/js/pages/respite/referrals/show.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteReferralController.php:17`
...
3. Attempt only the matrix-defined user job: Create, review, and update a respite referral.
