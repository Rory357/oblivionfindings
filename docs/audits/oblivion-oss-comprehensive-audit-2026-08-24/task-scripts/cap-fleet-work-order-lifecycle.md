# CAP-FLEET-WORK-ORDER-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Create, progress, and close a fleet work order
- Matrix source owner, not assumed human actor: `WorkOrderController`
...
- Route paths: `routes/fleet-assets.php:163-165; routes/fleet-assets.php:163-183; routes/fleet-assets.php:180-183`
- Pages: `resources/js/pages/fleet-assets/maintenance/work-orders/index.tsx`
- Backend: `app/Http/Controllers/FleetAssets/WorkOrderController.php:13-281`
...
3. Attempt only the matrix-defined user job: Create, progress, and close a fleet work order.
