...
- User job: Review the worker's calendar
- Matrix source owner, not assumed human actor: `Calendar read lens`
...
3. Attempt only the matrix-defined user job: Review the worker's calendar.
