# CAP-CLIN-MODULE-DASHBOARD

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Care & Clinical`
- User job: Review the clinical module dashboard for approved Sites
- Matrix source owner, not assumed human actor: `HealthClinicalDashboardController`
...
- Route paths: `routes/health-clinical.php:23-114`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Clinical/Services/ClinicalEventService.php:1; app/Domain/Clinical/Services/ClinicalObservationService.php:1; app/Http/Controllers/Clinical/HealthClinicalDashboardController.php:1`
- Tests: `tests/Feature/Domain/Clinical/HealthClinicalSiteAuthorizationTest.php:1; tests/Feature/Domain/Clinical/ObservationRegisterTest.php:1`
...
3. Attempt only the matrix-defined user job: Review the clinical module dashboard for approved Sites.
