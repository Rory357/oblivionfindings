# CAP-CLI-CLIENT-ASSIGNMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Clients`
- User job: Maintain authorised staff assignments for a client
- Matrix source owner, not assumed human actor: `ClientAssignmentController`
...
- Route paths: `routes/clients.php:172-177; routes/clients.php:173-177`
- Pages: `resources/js/pages/operations/clients/assignments.tsx`
- Backend: `app/Http/Controllers/ClientAssignmentController.php:10`
...
3. Attempt only the matrix-defined user job: Maintain authorised staff assignments for a client.
