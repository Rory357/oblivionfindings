...
- Module: `Compliance`
- User job: Review Site-scoped compliance exceptions, due work, and triage
- Matrix source owner, not assumed human actor: `ComplianceDashboardController and ComplianceMetricsService`
...
- Route paths: `routes/compliance.php:15-18`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Compliance/ComplianceDashboardController.php:24-89`
- Tests: `tests/Feature/Compliance/ComplianceDashboardSiteScopeTest.php; tests/Feature/Compliance/ComplianceDashboardTest.php`
...
3. Attempt only the matrix-defined user job: Review Site-scoped compliance exceptions, due work, and triage.
