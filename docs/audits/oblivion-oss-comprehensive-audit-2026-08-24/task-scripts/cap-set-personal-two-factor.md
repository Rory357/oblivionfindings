# CAP-SET-PERSONAL-TWO-FACTOR

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Public & Settings Platform`
- User job: Review and manage personal two-factor security
- Matrix source owner, not assumed human actor: `Profile, password, appearance, and two-factor controllers`
...
- Route paths: `routes/settings.php:59`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/TwoFactorAuthenticationController.php:11`
...
3. Attempt only the matrix-defined user job: Review and manage personal two-factor security.
