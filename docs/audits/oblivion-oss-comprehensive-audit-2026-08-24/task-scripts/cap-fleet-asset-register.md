# CAP-FLEET-ASSET-REGISTER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Fleet & Assets`
- User job: Maintain assets with custody provenance
- Matrix source owner, not assumed human actor: `AssetController and AssetMutationIntegrityService`
...
- Route paths: `routes/fleet-assets.php:71-80`
- Pages: `resources/js/pages/fleet-assets/assets/index.tsx`
...
3. Attempt only the matrix-defined user job: Maintain assets with custody provenance.
