...
- Module: `Catering`
- User job: Maintain the authorised recipe library
- Matrix source owner, not assumed human actor: `RecipeController`
...
- Route paths: `routes/catering.php:29-46; routes/catering.php:29-47`
- Pages: `resources/js/pages/catering/recipes/index.tsx`
- Backend: `app/Http/Controllers/Catering/RecipeController.php:11-178`
...
3. Attempt only the matrix-defined user job: Maintain the authorised recipe library.
