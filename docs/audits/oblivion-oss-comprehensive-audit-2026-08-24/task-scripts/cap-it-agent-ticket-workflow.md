# CAP-IT-AGENT-TICKET-WORKFLOW

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `IT & Support`
- User job: Triage, assign, merge, approve, and complete authorised IT work
- Matrix source owner, not assumed human actor: `ItTicketTriageService and work-task services`
...
- Backend: `app/Domain/It/Services/ItTicketTriageService.php:51-397`
- Tests: `tests/Feature/It/ItWorkAccessControllerTest.php:113-409`
...
3. Attempt only the matrix-defined user job: Triage, assign, merge, approve, and complete authorised IT work.
