# CAP-PORT-FAMILY-CALENDAR

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Review the section-filtered family calendar and events
...
- Route paths: `routes/portal.php:88-90`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Portal/PortalCalendarController.php:17-225`
...
3. Attempt only the matrix-defined user job: Review the section-filtered family calendar and events.
