# CAP-HR-OFFBOARDING-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Offboard staff through governed terminal tasks
...
- Backend: `app/Domain/Hr/Services/AttendanceService.php:1; app/Domain/Hr/Services/HrWebhookService.php:1; app/Http/Controllers/Hr/EmployeeProfileController.php:1; app/Http/Controllers/Hr/OffboardingController.php:19`
...
3. Attempt only the matrix-defined user job: Offboard staff through governed terminal tasks.
