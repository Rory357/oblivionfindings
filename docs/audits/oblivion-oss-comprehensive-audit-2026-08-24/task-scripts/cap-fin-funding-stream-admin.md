...
- Module: `Finance`
- User job: Maintain funding streams
...
- Route paths: `routes/finance.php:197`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/FundingStreamController.php:11`
...
3. Attempt only the matrix-defined user job: Maintain funding streams.
