# CAP-PORT-FAMILY-MESSAGING

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Portal`
- User job: Exchange messages within an authorised client relationship
- Matrix source owner, not assumed human actor: `PortalMessageController`
...
- Entry status: `PAGE_SOURCE_ANCHOR_ONLY_UNVALIDATED`
...
- Pages: `resources/js/pages/portal/messages.tsx`
- Backend: `app/Http/Controllers/Portal/PortalMessageController.php`
...
3. Attempt only the matrix-defined user job: Exchange messages within an authorised client relationship.
