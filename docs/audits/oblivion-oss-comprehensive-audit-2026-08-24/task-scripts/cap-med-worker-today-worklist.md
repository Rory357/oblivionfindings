# CAP-MED-WORKER-TODAY-WORKLIST

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Review today's authorised medication work
- Matrix source owner, not assumed human actor: `MyDayMedicationsController and medication scope owner`
...
- Route paths: `routes/emar.php:30-395`
...
3. Attempt only the matrix-defined user job: Review today's authorised medication work.
