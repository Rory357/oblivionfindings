# CAP-CR-ALERT-WORKLIST-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Control Room`
- User job: Inspect, acknowledge, triage, resolve, close, or reopen alerts
- Matrix source owner, not assumed human actor: `ControlRoomAlertAccessService and lifecycle service`
...
- Backend: `app/Services/ControlRoom/ControlRoomAlertLifecycleService.php:45-777`
- Tests: `tests/Feature/ControlRoom/ControlRoomAlertViewScopeTest.php:29-188`
...
3. Attempt only the matrix-defined user job: Inspect, acknowledge, triage, resolve, close, or reopen alerts.
