...
- Module: `Safeguarding`
- User job: Raise, assign, and triage a safeguarding concern
- Matrix source owner, not assumed human actor: `SafeguardingConcernController and lifecycle owners`
...
- Route paths: `routes/safeguarding.php:19-52`
- Pages: `resources/js/pages/safeguarding/index.tsx`
- Backend: `app/Http/Controllers/SafeguardingConcernController.php:213-252`
- Tests: `tests/Feature/SafeguardingConcernControllerTest.php:228-301`
...
3. Attempt only the matrix-defined user job: Raise, assign, and triage a safeguarding concern.
