...
- Route paths: `routes/settings.php:46`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/Settings/PasswordController.php:12`
...
3. Attempt only the matrix-defined user job: Change the signed-in user's password.
