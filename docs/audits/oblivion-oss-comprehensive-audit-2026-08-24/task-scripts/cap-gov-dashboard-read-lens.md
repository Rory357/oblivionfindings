# CAP-GOV-DASHBOARD-READ-LENS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Review the authorised governance overview
- Matrix source owner, not assumed human actor: `DashboardAggregatorService, ReportController, and AuditEvidencePackService`
...
- Backend: `app/Domain/Governance/Http/Controllers/DashboardController.php:13; app/Domain/Governance/Services/DashboardAggregatorService.php:29`
...
3. Attempt only the matrix-defined user job: Review the authorised governance overview.
