# CAP-IT-CHANGE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `IT & Support`
- User job: Create and transition IT changes
...
- Backend: `app/Domain/It/Services/ItChangeService.php:21; app/Domain/It/Services/ItMajorIncidentService.php:33-397`
...
3. Attempt only the matrix-defined user job: Create and transition IT changes.
