...
- Module: `Reporting`
- User job: Browse authorised report families and report KPIs
- Matrix source owner, not assumed human actor: `ReportsController, CombinedReportController, and ModuleReportController`
...
- Route paths: `routes/reports.php:22`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ReportsController.php:17`
...
3. Attempt only the matrix-defined user job: Browse authorised report families and report KPIs.
