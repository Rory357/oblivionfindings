# CAP-RESP-TASK-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Respite`
- User job: Assign, progress, evidence, submit, approve, or reject a respite task
- Matrix source owner, not assumed human actor: `RespiteTaskController`
...
- Route paths: `routes/respite.php:131-148`
- Pages: `resources/js/pages/respite/tasks/index.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteTaskController.php:16`
...
3. Attempt only the matrix-defined user job: Assign, progress, evidence, submit, approve, or reject a respite task.
