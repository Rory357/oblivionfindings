# CAP-HR-COMPETENCY-ASSESSMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `HR`
- User job: Assess and govern staff competencies
...
- Backend: `app/Http/Controllers/Hr/CompetencyController.php:20`
...
3. Attempt only the matrix-defined user job: Assess and govern staff competencies.
