# CAP-FIN-PAYMENT-RUN-EXTERNAL-SETTLEMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Accept, reject, settle, and reconcile an external payment run
- Matrix source owner, not assumed human actor: `PaymentRunService and PaymentSettlementRecorder`
...
- Backend: `app/Domain/Finance/Services/ExternalSettlementService.php:334; app/Domain/Finance/Services/ExternalSettlementService.php:490; app/Domain/Finance/Services/ExternalSettlementService.php:725`
...
3. Attempt only the matrix-defined user job: Accept, reject, settle, and reconcile an external payment run.
