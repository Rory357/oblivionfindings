...
- User job: Record restraint, support-plan, review, and linked evidence
- Matrix source owner, not assumed human actor: `RestraintController`
...
- Backend: `app/Http/Controllers/HealthSafety/RestraintController.php:448-883`
- Tests: `tests/Feature/HealthSafety/RestraintRegisterTest.php:151-238`
...
3. Attempt only the matrix-defined user job: Record restraint, support-plan, review, and linked evidence.
