# CAP-CLIN-CLIENT-SUMMARY-LENS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Care & Clinical`
- User job: Review the authorised client clinical summary
- Matrix source owner, not assumed human actor: `HealthClinicalController`
...
- Route paths: `routes/health-clinical.php:95-97`
- Pages: `resources/js/pages/health-clinical/ClientSummary.tsx`
- Backend: `app/Http/Controllers/HealthClinical/HealthClinicalController.php:25`
...
3. Attempt only the matrix-defined user job: Review the authorised client clinical summary.
