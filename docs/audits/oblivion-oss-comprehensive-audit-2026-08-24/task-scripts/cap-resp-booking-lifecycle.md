...
- Module: `Respite`
- User job: Create, confirm, view, and update a respite booking
- Matrix source owner, not assumed human actor: `RespiteBookingController`
...
- Route paths: `routes/respite.php:66-77`
- Pages: `resources/js/pages/respite/bookings/show.tsx`
- Backend: `app/Http/Controllers/Respite/RespiteBookingController.php:30`
...
3. Attempt only the matrix-defined user job: Create, confirm, view, and update a respite booking.
