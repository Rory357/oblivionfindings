# CAP-CLIN-PROTOCOL-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Care & Clinical`
- User job: Create, update, activate, and run clinical protocols
- Matrix source owner, not assumed human actor: `HealthClinicalProtocolController`
...
- Route paths: `routes/health-clinical.php:69-86`
- Pages: `resources/js/pages/health-clinical/Protocols.tsx`
- Backend: `app/Domain/Clinical/Services/ClinicalProtocolService.php:41; app/Http/Controllers/Clinical/HealthClinicalProtocolController.php:20-247`
...
3. Attempt only the matrix-defined user job: Create, update, activate, and run clinical protocols.
