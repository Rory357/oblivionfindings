...
- Module: `Operations`
- User job: Create, list, remove, and timestamp trigger attempts for user-owned personal calendar connection metadata.
- Matrix source owner, not assumed human actor: `Operations\CalendarSyncController and CalendarSync`
...
- Route paths: `routes/operations.php:1318-1322`
- Pages: `resources/js/pages/operations/calendar-sync/Index.tsx:72-134`
- Backend: `app/Http/Controllers/Operations/CalendarSyncController.php:9-91`
...
3. Attempt only the matrix-defined user job: Create, list, remove, and timestamp trigger attempts for user-owned personal calendar connection metadata..
