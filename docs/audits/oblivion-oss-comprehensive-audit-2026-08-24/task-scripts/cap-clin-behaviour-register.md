...
- User job: Record and review ABC behaviour evidence
- Matrix source owner, not assumed human actor: `BehaviourAbcController and clinical behaviour owner`
...
- Route paths: `routes/health-clinical.php:108-113; routes/health-clinical.php:51-53`
- Pages: `resources/js/pages/health-clinical/Behaviour.tsx; resources/js/pages/health-clinical/components/record-abc-dialog.tsx:27-266`
- Backend: `app/Http/Controllers/Clinical/BehaviourAbcController.php:22`
...
3. Attempt only the matrix-defined user job: Record and review ABC behaviour evidence.
