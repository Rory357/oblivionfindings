# CAP-SITE-HOUSE-LEDGER

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Sites & Locations`
- User job: Maintain and reconcile the Site house ledger
- Matrix source owner, not assumed human actor: `SiteCredentialController and HouseLedgerService`
...
- Backend: `app/Http/Controllers/Sites/SiteCredentialController.php:38-469; app/Services/Sites/HouseLedgerService.php:12`
- Tests: `tests/Feature/Sites/SiteAccessVaultCanonicalAccessTest.php:63-166`
...
3. Attempt only the matrix-defined user job: Maintain and reconcile the Site house ledger.
