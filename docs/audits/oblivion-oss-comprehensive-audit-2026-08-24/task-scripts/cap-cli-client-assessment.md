# CAP-CLI-CLIENT-ASSESSMENT

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Clients`
- User job: Create, update, and remove client assessments
- Matrix source owner, not assumed human actor: `ClientAssessmentController`
...
- Route paths: `routes/clients.php:160-165`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/ClientAssessmentController.php; app/Http/Controllers/ClientAssessmentController.php:10`
...
3. Attempt only the matrix-defined user job: Create, update, and remove client assessments.
