...
- Module: `Safeguarding`
- User job: Complete a safeguarding terminal transition across linked owners
- Matrix source owner, not assumed human actor: `SafeguardingTerminalTransitionService`
...
- Route paths: `routes/safeguarding.php:75-82`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Services/Safeguarding/SafeguardingTerminalTransitionService.php:45-225`
- Tests: `tests/Feature/Safeguarding/SafeguardingTerminalTransitionTest.php:37-168`
...
3. Attempt only the matrix-defined user job: Complete a safeguarding terminal transition across linked owners.
