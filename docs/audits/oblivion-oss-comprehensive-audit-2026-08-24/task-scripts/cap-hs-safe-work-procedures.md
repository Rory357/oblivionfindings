# CAP-HS-SAFE-WORK-PROCEDURES

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Health & Safety`
- User job: Draft, approve, acknowledge, version, and archive procedures
- Matrix source owner, not assumed human actor: `SafeWorkProcedureController`
...
- Backend: `app/Http/Controllers/HealthSafety/SafeWorkProcedureController.php:143-338`
- Tests: `tests/Feature/HealthSafety/SafeWorkProcedureTest.php:118-208`
...
3. Attempt only the matrix-defined user job: Draft, approve, acknowledge, version, and archive procedures.
