# CAP-OPS-ATTENDANCE-SESSION-CORRECTION

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Workforce`
- User job: Correct a missed or inaccurate attendance session, or end a stale session under explicit manager authority.
...
- Route paths: `routes/shifts.php:105-114`
- Pages: `resources/js/pages/attendance/index.tsx:1-1601`
- Backend: `app/Domain/Hr/Models/HrAttendanceSession.php:1; app/Domain/Hr/Services/AttendanceService.php:274-499`
- Tests: `tests/Feature/Hr/AttendanceSessionSiteBoundaryTest.php:77-327`
...
3. Attempt only the matrix-defined user job: Correct a missed or inaccurate attendance session, or end a stale session under explicit manager authority..
