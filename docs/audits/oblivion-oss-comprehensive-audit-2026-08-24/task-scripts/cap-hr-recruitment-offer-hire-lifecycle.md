...
- Module: `HR`
- User job: Create, approve, send, accept or decline an offer and convert an accepted offer through the canonical employee-intake seam.
- Matrix source owner, not assumed human actor: `CandidateController, RecruitmentService, and EmployeeIntakeService`
...
- Route paths: `routes/hr.php:206-228`
- Pages: `resources/js/pages/hr/candidates/create-offer.tsx:1-842`
- Backend: `app/Domain/Hr/Models/HrOffer.php:1; app/Domain/Hr/Services/RecruitmentService.php:283-449`
- Tests: `tests/Feature/Hr/RecruitmentOfferLifecycleTest.php:51-206`
...
3. Attempt only the matrix-defined user job: Create, approve, send, accept or decline an offer and convert an accepted offer through the canonical employee-intake seam..
