# CAP-FIN-PAYMENT-RUN-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Finance`
- User job: Prepare, approve, and process supplier payment runs
...
- Route paths: `routes/finance.php:304-336`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Finance/Http/Controllers/PaymentRunController.php:13; app/Domain/Finance/Services/PaymentRunService.php:15`
- Tests: `tests/Feature/Finance/BillAndPaymentRunJournalPostingTest.php:184`
...
3. Attempt only the matrix-defined user job: Prepare, approve, and process supplier payment runs.
