...
- User job: Review Site-scoped active care plans due for review or sign-off through the read-only clinical lens.
- Matrix source owner, not assumed human actor: `HealthClinicalDashboardController::carePlans and ClinicalDashboardService::getCarePlanLens`
...
- Route paths: `routes/health-clinical.php:54-56`
- Pages: `resources/js/pages/health-clinical/CarePlans.tsx`
- Backend: `app/Http/Controllers/Clinical/HealthClinicalDashboardController.php:221-241`
...
3. Attempt only the matrix-defined user job: Review Site-scoped active care plans due for review or sign-off through the read-only clinical lens..
