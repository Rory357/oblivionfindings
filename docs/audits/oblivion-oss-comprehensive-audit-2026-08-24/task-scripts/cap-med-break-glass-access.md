# CAP-MED-BREAK-GLASS-ACCESS

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `eMAR`
- User job: Open, revoke, extend, and review emergency medication access
- Matrix source owner, not assumed human actor: `BreakGlassController`
...
- Route paths: `routes/clients.php:204-209; routes/emar.php:295-315`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/BreakGlassController.php; app/Http/Controllers/BreakGlassController.php:24`
...
3. Attempt only the matrix-defined user job: Open, revoke, extend, and review emergency medication access.
