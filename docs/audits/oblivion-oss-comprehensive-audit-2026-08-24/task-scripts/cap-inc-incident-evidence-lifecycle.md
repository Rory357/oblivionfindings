# CAP-INC-INCIDENT-EVIDENCE-LIFECYCLE

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Incidents`
- User job: Add, update, and remove governed incident evidence
- Matrix source owner, not assumed human actor: `Incident evidence and journey owners`
...
- Route paths: `routes/incidents.php:59-86`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Http/Controllers/IncidentController.php:1457; app/Http/Controllers/IncidentController.php:1861-1915`
...
3. Attempt only the matrix-defined user job: Add, update, and remove governed incident evidence.
