...
- Module: `Control Room`
- User job: Subscribe or unsubscribe authorised alert watchers
- Matrix source owner, not assumed human actor: `Control Room alert collaboration owner`
...
- Route paths: `routes/control-room.php; routes/control-room.php:433-444`
- Pages: `resources/js/pages/control-room/show.tsx`
- Backend: `app/Http/Controllers/ControlRoom/ControlRoomWatcherController.php:15`
...
3. Attempt only the matrix-defined user job: Subscribe or unsubscribe authorised alert watchers.
