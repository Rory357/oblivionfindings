# CAP-GOV-SETTINGS-CONTROL

- Status: `SOURCE_BOUND_STATIC_TASK_CONTRACT`; not executed or scored.
- Module: `Governance`
- User job: Configure governed spend, escalation, and variance settings
- Matrix source owner, not assumed human actor: `GovernanceSettingController`
...
- Entry status: `NOT_ESTABLISHED_CURRENT_AUDIT_NO_ROUTE_OR_PAGE_ANCHOR`

## Source anchors

- Navigation: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Route names: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Route paths: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Pages: `NOT_ESTABLISHED_CURRENT_AUDIT`
- Backend: `app/Domain/Governance/Http/Controllers/GovernanceSettingController.php:109; app/Domain/Governance/Http/Controllers/GovernanceSettingController.php:13; app/Domain/Governance/Http/Controllers/GovernanceSettingController.php:25; app/Domain/Governance/Http/Controllers/GovernanceSettingController.php:90-109`
- Tests: `tests/Feature/Governance/GovernanceSpendApprovalsTest.php:214`
...
3. Attempt only the matrix-defined user job: Configure governed spend, escalation, and variance settings.
