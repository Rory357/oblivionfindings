...
- [ ] **Step 1: Write failing protocol contract tests with local fakes**
...
- [ ] **Step 3: Implement the common result and five focused adapters**
...
- [ ] **Step 4: Write the failing check-job integration test**
...
- [ ] **Step 1: Write failing due, disabled, overlap, and queue tests**
...
- [ ] **Step 4: Run schedule inspection and tests**
...
```powershell
git add app/Domain/Monitoring/Services/MonitorScheduler.php app/Domain/Monitoring/Jobs/ScheduleDueMonitors.php routes/console.php tests/Feature/Monitoring/MonitorSchedulerTest.php
...
- [ ] **Step 1: Write failing schema and identity-decision tests**
...
- [ ] **Step 4: Implement explicit identity scoring**
...
- [ ] **Step 1: Write failing scope/rate/exclusion/run-summary tests**
...
- [ ] **Step 3: Implement bounded network discovery**
...
- [ ] **Step 1: Write failing SNMPv3 security and normalisation tests**
...
- [ ] **Step 2: Run SNMP tests and verify RED**
...
- [ ] **Step 3: Implement the credential seam and SNMPv3 adapter**
...
- [ ] **Step 1: Write failing syslog normalisation tests**
...
- [ ] **Step 2: Write failing flow fixture tests**
...
- [ ] **Step 5: Verify listener boundary and decoders**
...
- [ ] **Step 1: Write failing allowlist and non-command tests**
...
- [ ] **Step 3: Implement fixed inventory profiles and hardened transports**
...
- [ ] **Step 4: Run the remote inventory test**
...
- [ ] **Step 1: Write failing capability declaration tests**
...
- [ ] **Step 3: Define the narrow contracts**
...
- [ ] **Step 4: Migrate the three adapters and provider jobs**
...
- [ ] **Step 5: Run existing integration compatibility suites**
...
- [ ] **Step 1: Write failing snapshot, confidence, and diff tests**
...
- [ ] **Step 4: Build and diff snapshots on the topology queue**
...
- [ ] **Step 5: Run topology and provider tests**
...
- [ ] **Step 1: Write failing monitoring-semantics tests**
...
- [ ] **Step 5: Run policy and lifecycle regression suites**
...
- [ ] **Step 1: Write failing no-database, signature, scope, and spool tests**
...
- [ ] **Step 3: Create the standalone PHP 8.4 application source**
...
- [ ] **Step 6: Run collector package tests**
...
- [ ] **Step 1: Write failing enrolment, scoping, order, and revocation tests**
...
- [ ] **Step 6: Run collector and correlation regression suites**
...
- [ ] **Step 1: Write failing metric-pointer, tier, and tombstone tests**
...
- [ ] **Step 6: Run storage, provider, and privacy tests**
...
- [ ] **Step 1: Write failing permission-scoped presenter tests**
...
- [ ] **Step 2: Run backend workspace tests and verify RED**
...
- [ ] **Step 3: Replace presentation stand-ins with canonical runtime queries**
...
- [ ] **Step 5: Implement focused UI additions using existing page ownership**
...
- [ ] **Step 6: Run workspace and frontend tests**
...
- [ ] **Step 1: Write the failing supervisor and operational-contract test**
...
- [ ] **Step 2: Run the operational-contract test and verify RED**
...
- [ ] **Step 3: Add separately supervised worker and listener definitions**
...
- [ ] **Step 8: Run the full automated verification matrix**
...
- [ ] **Step 9: Record exact evidence without overstating completion**
