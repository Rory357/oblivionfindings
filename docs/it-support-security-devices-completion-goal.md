...
Progress note: S08 is partial. Monitoring, Maintenance, and Discovery & collectors are complete presentation workspaces on the current native foundation; Integrations and Settings & audit remain open, as do runtime discovery records and broader collection protocols.
