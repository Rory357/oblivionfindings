...
| 4. Complete Security & Devices workspaces   | In progress | Approved four-group navigation, operational Estate/Sites/device inventory, and a permission-scoped specialist workspace shell with production-backed compatibility routing: `b20817d43`, `aef51ae39`, `afeb5807c`                                                         |
