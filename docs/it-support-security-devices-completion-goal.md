...
- [ ] M01 Observe, Operate, Manage, Control, and Admin capabilities enforce application, Site, workspace, device-class, ownership, privacy, and sensitivity boundaries.
...
- [ ] E09 Role, Site, ownership, privacy, sensitive-domain, and command denial across view, count, search, export, link, mutation, and API.
...
- [ ] V04 Site/ownership/privacy/field/command/security suites pass.
