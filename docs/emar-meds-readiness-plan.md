...
14. **`pages/emar/MarCharts.tsx:212` has hard-coded `bg-white`** in modal — should use `bg-card`. Same shape of issue exists elsewhere; the codebase has tokens (see `design_styles/DESIGN_TOKENS.md`).
