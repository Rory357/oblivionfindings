...
function ZoneWizard({
    ...
    function validate(all = false) {
        ...
        if (
            (all || step === 0) &&
            (!zone.place || !zone.name.trim() || !zone.purpose.trim())
        ) {
            message = 'Choose a place and enter a name and purpose.';
            target = 0;
        } else if (
            (all || step === 1) &&
            zone.shape === 'polygon' &&
            ...
            message =
                'Add at least three points to define the proposed boundary.';
            target = 1;
        } else if (
            (all || step === 2) &&
            (!zone.days.length ||
                    ...
                    <WizardStepPane key={step}>
                        ...
                        {step === 0 && (
                            <div className="v2-form">
                                <h3>Where does this rule apply?</h3>
                                <p>
                                    Choose an existing place, then describe
                                    Alex’s individual purpose.
                                </p>
                                ...
                                />
                                <Field id="zone-name" label="Rule name">
                                    <Input
                                        id="zone-name"
                                        value={zone.name}
                                        onChange={(e) =>
                        ...
                        {step === 1 && (
                            <div className="v2-form">
                                <div>
                                    <h3>Shape the proposed boundary</h3>
                                    <p>
                                        This edits a draft for review. It does
                                        not overwrite a shared place boundary.
                                    </p>
                                </div>
                                <div className="v2-inline">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => set('shape', 'polygon')}
                                    >
                                        Custom boundary
                                    </Button>
                                    <span className="micro">
                                        {zone.shape === 'circle'
                                            ? 'Click to move the centre.'
                                            : 'Click to add corners; three or more points.'}
                                    </span>
                                </div>
                                <FictionMap
                                    draw={zone}
                                    ...
                                    onPoint={(p) =>
                                        zone.shape === 'circle'
                                            ? set('centre', p)
                                            : set('points', [...zone.points, p])
                                    }
                                />
                                {zone.shape === 'circle' ? (
                                    <Field
                                        id="zone-radius"
                                        label="Boundary size · illustrative map units"
                                    >
                                        <input
                                            id="zone-radius"
                                            type="range"
                                        ...
                                        />
                                        <span className="micro">
                                            {zone.radius} units · actual metres
                                            require a verified map scale
                                        </span>
                                    </Field>
                                ) : (
                                    <div className="v2-inline">
                                        ...
                                        >
                                            Use sample rectangle
                                        </Button>
                                    </div>
                                )}
                                <Info>
                                    Boundary identity/version and affected uses
                                    must be checked before a real change is
                                    approved.
                                </Info>
                            </div>
                        )}
...
export function LocationWorkspace({
    ...
    const unavailable =
        ...
        scenario === 'empty' ||
        demo === 'offline';
    const uncertain = scenario === 'accuracy' || demo === 'boundary';
    const stale = scenario === 'stale';
    const outside = demo === 'outside';
    const alert = outside || demo === 'arrival' || demo === 'offline';
    ...
    const tabs = [
        ['today', 'Today', MapPin],
        ['zones', 'Zones & schedule', CalendarDays],
        ...
        <div className="v2-workspace">
                ...
                <>
                    ...
                    <div className="v2-main-grid">
                        <Box
                            ...
                            subtitle={`Synthetic Sunday 20 September · view checked ${checked}`}
                            action={
                                <div className="v2-inline">
                                    <Button
                                        size="sm"
                        ...
                        >
                            {unavailable ? (
                                ...
                                <FictionMap
                                    ...
                                    uncertain={uncertain}
                                    accuracyKnown={scenario !== 'accuracy'}
                                    outside={outside}
                                    zoneLayer={layers}
                                />
                            )}
            ...
            {view === 'zones' && (
                <>
                    <div className="v2-section-title">
                        <div>
                            <h3>Agreed zones & schedules</h3>
                            <p>
                                Places can be shared; these purposes and
                                schedules belong to Alex’s plan.
                            </p>
                        </div>
                        {!limited && (
                            <Button
            ...
            {view === 'activity' && (
                <>
                    <div className="v2-section-title">
                        <div>
                            <h3>Observation, plan & response activity</h3>
                            <p>
                                20 September 2026 · NZST (UTC+12) · synthetic
                                event record
                            </p>
                        </div>
                        <label className="v2-demo">
                            ...
                            >
                                ...
                                <option value="planned">Planned events</option>
                    ...
                    <div className="v2-activity">
                            ...
                            (logFilter === 'all' ||
                                ...
                                <div className="v2-event">
                                    ...
                                    <div>
                                        ...
                                        <h4>Jamie recorded an outcome</h4>
                                        <p>{outcome}</p>
                                        <small>
                                            CR-DEMO-19 · preview only ·
                        ...
                        {events
                            .filter(
                                (e) =>
                                    logFilter === 'all' || logFilter === e.type,
                            )
                            .filter(
                    ...
                    {unavailable && (
                        <Info>
                            No device observations are displayed in this
                            unavailable fixture. Plans and recorded staff
                            responses are not substitutes for location evidence.
                        </Info>
                    )}
                    <div className="v2-box-footer">
                        {!limited && (
                        ...
                        <div className="v2-form">
                            ...
                            <p>
                                {unavailable
                                    ...
                                    : `Observed 20 September 2026 · ${stale ? '11:10 am' : '2:32 pm'} NZST (UTC+12) · tracker T-DEMO-08`}
                            </p>
                            <Info>
