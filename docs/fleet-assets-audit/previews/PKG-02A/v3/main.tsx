            ...
            <div className={`layout ${collapsed ? 'collapsed' : ''}`}>
                ...
                <main className="content">
                    ...
                    <PageHeader
                        ...
                        meters={
                            <div className="profile-metrics grid w-full grid-cols-5 gap-2">
                                {[
                                    [
                                        'Next shift',
                                        '3:00 pm',
                            ...
                            <>
                                <div className="section-heading">
                                    <div>
                                        <h2>Location</h2>
                                        <p>
                                            Observed location, agreed zones and
                                            today’s plan for Alex.
                                        </p>
                                    </div>
                                ...
                                {hidden ? (
                                    ...
                                    <LocationWorkspace
                                        ...
                                        checked={checked}
                                        onOpen={open}
                                        onConsents={() => navigate('consents')}
                                        onAccessEnded={() =>
                                            changeScenario('withdrawn')
                                        }
                                    />
                                )}
                            </>
