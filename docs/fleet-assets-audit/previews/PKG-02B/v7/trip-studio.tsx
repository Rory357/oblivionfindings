                    ...
                    <div className="journey-bottom">
                        <section className="studio-card trip-event-list">
                                ...
                                .map((e, i) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <span className="trip-event-location">
                                                <MapPin size={12} />
                                                {journeyLocation(trip, e.point)}
                                            </span>
                                            <small>{e.detail}</small>
                                            <small className="trip-event-coordinates">
                                                {trip.path[e.point].lat.toFixed(
                                                    5,
                                                )}
                                                ,{' '}
                                                {trip.path[e.point].lng.toFixed(
                                                    5,
                                                )}
                                            </small>
                                        </div>
                            ...
                            <p className="studio-footnote">
                                Select an event to show its location on the map.
                                Location names are synthetic examples;
