...
export function VehicleCalendar({
    ...
    const context = {
        ...
        onSelect,
        onContext: onCreate
            ? (e: React.MouseEvent, date: Date, hour?: number) => {
                  e.preventDefault();
                  rightClick.current = null;
    ...
    return (
        ...
        >
            {eventMenu && (
                ...
                >
                    ...
                    <DropdownMenuContent align="start">
                        ...
                        {actionsFor?.(eventMenu.entry.id).map((action) => (
                            <DropdownMenuItem
                                key={action.label}
                                ...
                                onClick={() =>
                                    onCreate(
                                        [
                                            ...
                                            String(navDate.getDate()).padStart(
                                                2,
                                                '0',
                                            ),
                                        ].join('-') + 'T09:00',
            ...
            <div className="calendar-footnote">
                <Lock size={14} />
                <span>
                    Right-click a date/time to request a booking, or an entry
                    for actions. Select an entry to open its source. Reminders
                    and advisory estimates do not reserve the vehicle.
                </span>
            </div>
        </div>
    );
