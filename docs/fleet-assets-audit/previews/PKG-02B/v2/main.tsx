            ...
            <div className={`workspace ${collapsed ? 'collapsed' : ''}`}>
                ...
                <main className="main">
                                ...
                                <>
                                    <div className="subnav-return">
                                        ...
                                        <span className="muted">
                                            Bounded Maintenance destination
                                            preview
                                        </span>
                                    </div>
                                    <div className="content-grid work-grid">
                                        ...
                                        <div className="stack">
                                            <Panel title="Work details">
                                                ...
                                                <Row
                                                    title="Owner"
                                                    value="Kōwhai House Coordinator"
                                                />
                                                <Row
                                                    title="Target"
                                            ...
                                            sub === 'details' && (
                                                ...
                                                >
                                                    ...
                                                    <Notice title="Equipment and capacity are recorded facts">
                                                        A booking still needs to
                                                        match the actual
                                                        passenger, driver and
                                        ...
                                        {view === 'maintenance' && (
                                            ...
                                            >
                                                ...
                                                <Notice title="Work status does not clear a restriction">
                                                    Repair completion,
                                                    authorised release, custody
                                                    and Finance approval are
                                                    separate records.
                                                </Notice>
                                            </Panel>
                                        )}
                    ...
                    <footer className="page-footer">
                        <span>
                            PKG-02B v2 · All people, records, dates and outcomes
                            are synthetic.
                        </span>
