...
export const journeys: Journey[] = [
    {
        id: 'TRIP-DEMO-13',
        locations: [
            'Kōwhai House · Wellington',
            'Wellington city centre · recorded location',
            'Te Aro · recorded location',
            'Newtown · recorded location',
            'Community centre · Wellington',
        ],
        day: '2026-09-22',
        start: '9:00 am',
        end: '9:15 am',
    ...
    },
    {
        ...
        locations: [
            'Kōwhai House · Wellington',
            'Thorndon · Molesworth Street area',
            'Pipitea · Bunny Street area',
            'Wellington Central · Featherston Street area',
            'Community pickup · Lambton Quay area',
        ],
        day: '2026-09-21',
        start: '8:00 am',
        end: '8:12 am',
    ...
    },
    {
        id: 'TRIP-DEMO-11',
        locations: [
            'Community transport stop · Newtown',
            'Mount Cook · recorded location',
            'Te Aro · recorded location',
            'Wellington Central · Willis Street area',
            'Kōwhai House · Wellington',
        ],
        day: '2026-09-20',
        start: '4:40 pm',
...
export const journeyLocation = (trip: Journey, point: number) =>
    trip.locations?.[point] || 'Address unavailable';
