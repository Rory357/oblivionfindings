...
function App() {
    ...
    const [tripPoint, setTripPoint] = useState(0);
    ...
    const uncertain =
        ...
        model.readingStale ||
        !model.odo ||
        model.complianceProblems.length > 0 ||
    ...
    return (
        <TooltipProvider>
            ...
            <div className={`workspace ${collapsed ? 'collapsed' : ''}`}>
                ...
                <main className="main readable-records">
                    ...
                    {denied ? (
                        ...
                        <>
                            <VehicleCalendar
                                ...
                                actionsFor={
                                    calendarActions(model, openWork, nav)
                                        .forEntry
                                }
                                createActions={
                                    calendarActions(model, openWork, nav)
                                ...
                                subline={
                                    work ? (
                                        ...
                                        <>
                                            ...
                                            <br />
                                            {model.data.profile.make}{' '}
                                            {model.data.profile.model} ·{' '}
                                            {model.data.profile.fuel} ·
                                            Community transport
                                        </>
                                    )
                                }
                    ...
                    <footer className="page-footer">
                        <span>
                            PKG-02B v13 · All people, records, dates and
