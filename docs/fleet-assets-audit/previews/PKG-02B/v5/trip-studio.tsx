...
export function TripStudio({
    ...
    const [selected, setSelected] = useState(focusTrip || journeys[1].id),
                ...
                <>
                    ...
                    <div className="journey-workspace">
                        <section className="studio-card journey-map-panel">
                            ...
                            <div className="journey-square-map">
                                <LeafletMap
                                    key={trip.id}
                                    center={trip.path[2]}
                                    height="100%"
                        ...
                        <div className="journey-insights">
                            ...
                            <section className="studio-card trip-speed">
                                ...
                                <p>
                                    Selected sample: {trip.speeds[sample]} km/h.
                                    No road speed limit is inferred.{' '}
                                    {trip.overspeed &&
                    ...
                    <div className="journey-bottom">
                        ...
                        <section className="studio-card trip-next">
                            ...
                            <Button
                                ...
                                onClick={() => m.followup(undefined, trip.id)}
                            >
                                <Clock3 size={16} />
                                Add trip follow-up
                            </Button>
                            ...
                            <details>
                                ...
                                <p>
                                    Example score: 100 − braking×5 −
                                    acceleration×3 − overspeed episodes×8 −
                                    round(idle minutes×0.5). Scores are withheld
                                    below the illustrative 90% coverage gate.
                                    These rules require approval. GPS distance
                                    and paired dashboard observations remain
                                    separate.
                                </p>
                            </details>
                        </section>
