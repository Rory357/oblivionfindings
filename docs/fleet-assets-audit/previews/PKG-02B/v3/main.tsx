...
> = {
    ...
    map: [{ key: 'summary', label: 'Map & observations', icon: MapPin }],
...
function App() {
    ...
    const model = useVehicleModel(scenario, fault);
    ...
    const evidence = [
        ...
        },
        {
            ...
            value: model.nextSchedule
                ? serviceStatus(model.nextSchedule, model.odo).label
                : 'Not scheduled',
            ...
            <div className={`workspace ${collapsed ? 'collapsed' : ''}`}>
                ...
                <main className="main">
                                    ...
                                    <div className="meter-grid">
                                        {(work
                                            ? [
                                                  ...
                                                  [
                                                      'Evidence',
                                                      `${model.data.documents.filter((x) => x.owner === work).length} attached`,
                                        ...
                                        {view === 'map' && (
                                            <div className="stack">
                                                ...
                                                <ObservationHistory
                                                    ...
                                                    onSelect={setObservation}
                                                    onDetail={model.detail}
                                                />
                                            </div>
                                        )}
                                        {view === 'checks' && (
                                                                ...
                                                                if (
                                                                    ...
                                                                    model.detail(
                                                                        ...
                                                                        [
                                                                            ...
                                                                            [
                                                                                'Example questions',
                                                                                'Exterior condition; cabin condition',
                                                                            ],
                                                                            [
                                                                                'Access',
                                                                                'View only · no submission available',
                                                                            ],
                                                                        ],
                                                                    );
                                                                    return;
                    ...
                    <footer className="page-footer">
                        <span>
                            PKG-02B v3 · All people, records, dates and outcomes
                            are synthetic.
                        </span>
