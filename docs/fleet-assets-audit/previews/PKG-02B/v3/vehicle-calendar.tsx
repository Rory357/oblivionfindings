    ...
    return (
        ...
        >
            ...
            <div className="calendar-footnote">
                <Lock size={14} />
                <span>
                    Select an entry to review its source. Use a free date/time
                    or Request booking to start a vehicle request. Reminders and
                    advisory estimates do not reserve the vehicle.
                </span>
            </div>
        </div>
    );
