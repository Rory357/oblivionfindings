# PKG-02B v3 — vehicle profile mockup
...
Open http://127.0.0.1:4338/PKG-02B/v3/#/fleet-assets/vehicles/14/map
...
`C:/Users/steph/.hermes/node/node.exe docs/fleet-assets-audit/previews/PKG-02B/v3/serve.mjs`

The prebuilt bundle is included. The server binds only to 127.0.0.1:4338, accepts GET/HEAD only and disables application API connections. Map images are fetched from OpenStreetMap; no application records or real coordinates are sent. Preview form changes live only in browser memory.

## Validation

See `../../../evidence/PKG-02B/v3/REVISION-REVIEW.md` for browser checks, screenshots and limits. No tracked application or shared-component files were changed. No commit, push or message to Main was made for this revision.
