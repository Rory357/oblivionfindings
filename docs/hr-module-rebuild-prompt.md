...
`design_styles/DESIGN_TOKENS.md`, `design_styles/PAGE_HEADER_STYLE_GUIDE.md`, `design_styles/POPUP_STYLE_GUIDE.md`.
...
5. Page header contract: design_styles/PAGE_HEADER_STYLE_GUIDE.md (supersedes the old PageHero hero). Modal/popup style: design_styles/POPUP_STYLE_GUIDE.md.
