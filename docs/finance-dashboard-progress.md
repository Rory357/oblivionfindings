...
- Next: Phase C (3.1 repoint AR KPI to FinInvoice + AR aging donut/buckets from AccountsReceivableService [truthful source already exists]; 3.2/4.1 re-verify + guard tests; 2.1/2.2 resident-money canonical store [2.2 likely already fixed per audit]). Then un-stub Phase-B AR surfaces.
