...
- [ ] **E6b.** UI: `settings/it-mailbox` page — per-provider connect/disconnect cards, status/account/mailbox/last-poll/last-error, delegated-mailbox field (Microsoft), poll-now. types/build/lint.
