...
- [ ] **S4b.** SLA editor UI: business-hours toggle + open/close + working-day chips + holiday list on the SLA-targets surface; swap the "runs 24/7" copy when a calendar is on. types/build/lint.
