...
- [ ] **S7b.** Merge UI: a "Merge" workspace action → duplicate-search dialog (client-filter `mergeTargets`) posting `it.tickets.merge`; a "Merged into TCK-…" banner on a merged source. types/build/lint.
