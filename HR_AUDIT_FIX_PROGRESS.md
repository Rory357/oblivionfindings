...
- **Run 6 (2026-07-08)** — Slice 6 (Calendar hub) audited + fixed: invite notifications (the RSVP feature was unreachable — invitees were never told), organiser RSVP notification, attachment-file cleanup on event delete, attachment audit trait. `/hr/calendar/time-off` seed route confirmed stale.
