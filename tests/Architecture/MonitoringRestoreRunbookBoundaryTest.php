...
it('keeps the executable restore verifier aligned with the value-free reconciliation contract', function (): void {
    ...
    expect($probe)
        ...
        ->toContain("MONITORING_RESTORE_RUNTIME_COMMITMENT_SHA256', \$releaseAuthority.restored_runtime_commitment_sha256")
        ...
        ->toContain('$postPublicationReleaseRevision = Get-ReleaseRevision')
        ->toContain('$postPublicationReleaseAuthority = Get-RestoreReleaseAuthority')
        ->toContain('$releaseAuthority.authority_sha256,')
        ->toContain('$postPublicationReleaseAuthority.authority_sha256,')
        ->toContain('The protected release identity changed during restore evidence publication.')
        ...
        ->toContain('Restore process configuration changed before evidence publication.')
        ...
        ->toContain("'backup_manifest_sha256'", "'restored_runtime_commitment_sha256'")
        ->and($authorityScript)
        ...
        ->toContain('runtimeCommitmentMatches()')
        ->toContain("getenv('MONITORING_RESTORE_RUNTIME_COMMITMENT_SHA256')")
        ->toContain("'database_url_sha256'")
        ->toContain("'snapshot_endpoint_sha256'")
