...
it('keeps local synthetic monitoring performance artifacts ineligible for V09 closure', function (): void {
    ...
    expect($script)->toContain(
        ...
        '$releaseCheckoutVerifier->verify($root,',
        '@chmod($path, 0600)',
        ...
        '$publishedRemainsExact($artifactPath, $encoded, $releaseProvenance)',
    ...
    expect($verifier)->toContain(
        ...
        "'supervisor_observation_generation'",
        "'sample_count'",
        'measurementReferencesAreDistinct',
    ...
    expect($runbook)->toContain(
        ...
        'validity window is positive and no longer than 24 hours',
        ...
        'Each interval and the recovery observation must use',
        'a distinct `observation_sha256`',
