    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'strict' => true,
            'engine' => null,
            // App runs in UTC (config/app.php); without this the MySQL session
            // uses the host's timezone, and TIMESTAMP inserts whose UTC value
            // falls inside a local DST spring-forward gap fail with error 1292.
