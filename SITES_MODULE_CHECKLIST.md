# Sites/Locations Module - Implementation Checklist

> Based on comprehensive gap analysis of existing codebase vs. requirements spec
> Last updated: 2026-02-08

---

## 🔴 CRITICAL (MVP Blockers) - Fix These First
...
### 21. Fix Setup Completeness Logic Bug
**File:** `app/Http/Controllers/SiteController.php`
- [ ] **BUG:** Checklist shows "Primary contact phone recorded" as complete but Contact Information shows "—"
- [ ] Diagnose: Checklist checks `onboarding_progress['basic']['completed']` OR `$site->phone`
- [ ] Issue: Onboarding wizard marks basic step complete but phone field is empty
- [ ] Fix: Only mark checklist item complete if actual data exists, not just onboarding step completion
- [ ] Update checklist logic for: phone, email, emergency_plan_location, medication_storage_location
- [ ] OR ensure onboarding wizard actually saves the phone/email data to the site

### 22. Make Setup Completeness Collapsible
**File:** `resources/js/pages/sites/show.tsx`
...
### Week 2: Core Views
4. Global Calendar (Critical #3)
5. Global Hazards (Critical #4)
6. Checklist Run UI (Critical #5)

### Week 3: Type-Specific Features
7. Room Management (High #8)
8. Resource Management (High #9)
9. Zone Management (High #10)
10. Assets Onboarding Step (High #7)

### Week 4: Management & Reporting
11. Checklist Template UI (Medium #11)
12. Inspection Scheduling (Medium #12)
13. Site Reporting (High #6)

### Week 5: Polish
14. Site Asset Register (Medium #13)
15. Shifts Tab (Medium #14)
16. Testing & Bug Fixes

---

*Use this checklist to track progress. Check off items as they are completed and tested.*
