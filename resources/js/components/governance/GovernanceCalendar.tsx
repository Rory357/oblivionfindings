...
function monthDays(
    year: number,
    month: number,
): Array<{ day: number; date: string; inMonth: boolean }> {
    ...
    for (let i = startWeekday - 1; i >= 0; i--) {
        ...
        cells.push({
            day: d,
            date: dateString(prevYear, prevMonth, d),
            inMonth: false,
        });
    }
    // Current month
    ...
    while (cells.length % 7 !== 0) {
        ...
        cells.push({
            day: d,
            date: dateString(nextYear, nextMonth, d),
            inMonth: false,
        });
    }
    return cells;
    ...
    return (
        <Card data-dusk="cockpit-calendar">
            <CardHeader className="pb-3">
                <div className="flex items-start justify-between gap-2">
                    <div>
                        ...
                        <CardDescription>
                            Meetings, compliance due dates and policy reviews.
                        </CardDescription>
                    </div>
                    <Link
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-7 gap-1 text-center text-[10px] font-medium tracking-wide text-muted-foreground uppercase">
                ...
                <div className="flex flex-wrap items-center gap-3 text-[10px] tracking-wide text-muted-foreground uppercase">
