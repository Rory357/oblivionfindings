...
export function AlertWorklistRow({
    ...
    actions: readonly ControlRoomRowAction[];
}) {
    ...
    return (
        ...
        >
            {({ rowProps, overflowButton }) => (
                <div
                    data-testid="alert-worklist-row"
                    className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-3 border-b border-border px-4 py-4 last:border-b-0 hover:bg-muted/25 md:grid-cols-[2.5rem_minmax(0,2fr)_minmax(14rem,1fr)_minmax(12rem,0.8fr)_auto] md:items-center md:gap-4"
                    {...rowProps}
                >
                    <Checkbox
                    ...
                    <div className="col-start-2 space-y-2 md:col-start-3">
                        <AlertStatus
                            status={row.status}
                    ...
                    <div className="col-start-2 space-y-2 text-xs md:col-start-4">
                        {row.playbook ? (
