...
export default function InsulinAdminFields({ form, errors, onChange }: Props) {
    return (
        <div className="space-y-3 rounded-md border border-blue-200 bg-blue-50/50 p-3">
            <div className="text-sm font-medium text-blue-800">Insulin Administration</div>
            ...
            <div>
                ...
                {errors.blood_glucose_level && (
                    <p className="mt-1 text-xs text-red-600">{errors.blood_glucose_level}</p>
                )}
            </div>
            ...
            <div>
                ...
                {errors.insulin_units_given && (
                    <p className="mt-1 text-xs text-red-600">{errors.insulin_units_given}</p>
                )}
            </div>
