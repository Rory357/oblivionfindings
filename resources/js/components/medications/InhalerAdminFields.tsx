    ...
    return (
        <div className="space-y-3 rounded-md border border-primary bg-primary/10 p-3">
            ...
            <div className="flex items-center space-x-2">
                ...
                />
                <Label
                    htmlFor="inhaler_technique_observed"
            ...
            <div className="flex items-center space-x-2">
                <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                        onChange('spacer_used', checked ? true : false)
                    }
                />
            ...
            <div>
                <Label htmlFor="peak_flow_before">
                    Peak flow before (L/min)
                </Label>
                <Input
                    id="peak_flow_before"
                    type="number"
                    ...
                    onChange={(e) =>
                        onChange('peak_flow_before', e.target.value || null)
                    }
            ...
            <div>
                ...
                <Input
                    ...
                    onChange={(e) =>
                        onChange('peak_flow_after', e.target.value || null)
                    }
                    placeholder="Optional"
                />
