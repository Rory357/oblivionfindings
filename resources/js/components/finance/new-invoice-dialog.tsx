...
export function NewInvoiceDialog({
    ...
    const submit = () => {
        form.transform((d) => ({
            ...
            funding_body:
                d.bill_to === 'funder' ? d.funding_body || null : null,
    ...
    return (
        <WizardShell
            ...
            description={
                isEdit
                    ? 'Update this draft AR invoice'
                    : 'Create a draft AR invoice'
            }
            railIcon={Receipt}
            ...
            {index === 0 && (
                <div>
                    <StepHead
                        ...
                        blurb="Who is being billed, and the key dates."
                    />
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <Field label="Bill to" span>
                            <Segmented
                                value={data.bill_to}
                                onChange={(v) =>
                                    setData('bill_to', v as 'client' | 'funder')
                                }
                                options={[
            ...
            {index === 1 && (
                <div>
                    <StepHead
                        icon={Receipt}
                        title="Line items"
                        blurb="Each line is billed net; GST is added per line."
                    />
            ...
            {index === 2 && (
                <div>
                    <StepHead
                        ...
                        blurb={
                            isEdit
                                ? 'Updates this draft invoice.'
                                : 'Creates a draft invoice you can then send.'
                        }
                    />
                    <ReviewCard icon={FileText} title="Invoice">
                        <ReviewRow label="Bill to" value={billToName} />
                        {data.bill_to === 'funder' && data.funding_body && (
                            <ReviewRow
                                label="Funding body"
                                value={data.funding_body}
                            />
