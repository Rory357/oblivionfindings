...
const STEPS: readonly WizardStep[] = [
    {
        key: 'basics',
        label: 'Basics',
        blurb: 'Role, site type & status',
        icon: Settings2,
    },
    {
        key: 'tasks',
        label: 'Tasks',
        blurb: 'Build the task set',
        icon: ListChecks,
    },
    {
        key: 'review',
...
export function TemplateDialog({
    ...
    const addTask = () =>
        form.setData('tasks', [
            ...form.data.tasks,
            blankTask(form.data.tasks.length + 1),
        ]);
        ...
        form.transform((data) => ({
            ...
            tasks: data.tasks
                .map((t, i) => ({
                    ...
                    course_code:
                        t.category === 'induction'
                            ? t.course_code?.trim() || null
                            : null,
                }))
                .filter((t) => t.title !== ''),
        }));
        ...
        <WizardShell
            ...
            success={
                    ...
                    <WizardSuccessPane
                        ...
                        blurb={
                            <>
                                The {prettyLabel(form.data.role)} template with{' '}
                                {validTasks.length}{' '}
                                {validTasks.length === 1 ? 'task' : 'tasks'} is
                                saved and will auto-match when you start an
                                onboarding.
                            </>
                        }
            ...
            {wizard.index === 0 && (
                <WizardStepPane>
                    ...
                    <div className="grid gap-3.5 sm:grid-cols-2">
                        ...
                        <Field
                            label="Status"
                            hint="inactive templates are never auto-matched"
                        >
                            <Segmented
                                value={
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <SelectInput
                                            ...
                                            options={[
                                                {
                                                    value: NO_COURSE,
                                                    label: 'Mandatory courses (default)',
                                                },
                                                ...courseOptions.map((c) => ({
                                                    value: c.code,
                ...
                <WizardStepPane>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                        ...
                        >
                            <ReviewRow
                                label="Role"
                                value={prettyLabel(form.data.role)}
                            />
                            <ReviewRow
                                label="Site type"
                                value={prettyLabel(form.data.site_type)}
                            />
                            <ReviewRow
                                label="Status"
                                value={
