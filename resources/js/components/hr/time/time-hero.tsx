    ...
    return (
        ...
        >
            ...
            <div className="relative flex flex-wrap items-stretch">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="mt-1.5 text-[13px] font-medium text-primary-foreground/75">
                                Review team time, fix exceptions and keep{' '}
                                {teamName} payroll-ready
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex w-full flex-none flex-col border-t border-primary-foreground/15 bg-black/[0.08] p-[20px_22px] sm:w-[332px] sm:border-t-0 sm:border-l">
                                ...
                                onNow.slice(0, 5).map((p) => (
                                    ...
                                    >
                                        <span className="relative grid h-[30px] w-[30px] flex-none place-items-center rounded-full bg-primary-foreground/[0.18] text-[11px] font-bold">
                                            {p.initials}
                                            <span className="absolute -right-px -bottom-px h-2 w-2 rounded-full bg-[color:var(--hr-amber)] ring-2 ring-[color:color-mix(in_oklch,var(--primary)_60%,black)]" />
                                        </span>
                                        <span className="min-w-0 flex-1 truncate text-[12.5px] font-semibold">
                                            {p.name}
                                        </span>
                                        <span className="text-[11px] font-bold text-primary-foreground/85 tabular-nums">
                        ...
                        <>
                            <div className="mt-2 flex h-[120px] items-end gap-2">
                                {weekly.map((d) => (
                                    ...
                                    >
                                        <span className="text-[9.5px] font-semibold text-primary-foreground/70 tabular-nums">
                                            {d.hours > 0 ? d.hours : ''}
                                        </span>
                                        <div
                            ...
                            <div className="mt-2 text-[11.5px] text-primary-foreground/70">
                                {kpi.team_hours_week}h logged ·{' '}
                                {kpi.avg_hours_per_day}h avg/day
                            </div>
                        </>
                    )}
                </div>
        ...
        >
            <div className="relative flex flex-wrap items-center gap-6 p-[26px_32px]">
                ...
                <div className="flex items-center gap-6">
                    <div>
                        <div className="text-[10px] font-bold tracking-[0.09em] text-primary-foreground/60 uppercase">
            ...
            <div className="relative border-t border-primary-foreground/[0.14] bg-black/[0.08] px-8 py-3 text-[12px] text-primary-foreground/[0.78]">
                You&apos;re seeing the read-only view. Team review, corrections
                and approvals are for team leaders &amp; admins.
            </div>
        </div>
    );
}
