...
export default function SecuritySettings({
    ...
    const form = useForm({
        ...
        password_require_uppercase: toBoolean(
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid gap-6 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        How often users must change their
                                        password
                                    </p>
                                </div>
                            </div>
                        ...
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <CardDescription>
                                        Control session timeouts and login
                                        behaviour
                                    </CardDescription>
                                </div>
                            </div>
                        ...
                        <CardContent>
                            <div className="grid gap-6 sm:grid-cols-3">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            form.data.session_timeout_minutes
                                        }
                                        onValueChange={(val) =>
                                            form.setData(
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Inactive users will be logged out after
                                        this period
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            form.data.lockout_duration_minutes
                                        }
                                        onValueChange={(val) =>
                                            form.setData(
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between rounded-lg border p-4">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        When enabled, all users will be required
                                        to set up two-factor authentication on
                                        their next login.
                                    </p>
                                    {form.data.force_2fa && (
                                        <div className="mt-2 flex items-center gap-2 text-xs text-status-warning">
                                            ...
                                            <span>
                                                Users without 2FA will be
                                                prompted to set it up
                                                immediately.
                                            </span>
                                        </div>
                                    )}
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) =>
                                        form.setData('force_2fa', checked)
                                    }
                                />
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                >
                                    ...
                                    {twoFaEnabled} of {twoFaTotal} users have
                                    2FA enabled
                                </Badge>
                            </div>
                        </CardContent>
