        ...
        <div className="flex flex-col items-center gap-3">
            <div className="relative">
                <div
                    ...
                    style={{
                        backgroundColor: showColorPicker ? value : '#cbd5e1',
                    }}
                />
                <input
                    type="color"
...
export default function BrandingPage(props: Props) {
    ...
    const form = useForm<{
        ...
        branding: {
            ...
            email_header_colour: (
                props.branding?.email_header_colour ?? ''
            ).toString(),
            email_footer_text: (
                props.branding?.email_footer_text ?? ''
            ).toString(),
            report_logo_position: (
                props.branding?.report_logo_position ?? 'left'
            ).toString(),
            report_font: (props.branding?.report_font ?? 'default').toString(),
            report_include_company_details:
                props.branding?.report_include_company_details ?? true,
        },
        theme: {
    ...
    const terminologyInitial = useMemo(() => {
        return Object.fromEntries(
            ALL_KEYS.map((k) => [
                k,
                (
                    props.terminology?.overrides?.[k] ??
                    props.terminology?.defaults?.[k] ??
                    ''
                ).toString(),
            ]),
        );
    ...
    const [brandHex, setBrandHex] = useState<string>(
        /^#[0-9a-fA-F]{6}$/.test(essentialInitial)
            ? essentialInitial
            : DEFAULT_BRAND_HEX,
    );
    ...
    const initialRadius = (
        form.data.theme.light['--radius'] ?? '0.75rem'
    ).toString();
    ...
    const handleBrandChange = useCallback(
        (hex: string) => {
            ...
            const nextDark = { ...form.data.theme.dark, ...palette } as Record<
                string,
                string
            >;
            ...
            <SettingsLayout>
                <div className="space-y-8">
                    ...
                    <Tabs defaultValue="essentials" className="space-y-6">
                        ...
                        <TabsContent value="essentials" className="space-y-8">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Your organisation's name, logo, and
                                        tagline
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="grid gap-6 lg:grid-cols-2">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="branding_tagline">
                                                    Tagline
                                                </Label>
                                                <Input
                                                    id="branding_tagline"
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    Displayed under the company
                                                    name in the sidebar.
                                                </p>
                                            </div>
                                            <div className="space-y-2">
                                                <Label htmlFor="branding_report_subtitle">
                                                    Report Subtitle
                                                </Label>
                                                <Input
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Pick one brand colour — the rest of the
                                ...
                                <CardContent className="space-y-6">
                                    <div className="space-y-3">
                                        ...
                                        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-5">
                                            {Object.entries(BRAND_PRESETS).map(
                                                ([key, preset]) => {
                                                    const selected =
                                    ...
                                    <div className="grid gap-8 lg:grid-cols-2">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="brand_radius">
                                                Corner radius — {radiusPx}px
                                            </Label>
                                            <input
                                                id="brand_radius"
                                                type="range"
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div
                                                    className="h-10 w-full border bg-primary/10"
                                                    style={{
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Controls the rounding of cards,
                                                buttons, and inputs.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        ...
                                        in emails and exported documents
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="grid gap-6 lg:grid-cols-2">
                                        ...
                                        <div className="space-y-4">
                                            <div className="space-y-2">
                                                <Label htmlFor="email_header_colour">
                                                    Email Header Colour
                                                </Label>
                                                <div className="flex items-center gap-3">
                                                    <div className="relative">
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="email_footer_text">
                                                    Email Footer Text
                                                </Label>
                                                <Textarea
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center gap-3 pt-2">
                                                ...
                                                />
                                                <Label
                                                    htmlFor="report_company_details"
                                                    className="text-sm"
                                                >
                                                    Include company details in
                                                    report footer
                                                </Label>
                                            </div>
                                        </div>
                        ...
                        <TabsContent value="terminology" className="space-y-8">
                            <Card>
                                <CardHeader>
                                    <CardTitle>Terminology</CardTitle>
                                    <CardDescription>
                                        Customise the language used across the
                                        application to match your organisation
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <form
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Changes will be reflected across all
                                            modules immediately.
                                        </p>
                                    </form>
                                </CardContent>
