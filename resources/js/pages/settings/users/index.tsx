...
export default function UsersIndex({
    ...
    function handleExportCsv() {
        ...
        const rows = allData.map((u) => [
            ...
            u.last_login_at
                ? new Date(u.last_login_at).toLocaleDateString('en-NZ')
                : 'Never',
            u.session_count ?? 0,
