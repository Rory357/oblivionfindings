    ...
    return (
        <AppLayout>
            ...
            <PageHero
                variant="compact"
                title={feature}
                description="This feature is part of the eMAR module."
                backHref="/emar"
            />
            <PageShell>
                <Card>
                    <CardContent className="flex flex-col items-center justify-center py-16">
                        ...
                        <p className="mt-1 max-w-sm text-center text-sm text-muted-foreground/80">
                            The <strong>{feature}</strong> feature is being
                            developed as part of the eMAR module. This will
                            provide comprehensive electronic medication
