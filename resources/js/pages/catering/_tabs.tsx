...
import { ChefHat, LayoutDashboard, Package, ShieldAlert } from 'lucide-react';
import { useEffect, useState, type ComponentType } from 'react';

export type CateringTabKey = 'overview' | 'recipes' | 'products' | 'tags';
...
const TABS: Tab[] = [
    { key: 'overview', label: 'Overview', href: '/catering', icon: LayoutDashboard, description: 'Cross-site dashboard' },
