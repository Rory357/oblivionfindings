...
export default function CateringProductsIndex({
    products,
    categories,
    tags,
    filters,
    ...
    function applyFilters() {
        router.get(
            '/catering/products',
            { q: search || undefined, category: category || undefined },
    ...
    function openEdit(p: Product) {
        ...
        setCostDollars(
            p.cost_per_unit_cents != null
                ? (p.cost_per_unit_cents / 100).toString()
                : '',
        );
        setEditing(p);
    }
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Products', href: '/catering/products' },
            ]}
        >
