...
export default function CateringRecipesIndex({
    recipes,
    filters,
    canManage,
}: Props) {
    ...
    function applyFilters(nextDrafts = showDrafts) {
        router.get(
            '/catering/recipes',
            { q: search || undefined, inactive: nextDrafts ? 1 : undefined },
                                        ...
                                        {filters.q ? (
                                            ...
                                            <div className="flex flex-col items-center gap-2">
                                                ...
                                                <span className="text-xs">
                                                    Build your first recipe, or
                                                    activate a draft from the
                                                    shared library.
                                                </span>
                                                {canManage && (
                                    ...
                                    <TableCell>
                                        <div className="flex gap-1">
                                            ...
                                            {canManage && (
                                                ...
                                                >
                                                    <Link
                                                        href={`/catering/recipes/${r.id}/edit`}
                                                    >
