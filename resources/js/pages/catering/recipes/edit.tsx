...
export default function CateringRecipeEdit({ recipe, tags, products }: Props) {
    ...
    function updateIngredient(idx: number, patch: Partial<RecipeIngredient>) {
        const next = form.data.ingredients.map((row, i) =>
            i === idx ? { ...row, ...patch } : row,
        );
        form.setData('ingredients', next);
    }
    ...
    function removeIngredient(idx: number) {
        form.setData(
            'ingredients',
            form.data.ingredients.filter((_, i) => i !== idx),
        );
    }
    ...
    function cancel() {
        router.visit(
            isNew ? '/catering/recipes' : `/catering/recipes/${recipe!.id}`,
        );
    }
        ...
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Recipes', href: '/catering/recipes' },
                {
                    ...
                    href: isNew
                        ? '/catering/recipes/create'
                        : `/catering/recipes/${recipe!.id}/edit`,
                },
            ]}
        >
                    ...
                    <div className="space-y-4 rounded-md border p-4 lg:col-span-2">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <Input
                                    type="number"
                                    min={1}
                                    value={form.data.serves_default}
                                    onChange={(e) =>
                                        form.setData(
                                            'serves_default',
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Label htmlFor="is_active">
                                Active (available in meal planner)
                            </Label>
                        </div>
                    </div>
                ...
                <div className="rounded-md border p-4">
                    ...
                    <div className="mb-3">
                        <Input
                            ...
                            placeholder="Search products (filter the dropdown below)"
                        />
                    </div>
