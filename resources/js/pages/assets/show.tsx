                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        ...
                                        <CardContent className="space-y-2 text-sm">
                                            ...
                                            {a.notes ? (
                                                <div className="pt-2">
                                                    ...
                                                    <div className="mt-1 rounded-md border p-2 text-sm whitespace-pre-wrap">
                                                        {a.notes}
                                                    </div>
                                                </div>
                                            ) : null}
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-3">
                                            {a.qr_png_url ? (
                                                <article className="flex items-center justify-center rounded-md border bg-white p-4">
                                                    <img
                                                        src={a.qr_png_url}
                                                        alt="Asset QR"
                                                        className="h-56 w-56"
                                                        ...
                                                        <div className="flex shrink-0 items-center gap-2">
                                                            ...
                                                            {can?.manageDocuments ? (
                                                                <Button
                                                                    ...
                                                                    variant="link"
                                                                    size="sm"
                                                                    className="h-auto p-0 text-sm text-status-critical"
                                                                    onClick={() => {
                                                                        if (
                                                                            !confirm(
                            ...
                            content: (
                                <div className="space-y-4">
                                                    ...
                                                    >
                                                        ...
                                                        t.status ===
                                                            ...
                                                            <Button
                                                                ...
                                                                onClick={() =>
                                                                    router.post(
                                                                        `/assets/${a.id}/trackers/${t.id}/unpair`,
                                                                        {},
                                                                        {
                                                                            preserveScroll: true,
                                                                        },
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-2">
                                            <div className="text-xs text-muted-foreground">
                                                These legacy alert records are
                                                retained for history only.
                                                Active operational alerts now
                                                live in Fleet Alerts and Control
                                                Room.
                                            </div>
