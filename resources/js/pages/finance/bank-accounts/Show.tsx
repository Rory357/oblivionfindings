                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            ...
                            <p
                                className={`mt-1 font-mono text-2xl font-semibold tabular-nums ${bankAccount.current_balance >= 0 ? 'text-status-success' : 'text-status-critical'}`}
                            >
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Link
                                    href={`/finance/bank-reconciliation/create?bank_account_id=${bankAccount.id}`}
                                >
                                    <Button size="sm">
                        ...
                        {transactions.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <p className="text-muted-foreground">
                                    Import a CSV file or add transactions
                                    manually.
                                </p>
                            </div>
                        ) : (
                                ...
                                <TableBody>
                                    {transactions.map((txn) => (
                                        <TableRow key={txn.id}>
                                            ...
                                            <TableCell
                                                className={`text-right font-mono tabular-nums ${txn.amount >= 0 ? 'text-status-success' : 'text-status-critical'}`}
                                            >
