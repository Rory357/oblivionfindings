...
export default function PurchaseOrderCreate() {
    const { vendors, accounts, costCentres, fundingStreams } = usePage()
        .props as any;
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <Card>
                        ...
                        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="space-y-1">
                                ...
                                <Select
                                    value={data.cost_centre_id || 'none'}
                                    onValueChange={(v) =>
                                        setData(
                                            'cost_centre_id',
                                            v === 'none' ? '' : v,
                            ...
                            <div className="space-y-1">
                                ...
                                <Select
                                    value={data.funding_stream_id || 'none'}
                                    onValueChange={(v) =>
                                        setData(
                                            'funding_stream_id',
                                            v === 'none' ? '' : v,
                    ...
                    <div className="flex justify-end gap-2">
                        <Button
                            ...
                            variant="outline"
                            onClick={() =>
                                router.get('/finance/purchase-orders')
                            }
                        >
                            Cancel
                        </Button>
