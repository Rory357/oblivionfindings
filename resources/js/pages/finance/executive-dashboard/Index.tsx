...
export default function ExecutiveFinancialDashboard({
    ...
    const overBudgetCount = insights.filter(
        (i) => i.type === 'over_budget',
    ).length;
                    ...
                    <PageHero
                        ...
                        stats={[
                            ...
                            },
                            {
                                ...
                                tone:
                                    overBudgetCount > 0 ? 'warning' : undefined,
                            },
                            {
                                label: 'Staffing cost',
                                        ...
                                        {siteSummaries.sites
                                            ...
                                            .map((site) => (
                                                <TableRow key={site.site_id}>
                                                    <TableCell>
                                                        <Link
                                                            href={`/finance/sites/${site.site_id}/financial-dashboard`}
                        ...
                        <CardContent>
                            {client_kpis.top_outliers.length > 0 ? (
                                <Table>
                                    ...
                                    <TableBody>
                                        {client_kpis.top_outliers
                                            .slice(0, 10)
                                            .map((c) => (
                                                <TableRow key={c.client_id}>
                                                    <TableCell>
                                                        <Link
                                                            href={`/finance/clients/${c.client_id}/financials`}
                                                            className="font-medium text-primary hover:underline"
                                                        >
                                                            {c.client_name}
                                                        </Link>
                                                    ...
                                                    <TableCell
                                                        className={`text-right tabular-nums ${Number(c.weekly_gap) > 0 ? 'text-status-critical' : ''}`}
                                                    >
                                                        {$(c.weekly_gap)}
                                                    </TableCell>
                                                </TableRow>
