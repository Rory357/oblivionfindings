                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    {errors.filing_frequency && (
                                        <p className="text-sm text-destructive">{errors.filing_frequency}</p>
                                    )}
                                </div>

                                <div className="space-y-2">
                                    <Label htmlFor="basis">Accounting Basis</Label>
                                    <Select
                                        value={data.basis}
                                        onValueChange={(v) => setData('basis', v)}
                                    >
                                        <SelectTrigger>
                                    ...
                                    {errors.basis && (
                                        <p className="text-sm text-destructive">{errors.basis}</p>
                                    )}
                                </div>
                            </div>
                        ...
                        <Card>
                            <CardHeader>
                                <div className="flex items-center gap-2">
                                    ...
                                    <CardTitle>
                                        {currentYear} Filing Calendar ({frequencyLabels[selectedFrequency]})
                                    </CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <table className="w-full text-sm">
                                        <thead>
                                            <tr className="border-b text-left text-muted-foreground">
                                                ...
                                                <th className="pb-3 pr-4 font-medium">IRD Period</th>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <td className="py-3 pr-4">
                                                            {formatDate(period.period_start)} &ndash;{' '}
