                    ...
                    <Card className="space-y-3 border-primary/20 p-4">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            <div className="text-sm">
                                ...
                                {selectedIds.length} of {timesheets.data.length}
                            </div>
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                            ...
                            <div className="space-y-1">
                                <Label className="text-xs text-muted-foreground">
                                    Return notes (required when returning)
                                </Label>
                                <Textarea
                                    rows={3}
                                    value={returnedNotes}
                                        ...
                                        >
                                            ...
                                            <td className="p-3">
                                                ...
                                                {t.is_residential_billable ? (
                                                    <Badge
                                                        variant="outline"
                                                        className="mt-1 border-status-success/30 bg-status-success text-[10px] text-status-success"
                                                    >
