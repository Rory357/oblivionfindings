...
export default function AssetConditionReport({
    conditionGroups,
    sites,
    filters,
    summary,
    ...
    const applyFilters = () => {
        ...
        router.get('/sites/reports/asset-condition', params, {
            preserveState: true,
        });
    };
        ...
        <AppLayout
            breadcrumbs={[
                { title: 'Reports', href: '/sites/reports' },
                {
                    ...
                    href: '/sites/reports/asset-condition',
                },
            ]}
        >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex gap-2">
                                        {group.warranty_expired > 0 && (
                                            ...
                                            >
                                                {group.warranty_expired} expired
                                                warranty
                                            </Badge>
                                        )}
