...
export function HsDetailDialog({
    detail,
    onClose,
}: {
    detail: HsDetail;
                ...
                <>
                    {detail.registerUrl ? (
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => router.visit(detail.registerUrl!)}
                        >
                            <ExternalLink className="h-4 w-4" />{' '}
                            {detail.registerLabel ?? 'View register'}
                        </Button>
                    ) : null}
                    {detail.clientId ? (
                        <Button
                            ...
                            variant="ghost"
                            onClick={() =>
                                router.visit(`/clients/${detail.clientId}`)
                            }
                        >
                    ...
                    {detail.staffId ? (
                        <Button
                            ...
                            variant="ghost"
                            onClick={() =>
                                router.visit(`/staff/${detail.staffId}`)
                            }
                        >
