    ...
    return (
        <div className="flex items-start gap-3 rounded-2xl border border-status-warning/35 bg-status-warning-bg px-4 py-3 text-status-warning">
            ...
            <p className="text-sm leading-6">
                <strong>Orphan categories shown below as "unwired":</strong> these were defined in HsEvent before a source observer existed. Each appears here so the convergence view is complete; until an event is created from its source module it has no originating record to link back to.
            </p>
        </div>
    );
}
