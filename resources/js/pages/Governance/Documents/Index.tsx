...
import { Download, FileIcon, FolderOpen, Upload } from 'lucide-react';
                        ...
                        <Card key={doc.id}>
                            <CardContent className="flex items-center justify-between p-4">
                                <div className="flex items-center gap-3">
                                    <FileIcon className="h-5 w-5 text-status-info" />
                                    <div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            {doc.is_confidential && (
                                                <Badge className="bg-status-critical-bg text-xs text-status-critical">
                                                    Confidential
                                                </Badge>
                                            )}
                                        </div>
