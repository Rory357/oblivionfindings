  ...
  return (
    <AppLayout>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Create Governance Policy</h1>
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="effective_date" type="date" value={data.effective_date} onChange={e => setData('effective_date', e.target.value)} />
                </div>
                <div>
              ...
              <div className="flex justify-end gap-3">
                ...
                <Button type="submit" disabled={processing}>Create Policy</Button>
              </div>
            </CardContent>
          </Card>
        </form>
