                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Input type="number" min={1} max={5} value={data.likelihood_score} onChange={(e) => setData('likelihood_score', parseInt(e.target.value))} />
                                </div>
                                <div>
                                    <Label>Impact (1-5)</Label>
                                    <Input type="number" min={1} max={5} value={data.impact_score} onChange={(e) => setData('impact_score', parseInt(e.target.value))} />
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="flex gap-2 pt-4">
                                <Button type="submit" disabled={processing}>Update Risk</Button>
