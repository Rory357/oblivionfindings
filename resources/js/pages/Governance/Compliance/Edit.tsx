...
export default function EditCompliance({ auth, obligation }: { auth: any; obligation: Obligation }) {
    ...
    return (
        <AppLayout
            ...
            breadcrumbs={[
                ...
                { title: obligation.obligation_title, href: `/governance/compliance/${obligation.id}` },
                { title: 'Edit', href: `/governance/compliance/${obligation.id}/edit` },
            ]}
        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <Select value={data.framework} onValueChange={(v) => setData('framework', v)}>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="charities">Charities Services</SelectItem>
                                        <SelectItem value="nga_paerewa">Nga Paerewa NZS 8134:2021</SelectItem>
                                        <SelectItem value="health_disability_act">Health & Disability Services Act</SelectItem>
                                        <SelectItem value="privacy_act">Privacy Act 2020</SelectItem>
                                        <SelectItem value="hswa">HSWA 2015</SelectItem>
                                        <SelectItem value="employment">Employment</SelectItem>
                                        <SelectItem value="funding">Funding/Contract</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Select value={data.review_frequency} onValueChange={(v) => setData('review_frequency', v)}>
                                        <SelectTrigger><SelectValue /></SelectTrigger>
                                        <SelectContent>
                            ...
                            <div className="flex gap-2 pt-4">
                                <Button type="submit" disabled={processing}>Update Obligation</Button>
