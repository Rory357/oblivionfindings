...
import {
    calendar as complianceCalendar,
    create as createCompliance,
    show as showCompliance,
        ...
        >
            ...
            >
                ...
                <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {Object.entries(summary.by_framework).map(
                        ([framework, data]) => {
