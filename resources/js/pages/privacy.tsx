                    ...
                    <div className="space-y-10">
                        <section>
                            ...
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                ...
                                you use our platform, website, and services
                                (collectively, the "Services").
                            </p>
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                We are registered with the Office of the Privacy
                                Commissioner (OPC) and comply with the Privacy
                                Act 2020 and the Health Information Privacy Code
                                2020.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-2 text-muted-foreground">
                                <li>
                                    ...
                                    organisation details when you register.
                                </li>
                                <li>
                                    <strong>Resident Data:</strong> Names, dates
                                    of birth, medical information, care plans,
                                    and support records entered by your
                                    organisation.
                                </li>
                                <li>
                                    <strong>Staff Data:</strong> Employment
                                    details, qualifications, training records,
                                    and shift information.
                                </li>
                                <li>
                                    <strong>Communication Data:</strong>{' '}
                                    Messages, emails, and support requests you
                                    send us.
                                </li>
                            </ul>
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-2 text-muted-foreground">
                                ...
                                <li>
                                    ...
                                    when using mobile check-in features (with
                                    your consent).
                                </li>
                                <li>
                                    <strong>Cookies:</strong> Information
                        ...
                        <section>
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-2 text-muted-foreground">
                                <li>
                                    <strong>Contract:</strong> Processing
                                    necessary for the performance of our
                                    contract with you.
                                </li>
                                <li>
                                    <strong>Legal Obligation:</strong>{' '}
                                    Processing necessary to comply with our
                                    legal obligations (e.g., HealthCERT and Ngā
                                    Paerewa requirements).
                                </li>
                                <li>
                                    <strong>Legitimate Interests:</strong>{' '}
                                    Processing necessary for our legitimate
                                    interests, provided your rights don't
                                    override these.
                                </li>
                                <li>
                                    <strong>Consent:</strong> Where you have
                                    given us explicit consent to process your
                                    data.
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-2 text-muted-foreground">
                                <li>
                                    ...
                                    trusted third parties who assist us in
                                    operating our Services.
                                </li>
                                <li>
                                    <strong>Legal Requirements:</strong> When
                                    required by law, regulation, or legal
                                    process.
                                </li>
                                <li>
                            ...
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                ...
                                data processing agreements that ensure they meet
                                Privacy Act 2020 standards.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                ...
                                necessary to fulfil the purposes for which it
                            ...
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                ...
                                deleted or anonymised in accordance with our
                        ...
                        <section>
                            ...
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                Under Privacy Act 2020, you have the following
                                rights:
                            </p>
                            <ul className="mt-2 list-inside list-disc space-y-2 text-muted-foreground">
                                <li>
                                ...
                                <li>
                                    ...
                                    deletion of your data in certain
                                    circumstances.
                                </li>
                                <li>
                                    <strong>
                        ...
                        <section>
                            ...
                            <p className="mt-4 leading-relaxed text-muted-foreground">
                                ...
                                enhance your experience, analyse usage, and
                                assist in our marketing efforts. You can control
                        ...
                        <section>
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-2 text-muted-foreground">
                                ...
                                <li>
                                    <strong>Address:</strong> London, United
                                    Kingdom
                                </li>
                            </ul>
                            <p className="mt-4 leading-relaxed text-muted-foreground">
