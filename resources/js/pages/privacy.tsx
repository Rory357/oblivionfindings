...
const Privacy: React.FC = () => {
    return (
        <MarketingLayout title="Privacy Policy" description="Privacy Policy for Oblivion Findings - how we collect, use and protect your data.">
                ...
                <div className="mt-12 space-y-10">
                    <section>
                        ...
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            Oblivion Findings ("we", "our", or "us") is committed to protecting your privacy. 
                            This Privacy Policy explains how we collect, use, disclose, and safeguard your 
                            information when you use our platform, website, and services (collectively, 
                            the "Services").
                        </p>
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            We are registered with the Information Commissioner's Office (ICO) and comply 
                    ...
                    <section>
                        ...
                        <ul className="mt-2 list-disc list-inside space-y-2 text-muted-foreground">
                            <li><strong>Account Information:</strong> Name, email address, phone number, and organisation details when you register.</li>
                            <li><strong>Resident Data:</strong> Names, dates of birth, medical information, care plans, and support records entered by your organisation.</li>
                            <li><strong>Staff Data:</strong> Employment details, qualifications, training records, and shift information.</li>
                            <li><strong>Communication Data:</strong> Messages, emails, and support requests you send us.</li>
                        </ul>

                        <h3 className="mt-6 font-medium text-foreground">2.2 Information We Automatically Collect</h3>
                        <ul className="mt-2 list-disc list-inside space-y-2 text-muted-foreground">
                            ...
                            <li><strong>Location Data:</strong> GPS location when using mobile check-in features (with your consent).</li>
                    ...
                    <section>
                        ...
                        <p className="mt-4 text-muted-foreground leading-relaxed">We use your information to:</p>
                        <ul className="mt-2 list-disc list-inside space-y-2 text-muted-foreground">
                    ...
                    <section>
                        ...
                        <ul className="mt-2 list-disc list-inside space-y-2 text-muted-foreground">
                            ...
                            <li><strong>Legal Obligation:</strong> Processing necessary to comply with our legal obligations (e.g., CQC requirements).</li>
                            <li><strong>Legitimate Interests:</strong> Processing necessary for our legitimate interests, provided your rights don't override these.</li>
                    ...
                    <section>
                        ...
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            ...
                            that ensure they meet UK GDPR standards.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            When data is no longer needed, it is securely deleted or anonymised in 
                    ...
                    <section>
                        ...
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            To exercise these rights, please contact us at privacy@oblivionfindings.co.uk.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            ...
                            analyse usage, and assist in our marketing efforts. You can control 
                    ...
                    <section>
                        ...
                        <ul className="mt-2 list-disc list-inside space-y-2 text-muted-foreground">
                            <li><strong>Email:</strong> privacy@oblivionfindings.co.uk</li>
                            <li><strong>Data Protection Officer:</strong> dpo@oblivionfindings.co.uk</li>
                            <li><strong>Address:</strong> London, United Kingdom</li>
                        </ul>
                        <p className="mt-4 text-muted-foreground leading-relaxed">
                            You also have the right to complain to the Information Commissioner's 
                            Office (ICO) if you believe we have not handled your data properly.
                        </p>
                    </section>
                </div>
            </div>
