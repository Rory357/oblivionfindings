                                ...
                                <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            placeholder="care_plan / policy / assessment"
                                        />
                                    </div>
                                    <div>
                                        <Label>Version</Label>
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            type="date"
                                            value={
                                                uploadForm.data.effective_date
                                            }
                                            onChange={(e) =>
                                                uploadForm.setData(
                                                    'effective_date',
                                    ...
                                    <div className="flex items-center gap-2 pt-6">
                                        <Checkbox
                                            checked={
                                                uploadForm.data.portal_visible
                                            }
                                            onCheckedChange={(v) =>
                                                uploadForm.setData(
                                                    'portal_visible',
                            ...
                            <div className="rounded-md border p-3">
                                ...
                                <div className="mt-3">
                                    <Button
                                        onClick={() =>
                                            editForm.put(
                                                `/clients/${client.id}/documents/${editingDoc.id}`,
                                                {
                                                    preserveScroll: true,
                                                    onSuccess: () =>
                                                        setEditingId(null),
                                        ...
                                        {can_edit && (
                                            <>
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() =>
                                                        uploadForm.delete(
                                                            `/clients/${client.id}/documents/${d.id}`,
                                                            {
                                                                preserveScroll: true,
                                                            },
                                                        )
