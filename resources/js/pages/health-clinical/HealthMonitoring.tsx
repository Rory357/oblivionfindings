...
export default function HealthMonitoring({
    ...
    const setClient = (v: string) => {
        ...
        router.get('/health-clinical/health-monitoring', clean, {
            preserveState: true,
            replace: true,
        });
    };
        ...
        >
            <div className="flex flex-wrap items-center gap-3 rounded-xl border border-primary/25 bg-primary/5 px-4 py-3">
                ...
                <p className="flex-1 text-[13px] text-foreground">
                    Rolls up fluid, bowel, seizure and sleep monitoring captured
                    on each client's profile — surfaced here cross-client for
                    nursing oversight.
                </p>
                <div className="flex items-center gap-2">
                    ...
                    <Select
                        value={filters.client_id || ALL_SENTINEL}
            ...
            <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
                <StatCard
                    ...
                    label="Fluid (30d)"
                    value={s.fluid_30d}
                    caption={`${s.fluid_intake_ml_7d} ml intake · 7d`}
                />
                <StatCard
                    icon={Toilet}
                    label="Bowel (30d)"
                ...
                <StatCard
                    icon={Zap}
                    label="Seizures (30d)"
                    value={s.seizures_30d}
                    caption={
                        s.seizures_escalated_30d > 0
                            ? `${s.seizures_escalated_30d} escalated`
                            : 'none escalated'
                    }
                    tone={s.seizures_escalated_30d > 0 ? 'critical' : 'default'}
                />
                <StatCard
                    icon={Moon}
                    label="Sleep avg (7d)"
                    value={`${s.sleep_avg_hours_7d}h`}
                    caption="hours / night"
                />
            </div>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
                                    ...
                                    >
                                        <div>
                                            ...
                                            {e.escalated ? (
                                                <Badge
                                                    variant="outline"
                                                    className="ml-2 border-status-critical/40 text-[10px] text-status-critical"
                                                >
                                                    Escalated
                                                </Badge>
                                            ) : null}
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-base">
                            <Moon className="h-4 w-4 text-primary" /> Recent
                            sleep
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
