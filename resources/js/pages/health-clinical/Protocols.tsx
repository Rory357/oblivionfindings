...
import { FilePlus2, Filter, X } from 'lucide-react';
                ...
                <div className="flex-1">
                    <RegisterStatStrip
                        stats={[
                            ...
                            {
                                label: 'Due',
                                value: stats.schedules_due,
                                tone:
                                    stats.schedules_due > 0
                                        ? 'warning'
                                        : 'default',
                            },
                            {
                                label: 'Overdue',
                                value: stats.schedules_overdue,
                                tone:
                                    stats.schedules_overdue > 0
                                        ? 'critical'
                                        : 'default',
                            },
                            {
                                label: 'Compliance 30d',
                                value: `${stats.compliance_rate_30d}%`,
                                tone:
                                    stats.compliance_rate_30d >= 90
                                        ? 'success'
                                        : 'warning',
                            },
                        ]}
                        ...
                        <div>
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    {filter_options.observation_types.map(
                                        (type) => (
                                            <SelectItem
                                                key={type.value}
                                                value={type.value}
                        ...
                        <div>
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    {filter_options.frequencies.map(
                                        (frequency) => (
                                            <SelectItem
                                                key={frequency.value}
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {protocols.data.map((protocol) => (
                                        <tr
                                            key={protocol.id}
                                            className="border-b align-top transition-colors hover:bg-muted/20"
                                        >
                                            ...
                                            <td className="px-4 py-3 text-xs text-muted-foreground">
                                                ...
                                                <p className="mt-1">
                                                    Alert after{' '}
                                                    {
                                                        protocol.alert_if_missed_hours
                                                    }
                                                    h
                                                </p>
                                            </td>
                                            ...
                                            {can_manage ? (
                                                <td className="px-4 py-3">
                                                    <div className="flex justify-end gap-2">
                                                        <Link
                                                            href={`/health-clinical/protocols/${protocol.id}/edit`}
                                                        >
                                                            <Button
                                                                size="sm"
                                                                variant="outline"
                    ...
                    {protocols.last_page > 1 ? (
                        <div className="flex items-center justify-between border-t px-4 py-3">
                            <p className="text-xs text-muted-foreground">
                                Page {protocols.current_page} of{' '}
                                {protocols.last_page} ({protocols.total} total)
                            </p>
