...
export default function KeyManagement({
    ...
    const filteredHolders = current_holders.filter((h) => {
        ...
        return (
            !q ||
            h.vehicle_name?.toLowerCase().includes(q) ||
    ...
    const handleCheckout = () => {
        router.post(
            ...
            {
                asset_id: selectedVehicle,
                user_id: selectedUser,
                key_number: keyNumber || undefined,
                location: location || 'with_driver',
    ...
    const handleTransfer = () => {
        router.post(
            ...
            {
                asset_id: selectedVehicle,
                transferred_to_user_id: selectedTransferTo,
                key_number: keyNumber || undefined,
                location: location || 'with_driver',
                notes: notes || undefined,
            },
        ...
        >
            ...
            <PageShell>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                ...
                                <Input
                                    placeholder="Key Number (optional)"
                                    value={keyNumber}
                                    onChange={(e) =>
                            ...
                            <div className="mt-4 flex gap-2">
                                <Button
                                    ...
                                    disabled={!selectedVehicle || !selectedUser}
                                >
                                    Confirm Check Out
                                </Button>
                                <Button
                ...
                {can.manage && showReturn && (
                    <Card>
                        <CardHeader>
                            <CardTitle>Return Key</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <Select
                ...
                {can.manage && showTransfer && (
                    <Card>
                        <CardHeader>
                            <CardTitle>Transfer Key</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <Select
                                ...
                                >
                                    <SelectTrigger>
                                        <SelectValue placeholder="Transfer To Staff" />
                                    </SelectTrigger>
                                    <SelectContent>
                                        {users.map((u) => (
                                            <SelectItem
                            ...
                            <div className="mt-4 flex gap-2">
                                <Button
                                    ...
                                    disabled={
                                        !selectedVehicle || !selectedTransferTo
                                    }
                                >
                                    Confirm Transfer
                                </Button>
                ...
                <div className="relative max-w-sm">
                    ...
                    <Input
                        placeholder="Search by vehicle or staff..."
                        className="pl-10"
                        value={search}
                                                ...
                                                >
                                                    ...
                                                    <td className="py-3 pr-4">
                                                        <div className="flex items-center gap-2">
                                                            <span
                                                                className={`h-2 w-2 rounded-full ${h.status === 'checked_out' ? 'bg-status-warning' : 'bg-status-success'}`}
                                                            />
                                                            {h.holder_name ??
                                                                '-'}
                                                        </div>
