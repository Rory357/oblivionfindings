...
function conditionLabel(condition: string) {
    ...
    const info = labels[condition] ?? {
        text: condition.replace(/_/g, ' '),
        color: '',
    };
...
const fuelPercentage: Record<string, number> = {
    full: 100,
    '3/4': 75,
    '1/2': 50,
    '1/4': 25,
            ...
            <PageShell>
                ...
                <div
                    className={cn(
                        ...
                        statusBannerColors[h.status] ??
                            statusBannerColors.pending_acceptance,
                    )}
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {h.asset ? (
                                    <Link
                                        href={`/fleet-assets/vehicles/${h.asset.id}`}
                        ...
                        <div className="grid gap-4 sm:grid-cols-3">
                            <Card>
                                ...
                                <CardContent>
                                    <div className="flex items-center gap-3">
                                        <div className="relative h-16 w-8 overflow-hidden rounded-md border-2">
                                            <div
                                                className={cn(
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <span className="text-lg">
                                        {conditionLabel(h.exterior_condition)}
                                    </span>
                                </CardContent>
                            </Card>
                            <Card>
                                ...
                                <CardContent>
                                    <span className="text-lg">
                                        {conditionLabel(h.interior_condition)}
                                    </span>
                                </CardContent>
                            </Card>
                        </div>
                                    ...
                                    <div className="space-y-2">
                                        {(h.damage_notes ?? []).map(
                                            (note, i) => (
                                                <div
                                                    key={i}
                                                    className="rounded-md border border-status-warning/30 bg-status-warning-bg p-3 dark:border-status-warning/30"
                                                >
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    {[
                                        {
                                            label: 'Keys Present',
                                            value: h.keys_present,
                                        },
                                        {
                                            label: 'Documents Present',
                                            value: h.documents_present,
                                        },
                                        {
                                            label: 'First Aid Kit',
                                            value: h.first_aid_kit,
                                        },
                                        {
                                            label: 'Fire Extinguisher',
                                            value: h.fire_extinguisher,
                                        },
                                    ].map((item) => (
                                        <div
                                            key={item.label}
                        ...
                        {canAcceptOrDispute && (
                            <Card className="border-2 border-status-warning/30 dark:border-status-warning/30">
                                ...
                                <CardContent className="space-y-4">
                                    <p className="text-sm text-muted-foreground">
                                        Review the handover details. Accept if
                                        correct, or dispute with a reason.
                                    </p>
                                    <Button
