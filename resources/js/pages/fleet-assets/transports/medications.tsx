...
export default function MedicationTransitIndex({
    ...
    const canManageMedicationTransit = !!can_manage;
    const canAdministerMedicationTransit = !!can_administer;
    const canRecordControlledMedication = !!can_record_controlled;
    ...
    const [administeringLog, setAdministeringLog] = useState<MedLog | null>(
        null,
    );
                        ...
                        <CardContent className="flex flex-col gap-4 p-4 lg:flex-row lg:items-center lg:justify-between">
                            <div className="space-y-1">
                                ...
                                <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
                                    ...
                                    <span>•</span>
                                    <span className="capitalize">
                                        {transportScope.status.replaceAll(
                                            '_',
                                            ' ',
                                        )}
                                    </span>
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Button asChild size="sm" variant="outline">
                                    <Link
                                        href={`/fleet-assets/transports/${transportScope.id}`}
                                    >
                                        Open Transport
                                    </Link>
                                </Button>
