...
export default function RosteringIndex(props: Props) {
    ...
    const assignForm = useForm({ user_id: '', return_to: '/operations/rostering' });
                                                            ...
                                                            <div key={sh.id} className="rounded-md border p-3">
                                                                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                                                    ...
                                                                    <div className="flex flex-wrap items-center gap-2">
                                                                        ...
                                                                        <Link href={`/operations/shifts/${sh.id}`}>
                                                        ...
                                                        {staffOverlapsDetailed.slice(0, 4).map(({ a, b }) => (
                                                            <div key={`so-${a.id}-${b.id}`} className="rounded-md border p-3">
                                                                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                                                                    ...
                                                                    <div className="flex flex-wrap items-center gap-2">
                                                                        <Link href={`/operations/shifts/${a.id}`}><Button size="sm" variant="outline">Open A</Button></Link>
                                                                        <Link href={`/operations/shifts/${b.id}`}><Button size="sm" variant="outline">Open B</Button></Link>
                                                                        <Button
                                                                            size="sm"
                                                                            variant="default"
                                                                            onClick={() =>
                                                                        ...
                                                                        {props.canManageAny ? (
                                                                            <Button
                                                                                ...
                                                                                variant="destructive"
                                                                                onClick={() => {
                                                                                    router.post(`/operations/shifts/${b.id}/unassign`, { return_to: '/operations/rostering' }, { preserveScroll: true });
                                                                                }}
                                                                            >
                                                                                Unassign B
                                                                            </Button>
                                                ...
                                                {timesheetsNeedingAttention.length === 0 ? (
                                                    ...
                                                    <div className="space-y-2">
                                                        {timesheetsNeedingAttention.slice(0, 6).map((sh) => (
                                                            <Link key={sh.id} href={`/operations/shifts/${sh.id}`} className="block">
                                                                ...
                                                                {props.canManageAny ? (
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            onClick={() => {
                                                                                assignForm.post(`/operations/shifts/${sh.id}/assign`, {
                                                                                    preserveScroll: true,
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <Button
                                                                ...
                                                                onClick={() => {
                                                                    ...
                                                                    router.delete(`/rostering/time-off/${b.id}`, { preserveScroll: true, data: { return_to: '/operations/rostering' } });
                                                                }}
                                                            >
                                                                Delete
                                                            </Button>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                                <div className="rounded-md border p-3">
                                    ...
                                    <div className="mt-2">
                                        <Link href={`/operations/shifts/${resolveModal.a.id}`}>
                                ...
                                <div className="rounded-md border p-3">
                                    ...
                                    <div className="mt-2">
                                        <Link href={`/operations/shifts/${resolveModal.b.id}`}>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        router.post(`/operations/shifts/${resolveModal.b.id}/unassign`, { return_to: '/operations/rostering' }, {
                                                            preserveScroll: true,
                                                ...
                                                <div className="mt-2 flex items-center gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            if (!uid) return;
                                                            router.post(`/operations/shifts/${resolveModal.b.id}/assign`, { user_id: uid, return_to: '/operations/rostering' }, {
                                                                preserveScroll: true,
                                                                onSuccess: () => setResolveModal(null),
                                                            });
                                                        }}
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        router.post(`/operations/shifts/${resolveModal.a.id}/unassign`, { return_to: '/operations/rostering' }, {
                                                            preserveScroll: true,
                                                            onSuccess: () => setResolveModal(null),
                                                        });
                                                    }}
                                                ...
                                                <div className="mt-2 flex items-center gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            if (!uid) return;
                                                            router.post(`/operations/shifts/${resolveModal.a.id}/assign`, { user_id: uid, return_to: '/operations/rostering' }, {
                                                                preserveScroll: true,
                                                                onSuccess: () => setResolveModal(null),
                                                            });
                                                        }}
