...
export default function MileageIndex({
    claims = { data: [], links: [], current_page: 1, last_page: 1, total: 0 },
    filters = {} as any,
    stats = {} as any,
}: Props) {
        ...
        <AppLayout>
            ...
            <PageHero
                ...
                stats={[
                    ...
                    {
                        label: 'Total km',
                        value: `${(stats?.total_km ?? 0).toLocaleString('en-NZ')} km`,
                    },
                    {
                        label: 'Total amount',
                        value: nzd.format(stats?.total_amount ?? 0),
                    },
                ]}
            />
            <PageShell>
                        ...
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-16">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground/80">
                                    Create your first mileage claim to get
                                    started.
                                </p>
                            ...
                            <CardContent className="flex items-center gap-4 p-4">
                                ...
                                <div className="min-w-0 flex-1">
                                    <div className="flex items-center gap-2">
                                        <Link
                                            href={`/operations/mileage/${claim.id}`}
                                ...
                                <div className="flex shrink-0 gap-1">
                                    ...
                                    >
                                        <Link
                                            href={`/operations/mileage/${claim.id}/edit`}
                                        >
