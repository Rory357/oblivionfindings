                        ...
                        <CardContent className="space-y-2">
                            {med_charts.map((d: any) => (
                                <div key={d.id} className="flex items-center justify-between rounded-md border p-3">
                                    ...
                                    <Button variant="outline" onClick={() => (window.location.href = `/operations/clients/${client.id}/documents/${d.id}/download`)}>
                                        Download
                                    </Button>
                                </div>
                            ))}
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        ...
                                        {can_edit && (
                                            <Button
                                                ...
                                                onClick={() =>
                                                    contactForm.delete(
                                                        `/operations/clients/${client.id}/medical/emergency-contacts/${e.id}`,
                                                        {
                                                            preserveScroll: true,
                                                        },
                                                    )
