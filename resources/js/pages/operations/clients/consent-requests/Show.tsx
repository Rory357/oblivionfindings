                        ...
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between">
                                ...
                                <Badge
                                    ...
                                    data-test="consent-request-show-status"
                                >
                                    {request.status}
                                </Badge>
                            </CardHeader>
                            <CardContent className="space-y-2 text-sm">
                                ...
                                <Row
                                    ...
                                    value={
                                        formatDateTime(request.viewed_at) ??
                                        'Not yet'
                                    }
                                />
                                <Row
                                ...
                                {request.is_expired &&
                                    request.status === 'pending' && (
                                        <div className="mt-2 rounded border border-status-critical/30 bg-status-critical-bg p-2 text-xs text-status-critical">
                                            This request has passed its expiry
                                            and will auto-close on the next
                                            sweep.
                                        </div>
                                    )}
                            </CardContent>
                            ...
                            <CardContent className="space-y-4 text-sm">
                                ...
                                {request.withdrawal_method_text && (
                                    <Field
                                        ...
                                        body={request.withdrawal_method_text}
                                    />
                                )}
                            </CardContent>
                        </Card>
                        ...
                        {request.cancellation_reason && (
                            <Card>
                                ...
                                <CardContent className="text-sm">
                                    <p>
                                        Cancelled by{' '}
                                        {request.cancelled_by?.name ?? 'staff'}
                                    </p>
                    ...
                    <div className="space-y-6">
                        <Card>
                            ...
                            <CardContent className="space-y-3 text-sm">
                                ...
                                <Row
                                    label="Relationship"
                                    value={request.recipient_relationship.replace(
                                        /_/g,
                                        ' ',
                                    )}
                                />
                        ...
                        {request.resulting_consent && (
                            <Card className="border-status-success/30 bg-status-success-bg">
                                ...
                                <CardContent className="space-y-2 text-sm">
                                    <Row
                                        label="Consent"
                                        value={`#${request.resulting_consent.id}`}
                                    />
                                    <Row
                                        label="Status"
                                        value={request.resulting_consent.status}
                                    />
                                    <Row
                                        label="Given"
                                        value={formatDateTime(
                                            request.resulting_consent.given_at,
                                        )}
                                    />
                                    <Row
                                        label="Expires"
                        ...
                        {request.can_cancel && (
                            <Button
                                ...
                                className="w-full"
                                data-test="consent-request-cancel-open"
                            >
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                ...
                                Recorded with reason in the audit trail.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="space-y-2">
                            ...
                            <Textarea
                                id="reason"
                                data-test="consent-request-cancel-reason"
                                rows={3}
                                value={reason}
                        ...
                        <DialogFooter>
                            ...
                            <Button
                                ...
                                data-test="consent-request-cancel-confirm"
                            >
                                Cancel request
                            </Button>
                        </DialogFooter>
...
function authorityLabel(
    a: 'self' | 'substitute' | 'informational_only',
): string {
    return a === 'substitute'
