...
export default function ClientViewModal({
    ...
    useEffect(() => {
        ...
        fetch(`/operations/clients/${client.id}?modal=1`, {
            headers: {
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex flex-wrap gap-2 text-xs">
                                        <Link href={`/operations/clients/${detail.id}`} className="rounded-md border px-3 py-2 hover:bg-muted">
                                            Open profile
                                        </Link>
                                        <Link href={`/operations/clients/${detail.id}/medical`} className="rounded-md border px-3 py-2 hover:bg-muted">
                                            Medical
                                        </Link>
                                        <Link href={`/operations/clients/${detail.id}/documents`} className="rounded-md border px-3 py-2 hover:bg-muted">
                                            Documents
                                        </Link>
                                        <Link href={`/operations/clients/${detail.id}/portal-users`} className="rounded-md border px-3 py-2 hover:bg-muted">
                                            Portal users
                                        </Link>
                                        <Link href={`/operations/clients/${detail.id}/assignments`} className="rounded-md border px-3 py-2 hover:bg-muted">
                                            Assign workers
                                        </Link>
                                    </div>
                                </div>
