...
export default function CalendarSyncIndex({
    ...
    const triggerSync = (id: number) => {
        router.post(
            `/operations/calendar-sync/${id}/sync`,
            {},
            { preserveState: true },
        );
    };
                        ...
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-16">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground/80">
                                    Add a calendar connection to sync shifts and
                                    schedules.
                                </p>
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Badge
                                                ...
                                                className="h-4 gap-0.5 px-1.5 text-[9px] capitalize"
                                            >
                                        ...
                                        <div className="mt-0.5 flex items-center gap-3 text-xs text-muted-foreground">
                                            <span>
                                                {conn.calendars_count} calendar
                                                {conn.calendars_count !== 1
                                                    ? 's'
                                                    : ''}
                                            </span>
