    ...
    return (
        <AppLayout>
            ...
            <PageHero
                ...
                description="Connect an external calendar for shift synchronisation."
                backHref="/operations/calendar-sync"
            />
            <PageShell>
                <form onSubmit={handleSubmit}>
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-1.5">
                                    <Label htmlFor="sync_direction">
                                        Sync Direction *
                                    </Label>
                                    <Select
                                        value={data.sync_direction}
                                        onValueChange={(v) =>
                                            setData('sync_direction', v)
                                        }
                                    >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('calendar_id', e.target.value)
                                    }
                    ...
                    <div className="mt-4 flex items-center justify-end gap-2">
                        <Button
                            ...
                            variant="outline"
                            onClick={() =>
                                router.get('/operations/calendar-sync')
                            }
                        >
                            Cancel
                        </Button>
