...
export default function ShiftsIndex({
    ...
    const filterFields: FilterField[] = [
        ...
        { type: 'date', key: 'to', label: 'To' },
        {
            ...
            key: 'q',
            label: 'Search',
            placeholder: `Search ${clientSingular.toLowerCase()}, staff, location`,
        },
        {
            type: 'select',
            key: 'status',
    ...
    const handleFilterChange = (key: string, value: any) => {
        router.get(
            shiftsIndex.url({ query: { ...filters, [key]: value || null } }),
            {},
            ...
            <PageShell>
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <OpsStatCard
                        ...
                        icon={stats.unassigned > 0 ? AlertCircle : Users}
                        color={stats.unassigned > 0 ? 'red' : 'emerald'}
                    />
                </div>
                ...
                {shifts.data.length > 0 ? (
                    <>
                                            ...
                                            <div className="min-w-0">
                                                <div className="font-medium">
                                                    <Link
                                                        ...
                                                        href={`/operations/clients/${s.client.id}`}
                                                    >
                                                        {s.client.first_name}{' '}
                                                        {s.client.last_name}
                                                    </Link>
                        ...
                        <div className="text-xs text-muted-foreground">
                            ...
                            {shifts.data.length === 1 ? 'shift' : 'shifts'}
                        </div>
                    </>
                ) : (
                    <EmptyList
                        ...
                        itemName="shift"
                        createHref={canCreate ? createShift.url() : undefined}
