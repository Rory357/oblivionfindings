...
export default function EvvShow({ record }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        verification_status:
            record.status === 'flagged' ? 'flagged' : 'verified',
    ...
    return (
        <AppLayout>
            ...
            <PageHero
                variant="compact"
                title={`EVV Record #${record.id}`}
                description="Review visit timing, location evidence, and verification status."
                backHref="/operations/evv"
            />
            <PageShell>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between gap-3">
                                        ...
                                        <span className="text-right font-medium">
                                            {formatDateTime(
                                                record.shift?.starts_at ?? null,
                                            )}{' '}
                                            -{' '}
                                            {formatDateTime(
                                                record.shift?.ends_at ?? null,
                                            )}
                                        </span>
                                    </div>
                                </CardContent>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between gap-3">
                                        ...
                                        <span className="text-right font-medium">
                                            {record.distance_from_site_in ??
                                                '-'}
                                            m /{' '}
                                            {record.distance_from_site_out ??
                                                '-'}
                                            m
                                        </span>
                                    </div>
