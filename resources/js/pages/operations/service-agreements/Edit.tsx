...
export default function ServiceAgreementEdit({ agreement, clients }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        total_budget:
            agreement.total_budget != null
                ? String(agreement.total_budget)
                : '',
        hourly_rate:
            agreement.hourly_rate != null ? String(agreement.hourly_rate) : '',
        daily_rate:
            agreement.daily_rate != null ? String(agreement.daily_rate) : '',
        ...
        allocated_hours_per_week:
            agreement.allocated_hours_per_week != null
                ? String(agreement.allocated_hours_per_week)
                : '',
        carer_support_days_allocated:
            agreement.carer_support_days_allocated != null
                ? String(agreement.carer_support_days_allocated)
                : '',
        carer_support_days_used:
            agreement.carer_support_days_used != null
                ? String(agreement.carer_support_days_used)
                : '',
        carer_support_entitlement_year:
            agreement.carer_support_entitlement_year ?? '',
        total_hours:
            agreement.total_hours != null ? String(agreement.total_hours) : '',
    ...
    const handleSubmitForApproval = () => {
        router.post(
            `/operations/service-agreements/${agreement.id}/submit-for-approval`,
        );
    };

    const showApprovalSection =
        agreement.status === 'draft' || agreement.status === 'pending_approval';
                            ...
                            <div className="space-y-4">
                                <div className="grid gap-4 sm:grid-cols-3">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            type="date"
                                            value={data.nasc_assessment_date}
                                            onChange={(e) =>
                                                setData(
                                ...
                                <div className="grid gap-4 sm:grid-cols-3">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            type="date"
                                            value={data.funding_approved_date}
                                            onChange={(e) =>
                                                setData(
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4 sm:grid-cols-3">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Select
                                            value={data.support_needs_level}
                                            onValueChange={(v) =>
                                                setData(
                                                    'support_needs_level',
                                                    v,
                                ...
                                <div className="grid gap-4 sm:grid-cols-3">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            ...
                                            min="0"
                                            value={
                                                data.carer_support_days_allocated
                                            }
                                            onChange={(e) =>
                                                setData(
                                                    'carer_support_days_allocated',
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            ...
                                            step="1"
                                            min="0"
                                            value={data.carer_support_days_used}
                                            onChange={(e) =>
                                                setData(
                                                    'carer_support_days_used',
                                                    e.target.value,
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            value={
                                                data.carer_support_entitlement_year
                                            }
                                            onChange={(e) =>
                                                setData(
                                                    'carer_support_entitlement_year',
                        ...
                        <CardContent className="p-5">
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        value={data.nasc_support_package_ref}
                                        onChange={(e) =>
                                            setData(
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            ...
                                            placeholder="Person signing for the client (e.g. welfare guardian)"
                                        />
                                    </div>
                                    <div className="space-y-1.5">
                                        <Label>Provider Signatory</Label>
                                        <Input
                                            value={data.provider_signatory}
                                            onChange={(e) =>
                                                setData(
                                                    'provider_signatory',
                                                    e.target.value,
                                            ...
                                            placeholder="Person signing for your organisation"
                                        />
                                    </div>
                                </div>
                                <div className="grid gap-4 sm:grid-cols-3">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            value={data.funder_contact_name}
                                            onChange={(e) =>
                                                setData(
                                                    'funder_contact_name',
                                                    e.target.value,
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            type="email"
                                            value={data.funder_contact_email}
                                            onChange={(e) =>
                                                setData(
                                            ...
                                            placeholder="funder@example.co.nz"
                                        />
                                    </div>
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            type="tel"
                                            value={data.funder_contact_phone}
                                            onChange={(e) =>
                                                setData(
                        ...
                        <CardContent className="p-5">
                            ...
                            >
                                ...
                                <p className="mt-1 text-xs text-primary">
                                    PDF, Word document, or scanned image
                                </p>
                                <input
                                    id="doc-upload"
                                    type="file"
                                        ...
                                        <div className="flex items-start gap-3 rounded-lg border border-status-info/30 bg-status-info-bg p-3">
                                            ...
                                            <div className="text-xs text-status-info">
                                                ...
                                                <ol className="mt-1.5 list-inside list-decimal space-y-0.5">
                                                    ...
                                                    <li>
                                                        Submit the agreement for
                                                        approval
                                                    </li>
                                                    <li>
                                                        A manager will review
                    ...
                    <div className="flex items-center justify-between rounded-xl border bg-muted p-4">
                        ...
                        <div className="flex gap-2">
                            <Button
                                ...
                                onClick={() =>
                                    router.get(
                                        `/operations/service-agreements/${agreement.id}`,
                                    )
                                }
                            >
                                Cancel
