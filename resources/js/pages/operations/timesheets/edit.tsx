    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: `${timesheetLabel} #${timesheet.id}`, href: `/operations/timesheets/${timesheet.id}/edit` },
            ]}
        >
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {canSubmit && (status === 'draft' || status === 'returned') ? (
                            <Button
                                type="button"
                                variant="outline"
                                onClick={() => router.post(`/operations/timesheets/${timesheet.id}/submit`)}
                            >
                                Submit for approval
                            </Button>
                        ) : null}
                                ...
                                <div className="w-full rounded-md border p-4 space-y-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <Button
                                            ...
                                            variant="outline"
                                            onClick={() => {
                                                decision.post(`/operations/timesheets/${timesheet.id}/approve`, {
                                                    preserveScroll: true,
                                                });
                                            }}
                                        >
                                        ...
                                        <Button
                                            ...
                                            variant="outline"
                                            onClick={() => {
                                                decision.post(`/operations/timesheets/${timesheet.id}/reject`, {
                                                    preserveScroll: true,
                                                });
                                            }}
                                        >
                                        ...
                                        <Button
                                            ...
                                            variant="outline"
                                            onClick={() => {
                                                decision.post(`/operations/timesheets/${timesheet.id}/return`, {
                                                    preserveScroll: true,
                                                });
                                            }}
                                        >
