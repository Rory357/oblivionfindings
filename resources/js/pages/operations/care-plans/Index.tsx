    ...
    return (
        <AppLayout>
            ...
            <PageShell>
                    ...
                    <CardContent className="flex flex-col items-center gap-4 px-6 py-12 text-center">
                        ...
                        <div className="max-w-xl space-y-1.5">
                            <h2 className="text-lg font-semibold">
                                A care-plans dashboard is coming soon
                            </h2>
                            <p className="text-sm text-muted-foreground">
                                Care &amp; support plans now live inside each
                                client&apos;s profile — open a client and go to
                                the{' '}
                                <span className="font-medium text-foreground">
                                    Care &amp; Support Plan
                                </span>{' '}
                                tab to create, view, edit, review and sign off a
                                plan. This page will grow into an
                                organisation-wide overview of plan health,
                                reviews due and goal progress.
                            </p>
                        </div>
                        <Button asChild>
                            <Link href="/operations/clients">
                ...
                <div className="mt-2 flex items-center gap-2 text-xs font-semibold tracking-wide text-muted-foreground uppercase">
                    <ClipboardList className="h-3.5 w-3.5" /> Organisation
                    snapshot
                </div>
