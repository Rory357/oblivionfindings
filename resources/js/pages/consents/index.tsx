...
export default function ConsentsIndex({
    ...
    return (
        <AppLayout
            breadcrumbs={[{ title: 'Consent Management', href: '/consents' }]}
        >
                ...
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <div className="mt-1 text-sm text-muted-foreground">
                            GDPR-compliant consent tracking with Mental Capacity
                            Act integration
                        </div>
                    </div>
                    ...
                    <CardContent className="grid grid-cols-1 gap-3 sm:grid-cols-5">
                        ...
                        {clients.length > 0 && (
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(v) =>
                                        onFilter({
                                            client_id: v === ANY ? null : v,
                                        })
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue
                                            placeholder={clientSingular}
                                        />
                                    </SelectTrigger>
                                    <SelectContent>
                        ...
                        {consentTypes.length > 0 && (
                            <div>
                                ...
                                <Select
                                    value={
                                        filters.consent_type_id
                                            ? String(filters.consent_type_id)
                                            : ANY
                                    }
                                    onValueChange={(v) =>
                                        onFilter({
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="mt-2 flex flex-wrap gap-2">
                                                ...
                                                {consent.capacity_assessed && (
                                                    ...
                                                    >
                                                        Capacity:{' '}
                                                        {consent.capacity_outcome?.replace(
                                                            /_/g,
                                                            ' ',
                                                        )}
                                                    </Badge>
                                            ...
                                            <div className="mt-2 text-xs text-muted-foreground">
                                                Client:{' '}
                                                {consent.client.first_name}{' '}
                                                {consent.client.last_name}
                                                {consent.obtained_at &&
                                                    ` • Obtained: ${new Date(consent.obtained_at).toLocaleDateString()}`}
                                                {consent.expires_at &&
                                                    ` • Expires: ${new Date(consent.expires_at).toLocaleDateString()}`}
                                                {consent.obtained_by &&
                                                    ` • By: ${consent.obtained_by.first_name} ${consent.obtained_by.last_name}`}
                                            </div>
                                        </div>
                                        <Link
