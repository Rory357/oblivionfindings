...
const SmartMonitoring: React.FC = () => {
    const aiCapabilities = [
        {
            ...
            description: 'AI automatically identifies people, objects, and potential hazards in real-time. Know instantly when someone enters a restricted area or when unusual objects appear.',
        },
        {
            icon: AlertTriangle,
            title: 'Fall & Distress Detection',
            description: 'Advanced algorithms analyse body posture and movement patterns to detect falls, trips, or signs of distress—alerting staff within seconds.',
        },
        {
            icon: History,
            title: 'Timeline Reconstruction',
            description: 'When an incident occurs, the AI automatically pieces together footage from multiple cameras to create a complete timeline of events.',
        },
        {
            icon: Brain,
            title: 'Behavioural Analysis',
            description: 'Learn normal activity patterns and receive alerts when behaviour deviates from the baseline—early warning for potential issues.',
        },
        {
            icon: Eye,
            title: 'Privacy Masking',
            description: 'GDPR-compliant privacy zones automatically blur sensitive areas like bathrooms and bedrooms while maintaining security in common spaces.',
        },
        {
            icon: LayoutDashboard,
            title: 'Unified Dashboard',
            description: 'All cameras, alerts, and AI insights in one place—integrated seamlessly with your resident management and incident reporting.',
        },
    ];
    ...
    const scenarios = [
        {
            ...
            description: 'A resident with dementia gets up at 3 AM and walks toward an exit. The AI detects unusual movement during night hours, triggers an alert to the night staff, and reconstructs the path taken—preventing a potential safeguarding incident.',
            icon: Moon,
        },
        {
            title: 'The Slip and Fall',
            description: 'A resident slips in the kitchen when no staff are present. The AI immediately detects the fall posture, sends an urgent alert with camera location, and saves the preceding 30 seconds of footage for review.',
            icon: AlertTriangle,
        },
        {
            title: 'The Missing Item',
            description: 'A valuable item goes missing. Instead of reviewing hours of footage, staff use AI search: "Show me all people who entered room 3 between 2 PM and 4 PM." The system returns relevant clips in seconds.',
            icon: Search,
        },
        {
            title: 'The Investigation',
            description: 'Following an incident report, management uses the timeline reconstruction feature. The AI stitches together footage from 4 cameras to show the complete sequence of events—providing clear evidence for the safeguarding review.',
            icon: FileText,
        },
    ];
    ...
    return (
        <MarketingLayout title="Smart Monitoring" description="Intelligent monitoring with automatic incident detection, timeline reconstruction, and real-time alerts for supported living providers.">
            {/* Hero */}
            <section className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/10 via-primary/5 to-background px-6 py-16 sm:px-12 sm:py-24">
                ...
                <div className="relative mx-auto max-w-4xl text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-3xl text-xl text-muted-foreground">
                        Modern CCTV systems that don't just record—they understand. 
                        Detect incidents, reconstruct timelines, and protect your residents 
            ...
            <section className="mt-24">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                        Our AI doesn't replace your staff—it empowers them with superhuman 
                        awareness and perfect memory.
                    </p>
                </div>
                        ...
                        <div className="grid items-center gap-10 lg:grid-cols-2">
                            <div>
                                ...
                                <p className="mt-4 text-muted-foreground">
                                    When an incident occurs across multiple camera zones, 
                                    our AI automatically reconstructs the complete timeline—
                                    saving hours of manual footage review.
                                </p>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-foreground">Incident Detected</h4>
                                            <p className="text-sm text-muted-foreground">AI identifies unusual activity and triggers an alert</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-foreground">Multi-Camera Search</h4>
                                            <p className="text-sm text-muted-foreground">System scans all cameras to track movement</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-foreground">Timeline Built</h4>
                                            <p className="text-sm text-muted-foreground">Complete sequence stitched together automatically</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-foreground">Instant Review</h4>
                                            <p className="text-sm text-muted-foreground">Staff view the complete story in minutes, not hours</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="relative rounded-2xl border border-border bg-background p-4 shadow-2xl">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 mb-3">
                                        <div className="relative aspect-video rounded-lg bg-muted overflow-hidden">
                                            ...
                                            <div className="absolute bottom-2 right-2 flex items-center gap-1 rounded bg-emerald-500/20 px-2 py-1 text-[10px] text-emerald-400">
                                                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                                                Live
                                            </div>
                                            {/* AI Detection Box */}
                                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-20 w-14 border-2 border-primary/60 rounded-lg">
                                                <div className="absolute -top-6 left-0 bg-primary text-white text-[10px] px-2 py-1 rounded">
                                        ...
                                        <div className="relative aspect-video rounded-lg bg-muted overflow-hidden">
                                            ...
                                            <div className="absolute bottom-2 right-2 flex items-center gap-1 rounded bg-amber-500/20 px-2 py-1 text-[10px] text-amber-400">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between">
                                                    <p className="text-sm font-medium text-amber-600 dark:text-amber-400">
                                                        AI Alert: Unusual Activity
                                                    </p>
                                                    <span className="text-[10px] text-muted-foreground">14:32:18</span>
                                                </div>
                                                <p className="text-xs text-muted-foreground mt-1">
                                                    Motion pattern in Kitchen (Cam 03) inconsistent with normal activity 
            ...
            <section className="mt-24">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                        See how AI-powered CCTV makes a difference in everyday situations
                    </p>
                </div>
            ...
            <section className="mt-24">
                <div className="rounded-3xl border border-border bg-card p-8 sm:p-12">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-muted-foreground">
                            Enterprise-grade infrastructure built for 24/7 care environments
                        </p>
                    </div>

                    <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {specs.map((spec, index) => (
                            <div key={index} className="group relative flex items-center gap-4 overflow-hidden rounded-xl bg-gradient-to-br from-muted/80 to-muted/40 p-4 transition-all hover:from-muted/90 hover:to-muted/50">
                                {/* Gloss overlay */}
                ...
                <div className="rounded-3xl bg-gradient-to-br from-primary/5 to-transparent border border-border p-8 sm:p-12">
                    <div className="grid items-center gap-10 lg:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-4 text-muted-foreground">
                                We understand that CCTV in care settings requires a careful balance 
                                between safety and privacy. Our system is built with GDPR compliance 
                                at its core.
                            </p>
                        ...
                        <div className="flex items-center justify-center">
                            <div className="group relative overflow-hidden rounded-2xl border border-border bg-background p-8 text-center transition-all hover:shadow-lg hover:shadow-primary/5">
                                ...
                                <h3 className="mt-4 text-lg font-semibold text-foreground">GDPR Compliant</h3>
                                <p className="mt-2 text-sm text-muted-foreground">
                                    Full compliance with UK data protection regulations 
                                    for CCTV in care settings
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="rounded-3xl border border-border bg-card p-8 sm:p-12">
                    <div className="grid items-center gap-10 lg:grid-cols-2">
                            ...
                            <div className="space-y-4">
                                <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-muted/80 to-muted/40 p-4 transition-all hover:from-muted/90 hover:to-muted/50">
                                    ...
                                    <div className="relative flex items-center gap-3">
                                        ...
                                        <span className="font-medium text-foreground">CCTV Alert Generated</span>
                                        <span className="ml-auto text-xs text-muted-foreground">14:32:18</span>
                                    </div>
                                </div>
                                <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-muted/80 to-muted/40 p-4 transition-all hover:from-muted/90 hover:to-muted/50">
                                    {/* Gloss overlay */}
                                    ...
                                    <div className="relative flex items-center gap-3">
                                        ...
                                        <span className="font-medium text-foreground">Auto-linked to Incident Report</span>
                                        <span className="ml-auto text-xs text-muted-foreground">14:33:05</span>
                                    </div>
                                </div>
                                <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-muted/80 to-muted/40 p-4 transition-all hover:from-muted/90 hover:to-muted/50">
                                    {/* Gloss overlay */}
                                    ...
                                    <div className="relative flex items-center gap-3">
                                        ...
                                        <span className="font-medium text-foreground">Manager Notified</span>
                                        <span className="ml-auto text-xs text-muted-foreground">14:33:12</span>
                                    </div>
                                </div>
                                <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-muted/80 to-muted/40 p-4 transition-all hover:from-muted/90 hover:to-muted/50">
                                    {/* Gloss overlay */}
                                    ...
                                    <div className="relative flex items-center gap-3">
                                        ...
                                        <span className="font-medium text-foreground">Timeline Reconstructed</span>
                                        <span className="ml-auto text-xs text-muted-foreground">14:35:00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="order-1 lg:order-2">
                            ...
                            <p className="mt-4 text-muted-foreground">
                                The Control Room doesn't work in isolation—it's seamlessly 
                                connected to your entire Oblivion Findings platform.
                            </p>
                            <ul className="mt-6 space-y-3">
                                {[
                ...
                <div className="rounded-3xl bg-gradient-to-r from-primary to-primary/90 px-6 py-12 sm:px-12 sm:py-16">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mt-4 text-primary-foreground/80">
                            Get a personalised demonstration of our AI Control Room and see 
                            how it can transform your safeguarding and incident response.
                        </p>
