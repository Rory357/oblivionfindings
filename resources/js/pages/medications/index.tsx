            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                        {clients.map((c) => (
                            <Card key={c.id} className={`transition-shadow hover:shadow-md ${c.has_critical_alerts || (c.discrepancy_count && c.discrepancy_count > 0) ? 'border-red-300' : c.has_alerts ? 'border-amber-300' : ''}`}>
                                <CardHeader className="pb-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-1">
                                            {(c.discrepancy_count && c.discrepancy_count > 0) && (
