    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Documents', href: `/portal/clients/${client.id}/documents` },
            ]}
        >
                    ...
                    <Dialog open={uploadOpen} onOpenChange={setUploadOpen}>
                        ...
                        <DialogContent className="sm:max-w-lg">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Share a document with the care team — e.g. consent forms, letters, or reports.
                                </DialogDescription>
                            </DialogHeader>
                            <form onSubmit={submitUpload} className="space-y-4">
                                ...
                                {!form.data.file ? (
                                    ...
                                    >
                                        <div className={`mb-3 flex h-12 w-12 items-center justify-center rounded-full ${dragActive ? 'bg-primary/10' : 'bg-muted'}`}>
                                        ...
                                        <p className="mt-2 text-[11px] text-muted-foreground/60">
                                            PDF, Word, images, or text files up to 20 MB
                                        </p>
                                        <input
                                            ref={fileInputRef}
                                            type="file"
                                    ...
                                    <div className="flex items-center gap-3 rounded-xl border bg-muted/30 p-4">
                                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-background border">
                                            {fileIcon(form.data.file.type)}
                                        </div>
                                        <div className="min-w-0 flex-1">
                                            <p className="truncate text-sm font-medium">{form.data.file.name}</p>
                                ...
                                <div className="flex justify-end gap-2 pt-2">
                                    <Button type="button" variant="outline" onClick={() => { setUploadOpen(false); form.reset(); }}>
                                        Cancel
                                    </Button>
                                    <Button type="submit" disabled={form.processing || !form.data.file || !form.data.title} className="gap-2">
                                        <Upload className="h-4 w-4" />
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <p className="mt-1 text-xs text-muted-foreground/70">
                                Documents shared by the care team will appear here.
                            </p>
                        </CardContent>
                    </Card>
                )}
