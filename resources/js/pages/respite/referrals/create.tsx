                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <Select value={data.referrer_type} onValueChange={(v) => setData('referrer_type', v)}>
                                        <SelectTrigger><SelectValue placeholder="Select referrer type" /></SelectTrigger>
                                        <SelectContent>
                                            {[
                                                'Self',
                                                'Family/Whanau',
                            ...
                            <div>
                                ...
                                <Input value={data.referrer_contact} onChange={(e) => setData('referrer_contact', e.target.value)} />
                            </div>
