...
export default function RespiteResourcesIndex({
    allocations,
    filters,
    assets,
}: Props) {
                    ...
                    {allocations.data.map((a: any) => (
                        <Card key={a.id}>
                            <CardHeader>
                                <CardTitle className="text-base">
                                    {a.asset
                                        ? `${a.asset.name}${a.asset.asset_tag ? ` (${a.asset.asset_tag})` : ''}`
                                        : `Asset #${a.resource_id}`}
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-1 text-sm text-muted-foreground">
                                <div>
                                    {formatDateTimeLong(a.start_at)} →{' '}
                                    {formatDateTimeLong(a.end_at)}
                                </div>
