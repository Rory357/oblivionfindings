...
export default function RespiteStayShow({ stay }: Props) {
    ...
    const handleExtend = () => {
        if (extendDate) {
            router.post(`/respite/stays/${stay.id}/extend`, {
                new_end: `${extendDate}T12:00:00`,
            });
            setExtendOpen(false);
        }
    };
    ...
    const handleDischarge = () => {
        if (dischargeSummary) {
            router.post(`/respite/stays/${stay.id}/discharge`, {
    ...
    return (
        ...
        >
            <Head
                title={`Stay - ${stay.client?.first_name} ${stay.client?.last_name}`}
            />
            ...
            <PageLayout
                hero={
                    <PageHero
                        ...
                        title={
                            `${stay.client?.first_name ?? ''} ${stay.client?.last_name ?? ''}`.trim() ||
                            'Stay'
                        }
                        actions={
                            <div className="flex flex-wrap gap-2">
                                <Badge
                                    className={statusColor[stay.status] || ''}
                                >
                                    {stay.status}
                                </Badge>
                                {stay.evidence_pack_id && (
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2 text-sm">
                            <div className="grid grid-cols-2 gap-1">
                                ...
                                <span>
                                    {formatDateTimeLong(stay.actual_start) ||
                                        '—'}
                                </span>
                                <span className="text-muted-foreground">
                                    End
                                ...
                                <span>
                                    {formatDateTimeLong(stay.actual_end) || '—'}
                                </span>
                                <span className="text-muted-foreground">
                                    Created by
                                </span>
                        ...
                        <CardContent className="space-y-2 text-sm">
                            {stay.booking ? (
                                <div className="grid grid-cols-2 gap-1">
                                    ...
                                    <Link
                                        href={`/respite/bookings/${stay.booking.id}`}
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2 text-sm">
                                <div className="grid grid-cols-2 gap-1">
                                    ...
                                    <Badge variant="outline" className="w-fit">
                                        {stay.evidence_pack.status}
                                    </Badge>
                                </div>
                                <Link
                                    href={`/respite/stays/${stay.id}/evidence-pack`}
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                {stay.arrival_checklist_complete && (
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                {stay.discharge_checklist_complete && (
                                    <Badge className="bg-status-success-bg text-status-success">
                                        Complete
                                    </Badge>
                                )}
                            ...
                            <div className="space-y-3">
                                ...
                                {stay.daily_notes.length > 5 && (
                                    <p className="text-xs text-muted-foreground">
                                        + {stay.daily_notes.length - 5} more
                                        notes
                                    </p>
                                )}
                            </div>
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <Link
                                href={`/respite/stays/${stay.id}/handover-notes`}
                                className="text-xs text-primary hover:underline"
                            >
                                View All
                            </Link>
                    ...
                    <CardContent>
                        {stay.handovers?.length > 0 ? (
                            ...
                            <p className="text-sm text-muted-foreground">
                                No handover notes recorded yet.
                            </p>
                        )}
                    </CardContent>
                </Card>
                        ...
                        {stay.communications?.length > 0 ? (
                            <div className="space-y-3">
                                ...
                                {stay.communications.length > 5 && (
                                    <p className="text-xs text-muted-foreground">
                                        + {stay.communications.length - 5} more
                                        logs
                                    </p>
                                )}
                            </div>
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <Link
                                href={`/respite/stays/${stay.id}/risk-plan-activations`}
                                className="text-xs text-primary hover:underline"
                            >
                                View All
                            </Link>
                    ...
                    <CardContent>
                        {stay.risk_plan_activations?.length > 0 ? (
                            ...
                            <p className="text-sm text-muted-foreground">
                                No risk plans activated for this stay.
                            </p>
                        )}
                    </CardContent>
                </Card>
