        ...
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Handover Notes', href: '/respite/handover-notes' },
                {
                    ...
                    href: '/respite/handover-notes/unacknowledged',
                },
            ]}
        >
            ...
            <PageLayout
                hero={
                    <PageHero
                        ...
                        stats={[{ label: 'Total', value: notes.data.length }]}
                    />
                }
            >
                <RespiteSubnav />
                ...
                <div className="space-y-2">
                                    ...
                                    <div className="flex items-start justify-between gap-3">
                                        <div className="flex-1">
                                            <div className="font-semibold">
                                                {n.stay?.client?.first_name}{' '}
                                                {n.stay?.client?.last_name}
                                            </div>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <Button
                                                ...
                                                onClick={() =>
                                                    router.post(
                                                        `/respite/handover-notes/${n.id}/acknowledge`,
                                                    )
                                                }
                                            >
                                                Acknowledge
                    ...
                    {!notes.data.length && (
                        <div className="py-8 text-center text-sm text-muted-foreground">
                            No unacknowledged handover notes.
                        </div>
                    )}
                </div>
