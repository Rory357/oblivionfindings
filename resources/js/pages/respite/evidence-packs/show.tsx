...
export default function EvidencePackShow({ pack }: Props) {
    ...
    const handleSeal = () => {
        router.post(`/respite/evidence-packs/${pack.id}/seal`, {
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2 text-sm text-muted-foreground">
                        ...
                        <div>
                            ...
                            {pack.stay?.client ? (
                                <Link
                                    href={`/respite/stays/${pack.stay.id}`}
                                    className="text-primary hover:text-primary"
                                >
                                    {pack.stay.client.first_name}{' '}
                                    {pack.stay.client.last_name}
                                </Link>
                            ) : (
                                'Unknown'
                            )}
                        ...
                        {isSealed && (
                            <>
                                <div>
                                    Sealed at:{' '}
                                    {formatDateTimeLong(pack.sealed_at)}
                                </div>
                                {pack.sealed_by && (
                                    <div>
                                        Sealed by:{' '}
                                        {pack.sealed_by.name || pack.sealed_by}
                                    </div>
                                )}
                            </>
                        )}
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        rows={2}
                                    />
                                    {addItemForm.errors.description && (
                                        <div className="mt-1 text-xs text-status-critical">
                                            {addItemForm.errors.description}
                                        </div>
                                    )}
