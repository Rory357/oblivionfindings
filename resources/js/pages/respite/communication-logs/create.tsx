...
export default function CommunicationLogCreate({
    stays,
    stayId,
    channels,
}: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        channel: '',
        occurred_at: '',
        participants: [{ name: '', role: '' }] as Array<{
            name: string;
            role: string;
        }>,
        summary: '',
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                {
                    title: 'New Log',
                    href: '/respite/communication-logs/create',
                },
            ]}
        >
                        ...
                        <CardContent className="space-y-4">
                            {!hasStays && (
                                <div className="rounded-md border border-status-warning/30 bg-status-warning-bg px-3 py-2 text-sm text-status-warning">
                                    No respite stays are available yet. Create
                                    or admit a stay before logging
                                    communication.
                                </div>
                            )}
