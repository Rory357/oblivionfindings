            ...
            >
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3 text-sm text-muted-foreground">
                        ...
                        <div>
                            Progress: {run.current_step || 0}/
                            {run.total_steps || 0} steps
                        </div>
                        {run.sla_deadline && (
                            <div
                                className={
                            ...
                            >
                                SLA Deadline:{' '}
                                {formatDateTimeLong(run.sla_deadline)}
                                {run.sla_breached && ' (BREACHED)'}
                            </div>
                        )}
                        <div>
                            Initiated by: {run.initiated_by?.name || 'Unknown'}
                        </div>
                        {run.escalated_to && (
                            <div>Escalated to: {run.escalated_to?.name}</div>
                        )}
                        {run.failure_reason && (
                        ...
                        {run.cancellation_reason && (
                            <div>
                                Cancellation reason: {run.cancellation_reason}
                            </div>
                        )}
                    </CardContent>
                </Card>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2 border-t pt-4">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={setEscalateToUserId}
                                        >
                                            <SelectTrigger>
