...
export default function ProcedureRunsIndex({
    runs,
    templates,
    filters,
}: Props) {
                ...
                <Card>
                    ...
                    <CardContent className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <Select
                                value={filters.template_id ?? ANY}
                                onValueChange={(v) =>
                                    onFilter({
                                        template_id: v === ANY ? null : v,
                                    })
                                }
                            >
                                <SelectTrigger>
