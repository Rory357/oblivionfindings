                ...
                hero={
                    <PageHero
                        ...
                        stats={[
                            ...
                            { label: 'Active', value: activations.data.filter((a: any) => a.status === 'active').length },
                            { label: 'Pending review', value: activations.data.filter((a: any) => a.status === 'pending_review').length },
                        ]}
                        actions={
