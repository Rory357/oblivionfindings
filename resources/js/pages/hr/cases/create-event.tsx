                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="restricted">Restricted (Managers + HR)</SelectItem>
                                        <SelectItem value="full">Full (Subject can see)</SelectItem>
                                    </SelectContent>
                                </Select>
                                <p className="text-xs text-muted-foreground">
                                    Controls who can see this event on the timeline
                                </p>
                            </div>
                        </CardContent>
                    </Card>
