...
export default function CreateOffboarding({ employees, defaultEndDate }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex max-w-2xl flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold">Start Offboarding Checklist</h1>
                </div>
                ...
                {employees.length === 0 ? (
                    <Card>
                        <CardContent className="p-8 text-center">
                            ...
                            <h3 className="mb-2 text-lg font-medium">No eligible employees</h3>
                            <p className="mb-4 text-sm text-muted-foreground">
                                All active employees already have offboarding checklists in progress.
                            </p>
                            <Link href="/hr/offboarding">
                                <Button variant="outline">Back to Offboarding</Button>
                            </Link>
                        </CardContent>
                    </Card>
                ) : (
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-center justify-end gap-3">
                                    ...
                                    <Button type="submit" disabled={processing}>Start Checklist</Button>
                                </div>
                            </form>
                        </CardContent>
                    </Card>
