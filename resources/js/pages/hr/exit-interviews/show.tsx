...
import { Star, Lock, ThumbsUp, ThumbsDown } from 'lucide-react';
...
function FeedbackSection({ title, content }: { title: string; content: string | null }) {
...
export default function ExitInterviewShow({ interview, can }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: interview.employee_profile?.user?.name ?? 'Interview', href: `/hr/exit-interviews/${interview.id}` },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Exit Interview - ${interview.employee_profile?.user?.name}`} />
                ...
                <div className="space-y-4">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-5">
                            <FeedbackSection title="What Went Well" content={interview.what_went_well} />
                            <FeedbackSection title="What Could Improve" content={interview.what_could_improve} />
                            <FeedbackSection title="Management Feedback" content={interview.management_feedback} />
                            <FeedbackSection title="Culture Feedback" content={interview.culture_feedback} />
                            <FeedbackSection title="Additional Comments" content={interview.additional_comments} />
