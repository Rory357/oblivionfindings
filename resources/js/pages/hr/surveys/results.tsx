            ...
            <div className="flex flex-col gap-6 p-6">
                <div>
                    ...
                    <div className="mt-2 flex gap-2">
                        ...
                        <Badge variant="secondary">{results.total_responses} responses</Badge>
                    </div>
                </div>
                ...
                {enps && enps.total > 0 && (
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-base">Employee Net Promoter Score (eNPS)</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    {results.questions.map((question, index) => (
                        <Card key={question.id}>
                            <CardHeader className="pb-3">
                                ...
                                <p className="text-xs text-muted-foreground">{question.total_answers} answers</p>
                            </CardHeader>
                            <CardContent>
                                {(question.question_type === 'rating' || question.question_type === 'enps_score') && (
                                    <div>
                                        {question.average !== null && question.average !== undefined && (
                                        ...
                                        {question.distribution && Object.keys(question.distribution).length > 0 && (
                                            <div className="h-40">
                                                <ResponsiveContainer width="100%" height="100%">
                                                    <BarChart
                                                        data={Object.entries(question.distribution).map(([k, v]) => ({
                                                            score: k,
                                                            count: v,
                                                        }))}
                                                    >
                                ...
                                {question.question_type === 'multiple_choice' && question.distribution && (
                                    <div className="flex gap-6">
                                        <div className="h-48 flex-1">
                                            <ResponsiveContainer width="100%" height="100%">
                                                <PieChart>
                                                    ...
                                                    >
                                                        {Object.keys(question.distribution).map((_, i) => (
                                        ...
                                        <div className="space-y-2">
                                            {Object.entries(question.distribution).map(([choice, count], i) => (
                                ...
                                {question.question_type === 'text' && question.responses && (
