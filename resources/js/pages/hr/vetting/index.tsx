    ...
    const rowMenu = (c: Check): CtxItem[] => [
        {
            icon: ShieldCheck,
            label: 'Open',
            onClick: () => router.visit(`/hr/compliance/vetting/${c.id}`),
        },
        ...(can.manage
            ? [
                  {
                      ...
                      label: 'Edit',
                      onClick: () =>
                          router.visit(`/hr/compliance/vetting/${c.id}/edit`),
                  },
                  {
                      icon: CheckCircle2,
                      label: 'Mark cleared',
                      ...
                      onClick: () =>
                          post(
                              `/hr/compliance/vetting/${c.id}/clear`,
                              'Marked cleared.',
                          ),
                  },
                  {
                      ...
                      onClick: () =>
                          post(
                              `/hr/compliance/vetting/${c.id}/renew`,
                              'Renewal requested.',
                          ),
                  },
                  {
                      ...
                      onClick: () =>
                          router.post(
                              `/hr/compliance/vetting/${c.id}/consent`,
                              { consent_given: true },
                              {
                                  preserveScroll: true,
                                  onSuccess: () =>
            ...
            <div className="space-y-4 px-4 py-4 lg:px-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <p className="text-[12.5px] text-muted-foreground">
                        Police vetting · MOJ criminal record · Children's Act
                        safety checks
                    </p>
                ...
                >
                                    ...
                                    >
                                        <td className="px-3 py-2.5">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                />
                                                <Link
                                                    href={`/hr/compliance/vetting/${c.id}`}
                    ...
                    <div className="flex items-center justify-between border-t border-border px-4 py-3 text-[12.5px] text-muted-foreground">
                        <span>
                            Showing {checks.from ?? 0}–{checks.to ?? 0} of{' '}
                            {checks.total}
                        </span>
                        {checks.last_page > 1 && (
