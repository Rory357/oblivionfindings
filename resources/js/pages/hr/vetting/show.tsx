...
export default function VettingShow({ check, can }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: `${check.user.name} - ${check.check_type.replace(/_/g, ' ')}`,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-4">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <div className="text-sm">
                                ...
                                <div className="font-medium">
                                    {check.verified_by?.name || 'Not verified'}
                                </div>
                            </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <div className="text-sm">
                                ...
                                <div className="font-medium">
                                    {check.reference_number || 'Not assigned'}
                                </div>
                            </div>
                            <div className="text-sm">
                                <div className="text-xs text-muted-foreground">
                            ...
                            {check.risk_decision && (
                                <div className="text-sm">
                                    ...
                                    <div className="font-medium capitalize">
                                        {check.risk_decision.replace(/_/g, ' ')}
                                    </div>
                                </div>
                            )}
                        </CardContent>
                ...
                {canViewDisclosures &&
                    (check.disclosures_present || check.disclosure_details) && (
                        <Card>
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2 text-base">
                            ...
                            <CardContent className="space-y-3">
                                ...
                                {check.disclosure_details && (
                                    <div className="text-sm">
                                        ...
                                        <div className="rounded-md border border-status-critical/30 bg-status-critical-bg p-3 text-sm whitespace-pre-wrap text-foreground">
                                            {check.disclosure_details}
                                        </div>
                                    </div>
                                )}
                        ...
                        <CardContent className="flex flex-wrap gap-2">
                            {expired && (
                                <Button
                                    ...
                                    onClick={() => {
                                        if (
                                            confirm(
                                                'Request a renewal for this check?',
                                            )
                                        ) {
                                            router.post(
                                                `/hr/compliance/vetting/${check.id}/renew`,
                                            );
                                        }
                                    }}
                                >
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    if (
                                        confirm(
                                            'Are you sure you want to delete this vetting record?',
                                        )
                                    ) {
                                        router.delete(
                                            `/hr/compliance/vetting/${check.id}`,
                                        );
                                    }
                                }}
                            >
