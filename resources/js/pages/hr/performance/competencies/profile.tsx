...
const levelColors = ['bg-status-critical-bg text-status-critical', 'bg-status-warning-bg text-status-warning', 'bg-status-warning-bg text-status-warning', 'bg-status-info-bg text-status-info', 'bg-status-success-bg text-status-success'];
