...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add Supervision Note', href: '/hr/performance/supervision/create' },
];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 max-w-4xl">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Add Supervision Note</h1>
                        <p className="text-muted-foreground">Record a supervision session or check-in</p>
                    </div>
                </div>
