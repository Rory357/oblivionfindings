...
export default function EditReview({ review, reviewTypes }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: review.employee.name, href: `/hr/performance/reviews/${review.id}` },
        { title: 'Edit', href: `/hr/performance/reviews/${review.id}/edit` },
    ];

    const initialGoals = review.goals?.length ? review.goals : [''];
    const initialTraining = review.training_recommendations?.length ? review.training_recommendations : [''];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 max-w-4xl">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Edit Performance Review</h1>
                        <p className="text-muted-foreground">Update review for {review.employee.name}</p>
                    </div>
                </div>
