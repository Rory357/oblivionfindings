        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            >
                ...
                <InfoCard icon={Info} tone="info">
                    <span className="font-semibold">Read-only.</span> These
                    values are configured in the application config (and, for
                    the mileage rate, consolidated with Operations &amp; Fleet
                    in a future pass). They are shown here so payroll and
                    finance can see what every claim surface uses.
                </InfoCard>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                IRD-aligned rate read by every expense claim
                                wizard (mileage = distance × rate). The claim
                                form never hard-codes this number.
                            </p>
                        </CardContent>
                    </Card>
