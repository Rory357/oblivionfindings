    ...
    public function up(): void
    {
        ...
        $templates = [
            ...
            [
                ...
                'frequency' => 'monthly',
                'regulatory_reference' => 'HWhaikaha Infection Prevention Standards',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'frequency' => 'quarterly',
                'regulatory_reference' => 'Ngā Paerewa 2.1',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'frequency' => 'monthly',
                'regulatory_reference' => 'Ngā Paerewa 1.3',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name' => 'Ngā Paerewa Self-Assessment',
                'category' => 'regulatory',
                'description' => 'Annual self-assessment against NZ Ngā Paerewa NZS 8134:2021.',
                'checklist_items' => json_encode([
                ...
                'frequency' => 'annually',
                'regulatory_reference' => 'Ngā Paerewa NZS 8134:2021',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
