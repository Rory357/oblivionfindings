        ...
        return [
            ...
            [
                ...
                'steps' => [
                    ...
                    ['title' => 'Notify designated safeguarding lead', 'instructions' => 'Contact the organisation\'s designated safeguarding lead immediately. If unavailable, contact the deputy.', 'type' => PlaybookStep::TYPE_NOTIFICATION],
                    ...
                    ['title' => 'External referral decision', 'instructions' => 'The safeguarding lead must decide whether an external referral to police, social services, or other authority is required.', 'type' => PlaybookStep::TYPE_DECISION, 'decision_options' => ['Internal investigation only', 'Refer to Adult Social Care', 'Refer to NZ Police', 'Refer to Oranga Tamariki', 'Multiple referrals required']],
