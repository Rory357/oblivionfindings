...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('medication_allergies')) {
        ...
        if (! Schema::hasTable('medication_interactions')) {
        ...
        if (! Schema::hasTable('medication_scheduled_stock_counts')) {
        ...
        if (Schema::hasTable('client_medication_administrations') && ! Schema::hasTable('medication_mar_attachments')) {
        ...
        if (! Schema::hasTable('medication_dashboard_alerts')) {
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('client_controlled_drug_entries')) {
            Schema::table('client_controlled_drug_entries', function (Blueprint $table) {
                foreach (['disposal_method', 'disposal_authorisation', 'batch_number', 'expiry_date'] as $column) {
                    if (Schema::hasColumn('client_controlled_drug_entries', $column)) {
        ...
        if (Schema::hasTable('client_medication_administrations')) {
            Schema::table('client_medication_administrations', function (Blueprint $table) {
                foreach (['late_minutes', 'early_minutes', 'outcome', 'site'] as $column) {
