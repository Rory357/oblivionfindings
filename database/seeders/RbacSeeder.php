    ...
    public function run(): void
    {
        ...
        */
        $permissionDefinitions = [
            ...
            ['key' => 'clients.viewPortal', 'description' => 'Reach linked client portal profiles', 'group' => 'clients', 'module' => 'Portal'],
            ...
            ['key' => 'respite.procedures.run', 'description' => 'Run respite procedures', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.tasks.view', 'description' => 'View respite tasks', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.tasks.manage', 'description' => 'Manage respite tasks', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.tasks.approve', 'description' => 'Approve respite tasks', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.handovers.view', 'description' => 'View respite handovers', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.handovers.manage', 'description' => 'Manage respite handovers', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.communications.view', 'description' => 'View respite communication logs', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.communications.manage', 'description' => 'Manage respite communication logs', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.daily-notes.view', 'description' => 'View respite daily notes', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.daily-notes.manage', 'description' => 'Manage respite daily notes', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.risk-plans.view', 'description' => 'View respite risk plan activations', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.risk-plans.manage', 'description' => 'Manage respite risk plan activations', 'group' => 'respite', 'module' => 'Operations'],
            ...
            ['key' => 'respite.evidence.manage', 'description' => 'Manage respite evidence packs', 'group' => 'respite', 'module' => 'Operations'],
            ['key' => 'respite.evidence.seal', 'description' => 'Seal respite evidence packs', 'group' => 'respite', 'module' => 'Operations'],
            ...
            ['key' => 'hr.employees.viewAny', 'description' => 'View the employee directory and permitted profile sections', 'group' => 'hr', 'module' => 'HR'],
            ...
            ['key' => 'training.viewAny', 'description' => 'View staff training matrix', 'group' => 'training', 'module' => 'HR'],
            ['key' => 'training.enrol', 'description' => 'Enrol staff in training', 'group' => 'training', 'module' => 'HR'],
            ['key' => 'training.manageCourses', 'description' => 'Manage staff training courses', 'group' => 'training', 'module' => 'HR'],
            ['key' => 'training.record', 'description' => 'Record staff training completion', 'group' => 'training', 'module' => 'HR'],
            ['key' => 'competency.viewAny', 'description' => 'View competency frameworks', 'group' => 'competency', 'module' => 'HR'],
            ['key' => 'competency.manage', 'description' => 'Manage competency frameworks', 'group' => 'competency', 'module' => 'HR'],
            ...
            ['key' => 'safeguarding.closeAny', 'description' => 'Close a safeguarding concern owned by another safeguarding lead', 'group' => 'safeguarding', 'module' => 'Compliance'],
            ['key' => 'safeguarding.terminalOverride', 'description' => 'Apply an evidenced safeguarding terminal override while open safeguarding work is retained in provenance', 'group' => 'safeguarding', 'module' => 'Compliance'],
            ...
            ['key' => 'finance.donorFunds.manageAllSites', 'description' => 'Manage donor-fund bill applications across all active Sites', 'group' => 'finance', 'module' => 'Finance'],
        ...
        */
        ...
        $syncPermissions($providerManager, [
            ...
            'respite.procedures.run', 'respite.tasks.view', 'respite.tasks.manage', 'respite.tasks.approve',
            'respite.handovers.view', 'respite.handovers.manage',
            'respite.communications.view', 'respite.communications.manage',
            'respite.daily-notes.view', 'respite.daily-notes.manage',
            'respite.risk-plans.view', 'respite.risk-plans.manage',
            ...
            'safeguarding.closeAny', 'safeguarding.terminalOverride',
            ...
            'training.viewAny', 'training.enrol', 'training.manageCourses', 'training.record',
            'competency.viewAny', 'competency.manage',
        ...
        $syncPermissions($finance, [
            ...
            'finance.dashboard', 'finance.insights.viewAllSites', 'finance.payments.viewAllSites', 'finance.payments.manageAllSites', 'finance.donorFunds.manageAllSites', 'finance.ledger.view', 'finance.ledger.manage',
        ...
        $syncPermissions($hr, [
            ...
            'hr.recruitment.view', 'hr.recruitment.manage', 'hr.employees.viewAny', 'hr.employees.viewAllSites', 'hr.employees.manage',
            ...
            'hr.leave.viewAny', 'hr.leave.approve', 'hr.leave.manage',
            'hr.performance.view', 'hr.performance.manage', 'hr.cases.view', 'hr.cases.manage',
            'hr.disciplinary.manage', 'hr.policies.view', 'hr.policies.manage',
        ...
        $syncPermissions($auditor, [
            ...
            'staff.vetting.view',
            'privacy.viewRequests', 'hr.employees.viewAny', 'hr.employees.viewAllSites', 'hr.compliance.view',
        ...
        $syncPermissions($clientRole, [
            'clients.viewPortal', 'rag.ask.self', 'incidents.view.portal', 'incidents.attachments.view.portal',
        ]);
