...
/**
 * Reapplies the data inserts from
 * `2026_04_06_230200_register_shift_control_room_signal_support` so test
 * databases that are loaded from `database/schema/mysql-schema.sql` (which
 * captures schema only, not data-only migrations) still have the shift
 * signal source/types/rules wired up. Idempotent — safe to call repeatedly.
 */
class ShiftControlRoomSignalRegistrationSeeder extends Seeder
{
