...
class FinanceSeeder extends Seeder
{
    ...
    private function getDefaultAccounts(): array
    {
        return [
            ...
            $this->account('2400', 'Holiday Pay Accrual', 'liability', 'current_liability'),
            ...
            $this->account('4100', 'Interest Income', 'revenue', 'revenue'),
            $this->account('4200', 'Other Revenue', 'revenue', 'revenue', true),
            ...
            $this->account('6200', 'IT & Communications', 'expense', 'expense', true),
            $this->account('6300', 'Office Supplies', 'expense', 'expense', true),
            $this->account('6400', 'Professional Fees', 'expense', 'expense', true),
            $this->account('6500', 'Compliance & Audit', 'expense', 'expense', true),
