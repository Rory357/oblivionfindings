...
class SafeguardingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        SafeguardingExternalReport::create([
            ...
            'authority_name' => 'Local Safeguarding Adults Board',
            'authority_contact' => 'safeguarding@localauthority.gov.uk',
            'authority_reference' => 'LA-2026-00123',
        ...
        if (isset($clients[1])) {
            ...
            SafeguardingInvestigation::create([
                ...
                'methodology' => 'Work with local authority and police as appropriate. Interview client, review financial records with consent.',
                'evidence_collected' => [
            ...
            SafeguardingExternalReport::create([
                'safeguarding_concern_id' => $concern2->id,
                'authority_type' => 'local_authority',
                'authority_name' => 'Adult Social Care',
                'authority_contact' => 'adultsocialcare@localauthority.gov.uk',
                ...
                'acknowledgement_reference' => 'ASC-2026-00789',
            ...
            SafeguardingRiskAssessment::create([
                ...
                'agencies_involved' => [
                    ['name' => 'Adult Social Care', 'role' => 'Lead agency'],
                    ['name' => 'Police Financial Abuse Team', 'role' => 'Advisory'],
                ],
