...
class SecurityDevicesSignalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rules = [
            ...
            ['name' => 'Security & Devices: Device Online', 'signal_type_code' => 'device_online', 'priority' => 80, 'output_severity' => 'info', 'output_tier' => 1, 'deduplicate' => true, 'dedup_window_minutes' => 30],
