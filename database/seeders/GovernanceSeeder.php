...
class GovernanceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $teTiritiObligations = [
            ...
            ['principle' => 'tino_rangatiratanga', 'title' => 'Whānau engagement in care planning', 'description' => 'Enable whānau participation in service design and delivery decisions.', 'order' => 1],
            ['principle' => 'tino_rangatiratanga', 'title' => 'Māori consumer feedback', 'description' => 'Actively seek and incorporate feedback from Māori consumers and communities.', 'order' => 2],
            ['principle' => 'active_protection', 'title' => 'Cultural safety training', 'description' => 'Ensure all staff complete cultural safety and Te Tiriti training.', 'order' => 1],
            ['principle' => 'active_protection', 'title' => 'Te Reo Māori accessibility', 'description' => 'Make key documents and communications accessible in Te Reo Māori.', 'order' => 2],
