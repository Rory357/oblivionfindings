...
class GoalsOkrSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $companyGoal1 = HrGoal::firstOrCreate(
            ['title' => 'Improve Service Quality to 95% Satisfaction'],
            [
                'user_id' => $admin->id,
        ...
        HrKeyResult::firstOrCreate(['goal_id' => $companyGoal1->id, 'title' => 'Achieve 95% client satisfaction score'], [
            'target_value' => 95, 'current_value' => 82, 'unit' => '%', 'progress_percentage' => 86, 'status' => 'in_progress', 'due_date' => '2026-06-30', 'owner_id' => $admin->id,
        ]);
        HrKeyResult::firstOrCreate(['goal_id' => $companyGoal1->id, 'title' => 'Reduce incident reports by 30%'], [
            'target_value' => 30, 'current_value' => 18, 'unit' => '% reduction', 'progress_percentage' => 60, 'status' => 'in_progress', 'due_date' => '2026-06-30', 'owner_id' => $admin->id,
        ]);
        HrKeyResult::firstOrCreate(['goal_id' => $companyGoal1->id, 'title' => 'Complete quality audits at all sites'], [
            'target_value' => 5, 'current_value' => 3, 'unit' => 'audits', 'progress_percentage' => 60, 'status' => 'in_progress', 'due_date' => '2026-05-31', 'owner_id' => $admin->id,
        ]);

        // Team Goal under Company Goal 1
        $teamGoal1 = HrGoal::firstOrCreate(
            ['title' => 'Residential Services Quality Improvement'],
            [
                'user_id' => $admin->id,
        ...
        HrKeyResult::firstOrCreate(['goal_id' => $teamGoal1->id, 'title' => 'All staff complete medication management training'], [
            'target_value' => 100, 'current_value' => 85, 'unit' => '%', 'progress_percentage' => 85, 'status' => 'in_progress', 'due_date' => '2026-04-30', 'owner_id' => $admin->id,
        ]);
        HrKeyResult::firstOrCreate(['goal_id' => $teamGoal1->id, 'title' => 'Implement new support plan review process'], [
            'target_value' => 1, 'current_value' => 0, 'unit' => 'process', 'progress_percentage' => 40, 'status' => 'in_progress', 'due_date' => '2026-05-15', 'owner_id' => $admin->id,
        ]);

        // Individual Goal under Team Goal 1
        HrGoal::firstOrCreate(
            ['title' => 'Complete Level 4 Health & Wellbeing Certificate'],
            [
                'user_id' => $admin->id,
        ...
        HrGoal::firstOrCreate(
            ['title' => 'Achieve zero medication errors for Q2'],
            [
                'user_id' => $admin->id,
                'goal_type' => 'individual',
                'category' => 'Quality',
        ...
        $companyGoal2 = HrGoal::firstOrCreate(
            ['title' => 'Reduce Staff Turnover to Below 15%'],
            [
                'user_id' => $admin->id,
        ...
        HrKeyResult::firstOrCreate(['goal_id' => $companyGoal2->id, 'title' => 'Reduce annual turnover from 28% to 15%'], [
            'target_value' => 15, 'current_value' => 22, 'unit' => '%', 'progress_percentage' => 46, 'status' => 'in_progress', 'due_date' => '2026-12-31', 'owner_id' => $admin->id,
        ]);
        HrKeyResult::firstOrCreate(['goal_id' => $companyGoal2->id, 'title' => 'Launch career development programme'], [
            'target_value' => 1, 'current_value' => 0, 'unit' => 'programme', 'progress_percentage' => 30, 'status' => 'in_progress', 'due_date' => '2026-06-30', 'owner_id' => $admin->id,
        ]);
        HrKeyResult::firstOrCreate(['goal_id' => $companyGoal2->id, 'title' => 'Achieve 80%+ employee engagement score'], [
            'target_value' => 80, 'current_value' => 65, 'unit' => '%', 'progress_percentage' => 81, 'status' => 'in_progress', 'due_date' => '2026-09-30', 'owner_id' => $admin->id,
        ]);

        // Team goal under Company Goal 2
        $teamGoal2 = HrGoal::firstOrCreate(
            ['title' => 'Day Services Team Engagement Initiative'],
            [
                'user_id' => $admin->id,
                'goal_type' => 'team',
                'category' => 'People',
        ...
        HrKeyResult::firstOrCreate(['goal_id' => $teamGoal2->id, 'title' => 'Monthly team hui attendance above 90%'], [
            'target_value' => 90, 'current_value' => 78, 'unit' => '%', 'progress_percentage' => 87, 'status' => 'in_progress', 'due_date' => '2026-09-30', 'owner_id' => $admin->id,
        ]);
        ...
        // ============================================================
        HrGoal::firstOrCreate(
            ['title' => 'Expand Community Living Services to Tauranga'],
            [
                'user_id' => $admin->id,
        ...
        HrGoal::firstOrCreate(
            ['title' => 'Complete First Aid Refresher Course'],
            [
                'user_id' => $admin->id,
                'goal_type' => 'individual',
                'category' => 'Compliance',
        ...
        HrGoal::firstOrCreate(
            ['title' => 'Achieve 40 hours professional development this year'],
            [
                'user_id' => $admin->id,
                'goal_type' => 'individual',
